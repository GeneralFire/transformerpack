...
typedef struct {
    ...
    UINT64                    CacheSize;
    UINT64                    LogicalSize;
#if SMBIOS_SPEC_VERSION > 320    
    UINT64                    ExtSpeed;             //SMBIOS 3.3+
    UINT64                    ExtConfigMemSpeed;    //SMBIOS 3.3+
#endif 
...
typedef struct {
    UINT8                     BlockLength;
    UINT8                     ProcessorType;
    UINT8                     ProcessorSpecificData[PROCESSOR_SPECIFIC_DATA_SIZE];
} AMI_PROCESSOR_SPECIFIC_BLOCK;
/**
    Processor Additional Information (Type 44)      //SMBIOS 3.3+
**/
typedef struct {
    SMBIOS_STRUCTURE_HEADER         StructureType;
    UINT16                          ProcessorInfoHandle;
    AMI_PROCESSOR_SPECIFIC_BLOCK    ProcessorBlock;
} AMI_SMBIOS_PROCESSOR_ADDITIONAL_INFO;
#endif
