...
#define LANGUAGE_VARSTORE\
    varstore LANGUAGE, varid = LANGUAGE_KEY_ID,\
        name = PlatformLang, guid = EFI_GLOBAL_VARIABLE_GUID;
#define LANGUAGE_CODES_VARSTORE\
    varstore LANGUAGE_CODES, varid = LANGUAGE_CODES_KEY_ID,\
