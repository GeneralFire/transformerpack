...
//            }
            ...
            // hash mismatch keep looking for cert in a chain
                ...
                wpa_hexdump(MSG_MSGDUMP,"\tTrust Cert", revokeInfo->ToBeSignedHash, hashLen);
                wpa_hexdump(MSG_MSGDUMP,"\tChain Cert", hash, hashLen);
...
{
    wpa_debug_print_string_oid(MSG_MSGDUMP, "PKCS7: EncryptedDigest Algorithm", &SignedData->SignerInfo->enc_digest_info.enc_digest_alg.oid);
...
//        }
        switch(SignedData->SignerInfo->enc_digest_info.enc_digest_alg.oid.oid[6]) {
            case 10:  /* RSAencrypt with Pkcs1*/        
                wpa_printf(MSG_DEBUG, "PKCS7: RSASSA-PSS signature scheme");
                return Pkcs7_RsaSsa_Pss_decrypt_validate_digest(SignedData, SignCert, testHash, hashLen);
            case 1:  /* RSAencrypt with Pkcs1*/
                wpa_printf(MSG_DEBUG, "PKCS7: PKCS-1 with RSAencrypt");
                break;
            case 11: /* sha256WithRSAEncryption */
                wpa_printf(MSG_DEBUG, "PKCS7: PKCS-1 with Sha256RSA");
                break;
            case 12: /* sha384WithRSAEncryption */
                wpa_printf(MSG_DEBUG, "PKCS7: PKCS-1 with Sha384RSA");
                break;
        ...
        u8 *testHash, size_t hashLen)
{
    ...
    wpa_hexdump(MSG_MSGDUMP, "PKCS7: Encrypted Pkcs#1v1.5 signature", data, data_len);
