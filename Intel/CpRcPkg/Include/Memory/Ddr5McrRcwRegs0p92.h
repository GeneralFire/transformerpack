...
#ifndef _DDR5_MCR_RCW_REGS_H_
#define _DDR5_MCR_RCW_REGS_H_
#if FixedPcdGetBool(PcdMcrSupport)

//
// DDR5 MCR RCD Spec Rev0.92 RCW Definitions.
//
  ...
  struct {
    ...
    */
    ...
    /* DRAM Interface Forward All CMDS - Bits[1]
      ...
      1=Do not block
    */
    UINT8 dcs_assertion_error_en : 1;
    /* DCS Assertion Error Enable / Disable - Bits[2]
      0=Dcs assertion error disabled,
      1=Dcs assertion error enabled
    */
    ...
    /* Data Buffer Interface Forward All CMDs - Bits[3]
      ...
      1=Do not block
    */
    UINT8 dcs_phase_selection_en : 1;
    /* DCS Phase Selection Enable/disable - Bits[4]
      0=DCS Phase Selection disabled,
      1=DCS Phase selection enabled

      First NOP command after this bit is set will set the phase for PS0
      bit will automatically return to 0 on receiving NOP command
    */
...
typedef union {
  struct {
    ...
    /* Operating Speed - Bits[3:0]
      ...
      1001=Reserved for DDR5 6800 (6400 MT/s < f < 6800 MT/s),
      1010=Reserved for DDR5 7200 (6800 MT/s < f < 7200 MT/s),
      1011=Reserved for DDR5 7600 (7200 MT/s < f < 7600 MT/s),
      1100=Reserved for DDR5 8000 (7600 MT/s < f < 8000 MT/s),
      1101=Reserved for DDR5 8400 (8000 MT/s < f < 8400 MT/s),
      1110=Reserved for DDR5 8800 (8400 MT/s < f < 8800 MT/s),
...
#define DDR5_RCD_DPAR_AND_DCA_6_0_RECEIVER_DFE_TAP_3_COEFFICIENTS_REG 0x63
typedef union {
  struct {
...
//
// MCR Paged Registers
// Page number encoded in bits[15:8] of address
//
/**
  RW[60] - MCR RCD Global Features
**/
#define DDR5_MCR_RCD_PG70_RW60_REG 0x7060
typedef union {
  struct {
    UINT8 operating_mode : 2;
    /* Operating Mode Note 1 - Bits[1:0]
      00=DDR5 Standard Mode,
      01=Reserved,
      10=DDR5 MCR Mode,
      11=DDR4 MCR Mode
    */
    UINT8 scrambling_enable : 1;
    /* Scrambling Enable - Bits[2]
      0=Disable,
      1=Enable Resets LFSR on next NOP
    */
    UINT8 memory_data_width : 1;
    /* Memory data width. Affects the chip select usage. - Bits[3]
      0=X4 DRAMs. Single package rank only per PS. DCS0 used for PS0, DCS1 used for PS0.,
      1=X8 DRAMs. Up to 2 package ranks per PS. DCS[1:0] used for both pseudo-channels.
    */
    UINT8 qaca_rotation : 1;
    /* QACA Rotation - Bits[4]
      0=Disabled,
      1=Enabled
    */
    UINT8 reserved : 3;
  ...
  UINT8 Data;
} DDR5_MCR_RCD_PG70_RW60_STRUCT;

/**
  RW[61] - MCR CKE Drive Strength, Enable
**/
#define DDR5_MCR_RCD_PG70_RW61_REG 0x7061
typedef union {
  struct {
    UINT8 qcke0_and_qcke1_output_drive_characteristics : 2;
    /* QCKE0 and QCKE1 Output Drive Characteristics - Bits[1:0]
      00=RZQ/12,
      01=RZQ/17,
      10=RZQ/24,
      11=Reserved
    */
    UINT8 qcke1_enable : 1;
    /* QCKE1 Enable - Bits[2]
      0=Enabled,
      1=Disabled
    */
  ...
  UINT8 Data;
} DDR5_MCR_RCD_PG70_RW61_STRUCT;

/**
  RW[62] - MCR CKE0 Output Delay Control Word
**/
#define DDR5_MCR_RCD_PG70_RW62_REG 0x7062
typedef union {
  struct {
    UINT8 output_delay_control_for_qcke0 : 6;
    /* Output Delay Control for QCKE0 - Bits[5:0]
      000000=Delay Outputs by +(0/64) * tCK,
      000001=Delay Outputs by +(1/64) * tCK,
      000010=Delay Outputs by +(2/64) * tCK,
      .....=Delay Outputs by +(2/64) * tCK,
      111101=Delay Outputs by +(61/64) * tCK,
      111110=Delay Outputs by +(62/64) * tCK,
      111111=Delay Outputs by +(63/64) * tCK
    */
    UINT8 full_cycle_delay : 1;
    /* Full cycle delay - Bits[6]
      0=Disabled,
    ...
    */
    UINT8 output_delay_feature_enable_for_qcke0_output : 1;
    /* Output Delay Feature Enable for QCKE0 output signal - Bits[7]
      0=Disabled (default),
      1=Enabled
    */
  } Bits;
  UINT8 Data;
} DDR5_MCR_RCD_PG70_RW62_STRUCT;

/**
  RW[63] - MCR CKE1 Output Delay Control Word
**/
#define DDR5_MCR_RCD_PG70_RW63_REG 0x7063
typedef union {
  struct {
    UINT8 output_delay_control_for_qcke1 : 6;
    /* Output Delay Control for QCKE1 - Bits[5:0]
      000000=Delay Outputs by +(0/64) * tCK,
      000001=Delay Outputs by +(1/64) * tCK,
      000010=Delay Outputs by +(2/64) * tCK,
      .....=Delay Outputs by +(2/64) * tCK,
    ...
    */
    ...
    /* Full cycle delay - Bits[6]
      ...
      1=Enabled adds 1 tCK additional delay to OP[5:0]
    */
    UINT8 output_delay_feature_enable_for_qcke1_output : 1;
    /* Output Delay Feature Enable for QCKE1 output signal - Bits[7]
      0=Disabled (default),
      1=Enabled
    */
  } Bits;
  UINT8 Data;
} DDR5_MCR_RCD_PG70_RW63_STRUCT;

/**
  RW[64] - MCR RCD Training Mode Global Control Word
**/
#define DDR5_MCR_RCD_PG70_RW64_REG 0x7064
typedef union {
  struct {
    UINT8 ca_pass_through_mode_broadcast : 1;
    /* CA Pass through Mode broadcast DCS0 to both QCS0/QCS1 - Bits[0]
      0=Disable,
      1=Enable
    */
    UINT8 reserved_1 : 1;
    /* Reserved Bits[1]  */
    UINT8 route_parity_to_rsp_a_rsp_b : 1;
    /* Route Parity to RSP_A, RSP_B - Bits[2]
      0=Normal Operation,
      1=Enable routing of DRAM ERRORIN_n signals to RSP_A and RSP_B
    */
    UINT8 reserved_2 : 1;
    /*  Reserved - Bits[3] */
    UINT8 dram_space_mrr_to_bcom_read_conversion : 1;
    /* DRAM Space MRR to BCOM Read Conversion - Bits[4]
      0=Disabled,
      1=Enabled
    */
    UINT8  reserved_3: 3;
  ...
  UINT8 Data;
} DDR5_MCR_RCD_PG70_RW64_STRUCT;

/**
  RW[65] - DCATM XOR Selection in Enhanced Clock to DCA training Mode
**/
#define DDR5_MCR_RCD_PG70_RW65_REG 0x7065
typedef union {
  struct {
    UINT8 dca0_included_in_xor : 1;
    /* DCA0 included in XOR - Bits[0]
      0=Not Included,
      1=Included
    */
    UINT8 dca1_included_in_xor : 1;
    /* DCA1 included in XOR - Bits[1]
      0=Not Included,
      1=Included
    */
    UINT8 dca2_included_in_xor : 1;
    /* DCA2 included in XOR - Bits[2]
      0=Not Included,
      1=Included
    */
    UINT8 dca3_included_in_xor : 1;
    /* DCA3 included in XOR - Bits[3]
      0=Not Included,
      1=Included
    */
    UINT8 dca4_included_in_xor : 1;
    /* DCA4 included in XOR - Bits[4]
      0=Not Included,
      1=Included
    */
    UINT8 dca5_included_in_xor : 1;
    /* DCA5 included in XOR - Bits[5]
      0=Not Included,
      1=Included
    */
    UINT8 dca6_included_in_xor : 1;
    /* DCA6 included in XOR - Bits[6]
      0=Not Included,
      1=Included
    */
    UINT8 dpar_included_in_xor : 1;
    /* DPAR included in XOR - Bits[7]
      0=Not Included,
      1=Included
    */
  } Bits;
  UINT8 Data;
} DDR5_MCR_RCD_PG70_RW65_STRUCT;

/**
  RW[66] - DCATM XOR Selection in Enhanced Clock to DCA training Mode, DCS
**/
#define DDR5_MCR_RCD_PG70_RW66_REG 0x7066
typedef union {
  struct {
    UINT8 dcs0_included_in_xor : 1;
    /* DCS0 included in XOR - Bits[0]
      0=Not Included,
      1=Included
    */
    UINT8 dcs1_included_in_xor : 1;
    /* DCS1 included in XOR - Bits[1]
      0=Not Included,
      1=Included
    */
    UINT8 control_qualifier_signal_selection_note_1 : 1;
    /* Control (Qualifier) signal selection (Note 1) - Bits[2]
      0=DCS0,
      1=DCD1
    */
    UINT8 reserved : 5;
  ...
  UINT8 Data;
} DDR5_MCR_RCD_PG70_RW66_STRUCT;

/**
  RW[67] - VHOST Mode MCR Control Register
**/
#define DDR5_MCR_RCD_PG70_RW67_REG 0x7067
typedef union {
  struct {
    UINT8 ps0_vhost_enable : 1;
    /* PS0 VHOST enable - Bits[0]
      0=Disabled,
      1=Enable PS0 for VHOST operation
    */
    UINT8 ps1_vhost_enable : 1;
    /* PS1 VHOST enable - Bits[1]
      0=Disabled,
      1=Enable PS1 for VHOST operation
    */
    UINT8 reserved : 6;
    /*  - Bits[8:0]
  ...
  UINT8 Data;
} DDR5_MCR_RCD_PG70_RW67_STRUCT;

/**
  RW[68] - DFE MCR Control Register
**/
#define DDR5_MCR_RCD_PG70_RW68_REG 0x7068
typedef union {
  struct {
    UINT8 dfe_tap_5_enable : 1;
    /* DFE Tap 5 Enable - Bits[0]
      0=Disable,
      1=Enable DFE Tap 5
    */
    UINT8 dfe_tap_6_enable : 1;
    /* DFE Tap 6 Enable - Bits[1]
      0=Disable,
      1=Enable DFE Tap 6
    */
    UINT8 reserved : 6;
...
/**
  PG[8] RW[ED] - Host Side preamble/postamble Control Word
**/
#define DDR5_DATA_BUFFER_PG8_RWED_REG 0x08ED
typedef union {
  struct {
  ...
  UINT8 Data;
} DDR5_DATA_BUFFER_PG8_RWED_STRUCT;

/**
  RW[E0] - MCR DB Global Features
**/
#define DDR5_DATA_BUFFER_PG70_RWE0_REG 0x70E0
typedef union {
  struct {
    UINT8 mcr_mode : 2;
    /* MCR Mode Note 1 - Bits[1:0]
      00=DDR5 Standard Mode,
      01=Reserved,
      10=DDR5 MCR Mode,
      11=DDR4 MCR Mode
  ...
  UINT8 Data;
} DDR5_DATA_BUFFER_PG70_RWE0_STRUCT;

/**
  RW[E4] - MCR DB Training Mode
**/
#define DDR5_DATA_BUFFER_PG70_RWE4_REG 0x70E4
typedef union {
  struct {
    UINT8 dq_static_mux_mode_for_dq_pass : 1;
    /* DQ Static Mux Mode for DQ Pass Through and Transparent modes . - Bits[0]
      0=Disable,
      1=Enable
    */
    UINT8 swizzle_discovery_static_mode : 1;
    /* Swizzle Discovery Static Mode - Bits[1]
      0=Disable,
      1=Enable
    */
    UINT8 pseudo_channel_selection_for_dq_pass_through : 1;
    /* Pseudo Channel Selection for DQ Pass-Through Mode and Transparent Mode - Bits[2]
      0=Pseudo-Channel 0,
      1=Pseudo-Channel 1
    */
    UINT8 pseudo_channel_0_target_enable_for_mrr : 1;
    /* Pseudo Channel 0 Target Enable for MRR Snoop - Bits[3]
      0=Disabled,
      1=Enabled
    */
    UINT8 pseudo_channel_1_target_enable_for_mrr : 1;
    /* Pseudo Channel 1 Target Enable for MRR Snoop - Bits[4]
      0=Disabled,
      1=Enabled
    */
    UINT8 reserved : 3;
  ...
  UINT8 Data;
} DDR5_DATA_BUFFER_PG70_RWE4_STRUCT;

/**
  RW[E5] - MCR DB Static Mux Select for DQ Pass through and Transparent modes
**/
#define DDR5_DATA_BUFFER_PG70_RWE5_REG 0x70E5
typedef union {
  struct {
    UINT8 dq0_mux_select_for_static_dq_pass : 1;
    /* DQ0 Mux Select for Static DQ Pass Through Mode and Transparent modes - Bits[0]
      0=PS0,
      1=PS1
    */
    UINT8 dq1_mux_select_for_static_dq_pass : 1;
    /* DQ1 Mux Select for Static DQ Pass Through Mode and Transparent modes - Bits[1]
      0=PS0,
      1=PS1
    */
    UINT8 dq2_mux_select_for_static_dq_pass : 1;
    /* DQ2 Mux Select for Static DQ Pass Through Mode and Transparent modes - Bits[2]
      0=PS0,
      1=PS1
    */
    UINT8 dq3_mux_select_for_static_dq_pass : 1;
    /* DQ3 Mux Select for Static DQ Pass Through Mode and Transparent modes - Bits[3]
      0=PS0,
      1=PS1
    */
    UINT8 dq4_mux_select_for_static_dq_pass : 1;
    /* DQ4 Mux Select for Static DQ Pass Through Mode and Transparent modes - Bits[4]
      0=PS0,
      1=PS1
    */
    UINT8 dq5_mux_select_for_static_dq_pass : 1;
    /* DQ5 Mux Select for Static DQ Pass Through Mode and Transparent modes - Bits[5]
      0=PS0,
      1=PS1
    */
    UINT8 dq6_mux_select_for_static_dq_pass : 1;
    /* DQ6 Mux Select for Static DQ Pass Through Mode and Transparent modes - Bits[6]
      0=PS0,
      1=PS1
    */
    UINT8 dq7_mux_select_for_static_dq_pass : 1;
    /* DQ7 Mux Select for Static DQ Pass Through Mode and Transparent modes - Bits[7]
      0=PS0,
      1=PS1
    */
  } Bits;
  UINT8 Data;
} DDR5_DATA_BUFFER_PG70_RWE5_STRUCT;

/**
  RW[E6] - MCR DB Static Mux Select for Swizzle Discovery Mode DQ Pass through mode
**/
#define DDR5_DATA_BUFFER_PG70_RWE6_REG 0x70E6
typedef union {
  struct {
    UINT8 dq0_output_in_swizzle_discovery_static_mode : 1;
    /* DQ0 Output in Swizzle Discovery Static Mode - Bits[0]
      0=0,
      1=1
    */
    UINT8 dq1_output_in_swizzle_discovery_static_mode : 1;
    /* DQ1 Output in Swizzle Discovery Static Mode - Bits[1]
      0=0,
      1=1
    */
    UINT8 dq2_output_in_swizzle_discovery_static_mode : 1;
    /* DQ2 Output in Swizzle Discovery Static Mode - Bits[2]
      0=0,
      1=1
    */
    UINT8 dq3_output_in_swizzle_discovery_static_mode : 1;
    /* DQ3 Output in Swizzle Discovery Static Mode - Bits[3]
      0=0,
      1=1
    */
    UINT8 dq4_output_in_swizzle_discovery_static_mode : 1;
    /* DQ4 Output in Swizzle Discovery Static Mode - Bits[4]
      0=0,
      1=1
    */
    UINT8 dq5_output_in_swizzle_discovery_static_mode : 1;
    /* DQ5 Output in Swizzle Discovery Static Mode - Bits[5]
      0=0,
      1=1
    */
    UINT8 dq6_output_in_swizzle_discovery_static_mode : 1;
    /* DQ6 Output in Swizzle Discovery Static Mode - Bits[6]
      0=0,
      1=1
    */
    UINT8 dq7_output_in_swizzle_discovery_static_mode : 1;
    /* DQ7 Output in Swizzle Discovery Static Mode - Bits[7]
      0=0,
      1=1
    */
  } Bits;
  UINT8 Data;
} DDR5_DATA_BUFFER_PG70_RWE6_STRUCT;

/**
  RW[E8] - DF E taps 5 and 6 enables
**/
#define DDR5_DATA_BUFFER_PG70_RWE8_REG 0x70E8
typedef union {
  struct {
    UINT8 dfe_tap_5_enable : 1;
    /* DFE Tap 5 Enable - Bits[0]
      ...
      1=Enabled
    */
    UINT8 dfe_tap_6_enalbe : 1;
    /* DFE Tap 6 Enalbe - Bits[1]
      0=Disabled,
      1=Enabled
    */
    UINT8 reserved : 6;
  ...
  UINT8 Data;
} DDR5_DATA_BUFFER_PG70_RWE8_STRUCT;

/**
  RW[F0] - x 8 MDQS Mode Enable
**/
#define DDR5_DATA_BUFFER_PG70_RWF0_REG 0x70F0
typedef union {
  struct {
    UINT8 mx8_mode_en : 1;
    /* MX8 Mode EN - Bits[0]
      0=Disabled. Used for x4 DRAMs,
      1=Enabled. Used for x8 DRAMs.
    */
    UINT8 bits_7_1_reserved : 7;
    /* Bits [7:1] - Reserved - Bits[8:0]

    */
  } Bits;
  UINT8 Data;
} DDR5_DATA_BUFFER_PG70_RWF0_STRUCT;

/**
  RW[F1] - x8 MDQS Mode RTT Park
**/
#define DDR5_DATA_BUFFER_PG70_RWF1_REG 0x70F1
typedef union {
  struct {
    UINT8 x8_mode_rtt_control_for_mdqs0_t : 3;
    /* X8 mode RTT control for MDQS0_t and MDQS0_c This termination is used for Park and Reads when the MX8 Mode EN bit
       =1 - Bits[2:0]
      ...
      111=RZQ/ 7 ( 34 )
    */
    UINT8 x8_mode_rtt_control_for_mdqs_1 : 3;
    /* X8 mode RTT control for MDQS 1 _t and MDQS 1 _c This termination is used for Park and Reads when the MX8 Mode EN
       bit =1 - Bits[5:3]
      000=Termination Disabled,
      001=RZQ/4 (60),
      010=RZQ/2 (120),
      ...
      111=RZQ/7 (34)
    */
    UINT8 bits_7_6_reserved : 2;
    /* Bits [7:6] - Reserved

    */
  } Bits;
  UINT8 Data;
} DDR5_DATA_BUFFER_PG70_RWF1_STRUCT;

/**
  RW[F] - 2 x 8 MDQS Mode Drive Strength
**/
#define DDR5_DATA_BUFFER_PG70_RW0F_REG 0x700F
typedef union {
  struct {
    UINT8 bit_0_reserved : 1;
    /* Bit [0] - Reserved -

    */
    UINT8 x8_mode_pull_down_drive_strength_for : 3;
    /* X8 Mode Pull-down Drive Strength for MDQS[ 1:0]_[t/c ] when MX8 Mode EN bit =1. Used by enabled driver. - Bits[3:1]
      000=RZQ/6 (40),
      001=RZQ/7 (34),
      010=RZQ/5 (48),
      011=Reserved,
      ...
      111=Reserved
    */
    UINT8 x8_mode_pull_up_drive_strength_for : 3;
    /* X8 Mode Pull-up Drive Strength for MDQS[ 1:0]_[t/c] when MX8 Mode EN bit =1. Used by enabled driver. - Bits[6:4]
      000=RZQ/6 (40),
      001=RZQ/7 (34),
      010=RZQ/5 (48),
      011=Reserved,
      ...
      111=Reserved
    */
    UINT8 bit_7_reserved : 1;
    /* Bit [7] - Reserved

    */
  } Bits;
  UINT8 Data;
} DDR5_DATA_BUFFER_PG70_RW0F_STRUCT;

/**
  RW[F3] - x8 MDQS Mode Control
**/
#define DDR5_DATA_BUFFER_PG70_RWF3_REG 0x70F3
typedef union {
  struct {
    UINT8 mdqs0_driver_disable_for_x8_mode : 1;
    /* MDQS0 Driver Disable for x8 mode - Bits[0]
      0=Drivers Enabled (default),
      1=Drivers Disabled
    */
    UINT8 mdqs1_driver_disable_for_x8_mode : 1;
    /* MDQS1 Driver Disable for x8 mode - Bits[1]
      0=Drivers Enabled (default),
      1=Drivers Disabled
    */
    UINT8 reserved : 2;
    ...
    */
    UINT8 termination_for_disabled_mdqs_when_db_is : 3;
    /* Termination for Disabled MDQS when DB is transmitting for x8 mode. - Bits[6:4]
      000=Termination Disabled,
      001=RZQ/4 (60),
      010=RZQ/2 (120),
      011=RZQ/6 (40),
  ...
  UINT8 Data;
} DDR5_DATA_BUFFER_PG70_RWF3_STRUCT;

#define DDR5_DATA_BUFFER_CW_PAGE_REG 0xDF
#endif // #if FixedPcdGetBool(PcdMcrSupport)
#endif  // _DDR5_MCR_RCW_REGS_H_
