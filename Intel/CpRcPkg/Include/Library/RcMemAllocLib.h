/** @file
  Interface header file for the RC memory allocation library class.
...
#ifndef __RC_MEM_ALLOC_LIB_H__
#define __RC_MEM_ALLOC_LIB_H__

/**

  Allocates the number bytes specified by AllocationSize and returns a pointer to the allocated buffer.
