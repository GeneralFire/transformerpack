...
#ifndef __BIOS_SSA_MEMORY_HBM_CONFIG__
#define __BIOS_SSA_MEMORY_HBM_CONFIG__
...
#endif // __BIOS_SSA_MEMORY_HBM_CONFIG__

// end file BiosSsaMemoryHbmConfig.h
