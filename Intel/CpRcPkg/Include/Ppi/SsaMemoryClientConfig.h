...
typedef enum {
  ...
  DqdbIncRateModeDelim = MAX_INT32        ///< This value ensures the enum size is consistent on both sides of the PPI.
} DQDB_INC_RATE_MODE;
...
typedef enum {
  ...
  EccDataSourceDelim = MAX_INT32          ///< This value ensures the enum size is consistent on both sides of the PPI.
} ECC_DATA_SOURCE;
...
typedef enum {
  ...
  GaloisLfsrDqdbUniseqMode,               ///< GALOIS_LFSR_MODE unisequencer select.
  DqdbUniseqModeMax,                      ///< DQDB_UNISEQ_SEL enumeration maximum value.
  DqdbUniseqModeDelim = MAX_INT32         ///< This value ensures the enum size is consistent on both sides of the PPI.
} DQDB_UNISEQ_MODE;
...
typedef enum {
  ...
  InvertDcModeDelim = MAX_INT32           ///< This value ensures the enum size is consistent on both sides of the PPI.
} INVERT_DC_MODE;
...
typedef enum {
  ...
  CadbUniseqModeDelim = MAX_INT32         ///< This value ensures the enum size is consistent on both sides of the PPI.
} CADB_UNISEQ_MODE;
...
typedef enum {
  ...
  BurstLengthModeDelim = MAX_INT32        ///< This value ensures the enum size is consistent on both sides of the PPI.
} BURST_LENGTH_MODE;
...
typedef enum {
  ...
  SubseqTypeDelim = MAX_INT32             ///< This value ensures the enum size is consistent on both sides of the PPI.
} SUBSEQ_TYPE;
...
typedef enum {
  ...
  CpgcInitModeDelim = MAX_INT32           ///< This value ensures the enum size is consistent on both sides of the PPI.
} CPGC_INIT_MODE;
...
typedef enum {
  ...
  AddrUpdateRateModeDelim = MAX_INT32     ///< This value ensures the enum size is consistent on both sides of the PPI.
...
typedef enum {
  ...
  AddrincModeDelim = MAX_INT32            ///< This value ensures the enum size is consistent on both sides of the PPI.
} ADDR_INC_MODE;
...
typedef enum {
  ...
  CpgcStopModeDelim = MAX_INT32           ///< This value ensures the enum size is consistent on both sides of the PPI.
} CPGC_STOP_MODE;
...
typedef enum {
  ...
  ErrorCounterModeDelim = MAX_INT32       ///< This value ensures the enum size is consistent on both sides of the PPI.
} ERROR_COUNTER_MODE;
...
typedef enum {
  ...
  ClockGateABModedelim = MAX_INT32        ///< This value ensures the enum size is consistent on both sides of the PPI.
} CLOCK_GATE_AB_MODE;
...
typedef enum {
  ...
  ClockGateCModeDelim = MAX_INT32         ///< This value ensures the enum size is consistent on both sides of the PPI.
} CLOCK_GATE_C_MODE;
