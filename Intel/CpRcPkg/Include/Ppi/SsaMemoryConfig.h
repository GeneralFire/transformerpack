...
typedef enum {
  ...
  MrcBootModeDelim = MAX_INT32            ///< This value ensures the enum size is consistent on both sides of the PPI.
} MrcBootMode;
...
typedef enum {
  ...
  SsaMemoryDdr5   = 0x12,                 ///< DDR5 technology
  MemoryTechnologyMax,                    ///< MEMORY_TECHNOLOGY_TYPES enumeration maximum value.
  MemoryTechnologyDelim = MAX_INT32       ///< This value ensures the enum size is consistent on both sides of the PPI.
} MEMORY_TECHNOLOGY_TYPES;
...
typedef struct {
  ...
  MEMORY_TECHNOLOGY_TYPES MemoryTech;     ///< DIMM memory signaling technology.
...
typedef enum {
  ...
  MarginParamSpecificityDelim = MAX_INT32 ///< This value ensures the enum size is consistent on both sides of the PPI.
...
typedef enum {
  ...
  SetupCleanupDelim = MAX_INT32           ///< This value ensures the enum size is consistent on both sides of the PPI.
} SETUP_CLEANUP;
