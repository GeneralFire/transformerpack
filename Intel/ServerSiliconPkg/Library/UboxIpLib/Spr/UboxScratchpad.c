  ...
  )
{
  *KtiTop = UsraCsrRead (SocId, BoxInst, BIOSSCRATCHPAD2_UBOX_MISC_REG) | \
            LShiftU64 (UsraCsrRead (SocId, BoxInst, BIOSSTICKYLOCKBYPASSSCRATCHPAD5_UBOX_CFG_REG), 32);
  ...
  )
{
  ...
  UsraCsrWrite (SocId, BoxInst, BIOSSTICKYLOCKBYPASSSCRATCHPAD5_UBOX_CFG_REG, (UINT32) RShiftU64 (KtiTopology, 32));
