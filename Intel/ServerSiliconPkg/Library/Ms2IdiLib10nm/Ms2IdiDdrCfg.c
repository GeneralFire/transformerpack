  ...
  )
{
  ...
  SaiLowValue = UsraCsrRead (SocId, 0, LB_MCHECK_W_RAC_N0_MS2IDI_MAIN_REG);
  ...
  )
{
  ...
  SaiLowValue = UsraCsrRead (SocId, 0, LB_MCHECK_W_WAC_N0_MS2IDI_MAIN_REG);
  ...
  )
{
  ...
  SaiHighValue = UsraCsrRead (SocId, 0, LB_MCHECK_W_WAC_N1_MS2IDI_MAIN_REG);
  ...
  )
{
  ...
  SaiLowValue = UsraCsrRead (SocId, 0, LB_MCHECK_W_CP_N0_MS2IDI_MAIN_REG);
...
{
  UsraCsrWrite (SocId, MS2IDI_MULTICAST, LB_MCHECK_W_CP_N0_MS2IDI_MAIN_REG, SaiLowValue);
}
  ...
  )
{
  ...
  SaiHighValue = UsraCsrRead (SocId, 0, LB_MCHECK_W_CP_N1_MS2IDI_MAIN_REG);
  ...
  )
{
  ...
  DdrtQosCfg2.Data = UsraCsrRead (SocId, 0, DDRT_QOS_CFG2_MS2IDI_MAIN_REG);
  ...
  if (DdrtQosMode == DDRT_QOS_MODE_2) {
    DdrtQosCfg1.Data = UsraCsrRead (SocId, 0, DDRT_QOS_CFG1_MS2IDI_MAIN_REG);
    ...
    DdrtQosCfg3.Data = UsraCsrRead (SocId, 0, DDRT_QOS_CFG3_MS2IDI_MAIN_REG);
    DdrtQosCfg3.Bits.leakybktsatvalue = 0x10;
    UsraCsrWrite (SocId, MS2IDI_MULTICAST, DDRT_QOS_CFG3_MS2IDI_MAIN_REG, DdrtQosCfg3.Data);
  }
  TwolmQosConfig1.Data = UsraCsrRead (SocId, 0, TWOLM_QOS_CONFIG1_MS2IDI_MAIN_REG);
  ...
  TwolmQosConfig2.Data = UsraCsrRead (SocId, 0, TWOLM_QOS_CONFIG2_MS2IDI_MAIN_REG);
