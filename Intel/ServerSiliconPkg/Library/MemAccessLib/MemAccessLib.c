/** @file
  Implementation of MemoryAccessLib class library
  ...
  )
{
  ...
  USRA_CSR_MCID_OFFSET_ADDRESS (RegisterId, SocketId, McId, CsrOffset);
  ...
  )
{
  ...
  USRA_CSR_IOID_OFFSET_ADDRESS (RegisterId, SocketId, IoId, CsrOffset);
