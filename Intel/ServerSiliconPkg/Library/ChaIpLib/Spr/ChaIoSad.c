/** @file
  Configure DRAM related registers for 10nm.
...
{
  UINT32               MmiolRuleOffset[20] = { MMIO_RULE_CFG_0_CHABC_SAD1_REG,
                                               MMIO_RULE_CFG_1_CHABC_SAD1_REG,
                                               MMIO_RULE_CFG_2_CHABC_SAD1_REG,
                                               MMIO_RULE_CFG_3_CHABC_SAD1_REG,
                                               MMIO_RULE_CFG_4_CHABC_SAD1_REG,
                                               MMIO_RULE_CFG_5_CHABC_SAD1_REG,
                                               MMIO_RULE_CFG_6_CHABC_SAD1_REG,
                                               MMIO_RULE_CFG_7_CHABC_SAD1_REG,
                                               MMIO_RULE_CFG_8_CHABC_SAD1_REG,
                                               MMIO_RULE_CFG_9_CHABC_SAD1_REG,
                                               MMIO_RULE_CFG_10_CHABC_SAD1_REG,
                                               MMIO_RULE_CFG_11_CHABC_SAD1_REG,
                                               MMIO_RULE_CFG_12_CHABC_SAD1_REG,
                                               MMIO_RULE_CFG_13_CHABC_SAD1_REG,
                                               MMIO_RULE_CFG_14_CHABC_SAD1_REG,
                                               MMIO_RULE_CFG_15_CHABC_SAD1_REG,
                                               MMIO_RULE_CFG_16_CHABC_SAD1_REG,
                                               MMIO_RULE_CFG_17_CHABC_SAD1_REG,
                                               MMIO_RULE_CFG_18_CHABC_SAD1_REG,
                                               MMIO_RULE_CFG_19_CHABC_SAD1_REG};
  MMIO_RULE_CFG_0_CHABC_SAD1_STRUCT      MmioRule;

  MmioRule.Data = UsraCsrRead (SocId, BoxInst, MmiolRuleOffset[MmiolRuleRegIndex]);

  if (MmiolBase < MmiolLimit) {
    //
    // If MmiolBase >= MmiolLimit: Invalid Base and Limit parameters, only update rule_enable and target
    //
    MmioRule.Bits.baseaddress = MmiolBase >> 22;
    MmioRule.Bits.limitaddress = MmiolLimit >> 22;
  }

  MmioRule.Bits.rule_enable = EnableRule; // Enable the rule
  MmioRule.Bits.target = MmiolTarget;
  UsraCsrWrite (SocId, BoxInst, MmiolRuleOffset[MmiolRuleRegIndex], MmioRule.Data);
...
{
  UINT32               MmiohRuleOffset[19][2] = { { MMIOH_RULE_CFG_0_N0_CHABC_SAD1_REG, MMIOH_RULE_CFG_0_N1_CHABC_SAD1_REG },
                                                  ...
                                                  { MMIOH_RULE_CFG_13_N0_CHABC_SAD1_REG, MMIOH_RULE_CFG_13_N1_CHABC_SAD1_REG },
                                                  { MMIOH_RULE_CFG_14_N0_CHABC_SAD1_REG, MMIOH_RULE_CFG_14_N1_CHABC_SAD1_REG },
                                                  { MMIOH_RULE_CFG_15_N0_CHABC_SAD1_REG, MMIOH_RULE_CFG_15_N1_CHABC_SAD1_REG },
                                                  { MMIOH_RULE_CFG_16_N0_CHABC_SAD1_REG, MMIOH_RULE_CFG_16_N1_CHABC_SAD1_REG },
                                                  { MMIOH_RULE_CFG_17_N0_CHABC_SAD1_REG, MMIOH_RULE_CFG_17_N1_CHABC_SAD1_REG },
                                                  { MMIOH_RULE_CFG_18_N0_CHABC_SAD1_REG, MMIOH_RULE_CFG_18_N1_CHABC_SAD1_REG }};
          ...
          if (IfStackPresent (Socket, Stack)) {
            ...
            if ((MmiohBaseTmp.hi != 0xFFFFFFFF) && (MmiohBaseTmp.lo != 0xFFFFFFFF)) {
              ...
              if ((MmiohBaseTmp.hi < MmiohLimitTmp.hi) || ((MmiohBaseTmp.hi == MmiohLimitTmp.hi) && (MmiohBaseTmp.lo < MmiohLimitTmp.lo))) {
                ChaConfigureMmiohRule (SocId, 0, TargetIndex, Stack | SOCKET_LOCAL_5BITS_NID_MSB, MmiohBaseTmp, MmiohLimitTmp);
                TargetIndex++;
              }
            }
          } //if (StackPresent..
...
{
  MMIO_RULE_CFG_0_CHABC_SAD1_STRUCT         RuleLo;

  RuleLo.Data = UsraCsrRead(SocId, BoxInst, MMIO_RULE_CFG_19_CHABC_SAD1_REG);
  ...
  UsraCsrWrite(SocId, BoxInst, MMIO_RULE_CFG_19_CHABC_SAD1_REG, RuleLo.Data);
  ...
  )
{
  UINT32    MmcfgLocalRuleAddressOffset[] = { MMCFG_LOCAL_RULE_ADDRESS_CFG_0_CHABC_SAD1_REG,
                                              ...
                                              MMCFG_LOCAL_RULE_ADDRESS_CFG_2_CHABC_SAD1_REG,
                                              MMCFG_LOCAL_RULE_ADDRESS_CFG_3_CHABC_SAD1_REG};
  UINT32    MmcfgLocalRuleCfgOffset[] = { MMCFG_LOCAL_RULE_CHABC_SAD1_REG,
                                          MMCFG_LOCAL_RULE_CFG2_CHABC_SAD1_REG};
  UINT8     Index;
  ...
  for (Index = 0; Index < sizeof (MmcfgLocalRuleCfgOffset) / sizeof (UINT32); Index ++) {
    UsraCsrWrite (SocId, BoxInst, MmcfgLocalRuleCfgOffset[Index], *((volatile UINT32 *)(LocalRuleCfg + Index)));
  }
  ...
  )
{
  ...
  if (LocalRuleAddr != NULL) {
    ...
    LocalRuleAddr[2] = UsraCsrRead (SocId, BoxInst, MMCFG_LOCAL_RULE_ADDRESS_CFG_2_CHABC_SAD1_REG);
    LocalRuleAddr[3] = UsraCsrRead (SocId, BoxInst, MMCFG_LOCAL_RULE_ADDRESS_CFG_3_CHABC_SAD1_REG);
  }
  ...
  )
{
  ...
  UsraCsrWrite (SocId, BoxInst, MMCFG_LOCAL_RULE_ADDRESS_CFG_2_CHABC_SAD1_REG, LocalRuleAddr[2]);
  UsraCsrWrite (SocId, BoxInst, MMCFG_LOCAL_RULE_ADDRESS_CFG_3_CHABC_SAD1_REG, LocalRuleAddr[3]);
  ...
  )
{
  ...
  Data32 += (GetStackBus (SocId, 6) << 24);
  MMCFG_RULE_Addr[1] = Data32;
  Data32 = GetStackBus (SocId, 7);
  Data32 += (GetStackBus (SocId, 8) << 8);
  Data32 += (GetStackBus (SocId, 9) << 16);
  Data32 += (GetStackBus (SocId, 10) << 24);
  MMCFG_RULE_Addr[2] = Data32;
  Data32 = GetStackBus (SocId, 11);
  MMCFG_RULE_Addr[3] = Data32;
  Data32 = *MmcfgRule;
  Data32 |= BIT0;
  ...
  )
{
  ...
  UINT32    IoPortTargetOffset[] = { IOPORT_TARGET_LIST_CFG_0_CHABC_SAD_REG,
                                     ...
                                     IOPORT_TARGET_LIST_CFG_4_CHABC_SAD_REG,
                                     IOPORT_TARGET_LIST_CFG_5_CHABC_SAD_REG,
                                     IOPORT_TARGET_LIST_CFG_6_CHABC_SAD_REG,
                                     IOPORT_TARGET_LIST_CFG_7_CHABC_SAD_REG};

  for (RegIndex = 0; RegIndex < MAX_SAD_TARGETS/4; RegIndex++) {
    Data32 = UsraCsrRead (SocId, 0, IoPortTargetOffset[RegIndex]);

    for (TargetIndex = 0; TargetIndex < 4; TargetIndex++) {
      FieldMask = ~FLD_MASK(5, (TargetIndex*8));
      if (IoTgtLst[RegIndex*4 + TargetIndex] & SOCKET_LOCAL_FLAG) {
        Data32 = (Data32 & FieldMask) | ((IoTgtLst[RegIndex*4 + TargetIndex] & 0x1F | BIT4) <<  (8 * TargetIndex));
      } else if (IoTgtLst[RegIndex*4 + TargetIndex] & SOCKET_REMOTE_FLAG)  {
        Data32 = (Data32 & FieldMask) | ((IoTgtLst[RegIndex*4 + TargetIndex] & 0x1F) << (8 * TargetIndex));
      } else {
        Data32 = (Data32 & FieldMask) | (BIT4 <<  (8 * TargetIndex));
      }
    }
  ...
  )
{
  ...
  UINT32    Data32 = 0;
  UINT32    FieldMask = 0;
  UINT32    IoPortTargetOffset[] = { IOAPIC_TARGET_LIST_CFG_0_CHABC_SAD1_REG,
                                     IOAPIC_TARGET_LIST_CFG_1_CHABC_SAD1_REG,
                                     IOAPIC_TARGET_LIST_CFG_2_CHABC_SAD1_REG,
                                     IOAPIC_TARGET_LIST_CFG_3_CHABC_SAD1_REG,
                                     IOAPIC_TARGET_LIST_CFG_4_CHABC_SAD1_REG,
                                     IOAPIC_TARGET_LIST_CFG_5_CHABC_SAD1_REG,
                                     IOAPIC_TARGET_LIST_CFG_6_CHABC_SAD1_REG,
                                     IOAPIC_TARGET_LIST_CFG_7_CHABC_SAD1_REG};
  ...
  for (RegIndex = 0; RegIndex < MAX_SAD_TARGETS/4; RegIndex++) {
    ...
    for (TargetIndex = 0; TargetIndex < 4; TargetIndex++) {
      FieldMask = ~FLD_MASK(5, (TargetIndex*8));
      if (IoApicTgtLst[RegIndex*4 + TargetIndex] & SOCKET_LOCAL_FLAG) {
        Data32 = (Data32 & FieldMask) | ((IoApicTgtLst[RegIndex*4 + TargetIndex] & 0x1F | BIT4) <<  (8 * TargetIndex));
      } else if (IoApicTgtLst[RegIndex*4 + TargetIndex] & SOCKET_REMOTE_FLAG)  {
        Data32 = (Data32 & FieldMask) | ((IoApicTgtLst[RegIndex*4 + TargetIndex] & 0x1F) << (8 * TargetIndex));
      } else {
        Data32 = (Data32 & FieldMask) | (BIT4 <<  (8 * TargetIndex));
      }
    }
