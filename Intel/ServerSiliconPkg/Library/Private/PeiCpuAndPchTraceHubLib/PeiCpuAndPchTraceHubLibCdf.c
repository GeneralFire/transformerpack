/** @file
  This code provides functions CDF Trace Hub.
...
/**
  Get PCH Trace Hub configuration. This version is for CDF. Trace Hub config is in PCH_TRACE_HUB_PREMEM_CONFIG

  @param[in,out]  PchTraceHubConfig           Pointer to PCH Trace Hub configuration

**/
VOID
PeiPchTraceHubGetConfig (
