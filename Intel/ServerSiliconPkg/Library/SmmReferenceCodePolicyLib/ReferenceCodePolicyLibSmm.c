...
EFI_STATUS
EFIAPI
SmmReferenceCodePolicyLibConstructor (
  ...
  )
{
  ...
  SmmReferenceCodePolicyProtocol = NULL;
  if (mReferenceCodePolicy == NULL) {
    if (gSmst == NULL) {
      ASSERT (FALSE);
  ...
  mReferenceCodePolicy =  (REFERENCE_CODE_POLICY*)SmmReferenceCodePolicyProtocol;
