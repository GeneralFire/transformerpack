...
#ifndef __CREATE_MAX_RESULT_BUFFER_H__
#define __CREATE_MAX_RESULT_BUFFER_H__
...
#endif // __CREATE_MAX_RESULT_BUFFER_H__

// end file CreateMaxResultBuffer.h
