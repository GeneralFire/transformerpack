...
typedef enum {
  ...
  TurnaroundsTestModeDelim = MAX_INT32    ///< TURNAROUNDS_TEST_MODE enumeration delimiter value.
...
typedef enum {
  ...
  TurnaroundsPairModeDelim = MAX_INT32    ///< TURNAROUNDS_PAIR_MODE enumeration delimiter value.
...
typedef enum {
  ...
  DimmInitModeDelim = MAX_INT32           ///< DIMM_INIT_MODE enumeration delimiter value.
} DIMM_INIT_MODE;
...
typedef struct {
  ...
  UINT16 ChunkValBitmasks[MAX_CONTROLLER_CNT][MAX_CHANNEL_CNT];
