...
#else
  return UsraCsrRead (Socket, McId, VID_0_12_0_CFG_M2MEM_MAIN_REG);
#endif
}
  ...
  )
{
  ...
  TwoWayCacheReg.Data = UsraCsrRead (Socket, McId, TWOWAYCACHE_M2MEM_MAIN_REG);
  if (TwoWayCacheReg.Bits.enable) {
    M2MemDefeatures1.Data = UsraCsrRead (Socket, McId,  DEFEATURES1_M2MEM_MAIN_REG);
    M2MemDefeatures1.Bits.uconnmcacherducdata = 1;
    UsraCsrWrite (Socket, McId, DEFEATURES1_M2MEM_MAIN_REG, M2MemDefeatures1.Data);
  }
}
