...
typedef enum {
  ...
  /// respond to SMIs.
  /// This feature has been dropped since Targeted SMI do not support.
  ///
  SmmRegSmmEnable,
  ///
  /// Read-only register that returns a non-zero value if the CPU is able to
  ...
  SmmRegSmmBlocked,
  ///
  /// Read-write register that provides access to CBO_CR_SMMSEG_BASE_CFG if the
  /// CPU supports this CSR
  ///
  SmmRegChaSadSmmBase,
  ///
  /// Read-write register that provides access to CBO_CR_SMMSEG_LIMIT_CFG if the
  /// CPU supports this CSR
  ///
  SmmRegChaSadSmmLimit
} SMM_REG_NAME;
