/** @file
  CPU Late Policy PPI definition.
...
#ifndef __CPU_LATE_POLICY_PPI_H__
#define __CPU_LATE_POLICY_PPI_H__
...
///
#define CPU_LATE_POLICY_PPI_REVISION  0x1

typedef struct {
  ///
  /// This member specifies the revision of the CPU_LATE_POLICY_PPI. This field is used to
  /// indicate backwards compatible changes to the INTERFACE. Platform code that produces
  /// this INTERFACE must fill with the correct revision value for consumer code
...
extern EFI_GUID gPeiCpuLatePolicyPpiGuid;
