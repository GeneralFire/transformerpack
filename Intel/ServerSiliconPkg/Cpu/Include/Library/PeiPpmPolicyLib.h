/** @file
  Public API header file for the PpmPolicyPpiLib library class.
...
#ifndef __PEI_PPM_POLICY_LIB_H__
#define __PEI_PPM_POLICY_LIB_H__

#include <Ppi/PpmPolicyPpi.h>

/**
  Generate the default PPM Pei Policy.
