...
#define CPU_SNR        3     // Snowridge:         Atom core based Micro-Server
#define CPU_ICXSP      4     // Icelake-SP:        Mainstream Xeon – 10nm Wave 1
#define CPU_ICXD       5     // Icelake-D:         Xeon core based Micro-Server
#define CPU_SPRSP      6     // SapphireRapids-SP: Mainstream Xeon – 10nm Wave 3
#define CPU_TNR        7     // Tanner Ridge:      Atom core based Micro-Server
#define CPU_GNRSP      8     // GraniteRapids      Mainstream Xeon - 7nm Wave 4
#define CPU_SRFSP      9     // SierraForest       Atom core based - 7nm Wave 4
