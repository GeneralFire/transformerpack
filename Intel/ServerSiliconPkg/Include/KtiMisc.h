...
#define KTI_ASSERT(assertion, majorCode, minorCode) \
  if (!(assertion)) { \
    OemDebugPrintKti (KTI_DEBUG_ERROR, "\n\n %a: %u   %a ", __FILE__, __LINE__, #assertion); \
    KtiAssert (majorCode, minorCode);\
  }
#else
#define KTI_ASSERT(assertion, majorCode, minorCode) \
  if (!(assertion)) { \
...
//
// Map KTI prints to RcDebugLib
//
#define OemDebugPrintKti(KtiLevel, ...) \
  if (GetKtiDebugPrintLevel () & KtiLevel) { \
...
#define MINOR_STS_UNCORE_MESH_MODE_COMPLETE   0x01
...
#define MINOR_STS_EARLY_IO_SAD                0x04
...
#define MINOR_STS_TXEQ_ADAPTATION_START       0x03  // a round of txeq adaptation start
#define MINOR_STS_TXEQ_ADAPTATION_LOOPBACK    0x04  // fast loopback mode in txeq adaptation
#define MINOR_STS_TXEQ_ADAPTATION_SLOW        0x05  // slow mode in txeq adaptation
...
#define MINOR_ERR_PBSP_ENTER_HLT_FAILURE      0x03
#define MINOR_ERR_CPL1_TIMEOUT_FAILURE        0x04
...
#define MINOR_ERR_SLOW_MODE_WA_FAIL           0x07
...
#define MINOR_ERR_INVALID_KTI_PORT_ID         0x0B
#define MINOR_ERR_INVALID_FPGA_TOPOLOGY       0x0C
...
#define MINOR_ERR_SW_CHECK_7D                 0x7D
#define MINOR_ERR_SW_CHECK_7E                 0x7E
#define MINOR_ERR_SW_CHECK_7F                 0x7F
#define MINOR_ERR_SW_CHECK_80                 0x80
#define MINOR_ERR_SW_CHECK_81                 0x81
#define MINOR_ERR_SW_CHECK_82                 0x82
#define MINOR_ERR_SW_CHECK_83                 0x83
#define MINOR_ERR_SW_CHECK_84                 0x84
#define MINOR_ERR_SW_CHECK_85                 0x85
#define MINOR_ERR_SW_CHECK_86                 0x86
#define MINOR_ERR_SW_CHECK_87                 0x87
#define MINOR_ERR_SW_CHECK_88                 0x88
#define MINOR_ERR_SW_CHECK_89                 0x89
#define MINOR_ERR_SW_CHECK_8A                 0x8A
...
#define WARN_ADAPTATION_FAILED                0x06
...
#define WARN_KTI_MAX_ADDR_UNSUPPORTED         0x19
#define WARN_CPU_STEPPING_MISMATCH            0x10
#define WARN_TSC_SYNC_UNSUPPORTED             0x11

#define IsIcxFamilyCpu(CpuType) (((CpuType) == CPU_ICXSP) || ((CpuType) == CPU_ICXD) || \
                                 ((CpuType) == CPU_SNR) || ((CpuType) == CPU_TNR))

#define IsSkxFamilyCpu(CpuType) (((CpuType) == CPU_SKX) || ((CpuType) == CPU_CLX) || \
                                 ((CpuType) == CPU_CPX))

#define IsSprFamilyCpu(CpuType) ((CpuType) == CPU_SPRSP)

#define IsGnrSrfFamilyCpu(CpuType) (((CpuType) == CPU_GNRSP) || ((CpuType) == CPU_SRFSP))
