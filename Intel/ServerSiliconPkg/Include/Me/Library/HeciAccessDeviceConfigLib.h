...
**/
#ifndef _HECI_ACCESS_DEVICE_CONFIG_LIB_H_
#define _HECI_ACCESS_DEVICE_CONFIG_LIB_H_
...
GetHeciInitializationInfo (
  HECI_ACCESS_DEVICE_INITIALIZATION_DEFINITION  **HeciDeviceInitInfoReturn
);


#endif // _HECI_ACCESS_DEVICE_CONFIG_LIB_H_
