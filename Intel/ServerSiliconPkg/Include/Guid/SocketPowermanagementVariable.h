...
typedef struct {
  ...
  UINT8   ProcessorRaplPrioritization;      // used for ICX/SNR, SKX family
  UINT8   ProcessorSstCpSetting;            // used for SPR and future generation CPUs
  ...
  UINT8   PsysCsrLock;
  UINT8   OverridePplMaxMin;
  UINT16  MinPpl1Power;
  UINT16  MaxPpl1Power;
  UINT16  MaxPpl2Power;
  UINT8   MaxPplTimeWindow;

  UINT8   OverridePsysMaster;
  UINT8   PsysMaster[MAX_SOCKET];
  UINT8   PsysSlaveBitmap[MAX_SOCKET];
