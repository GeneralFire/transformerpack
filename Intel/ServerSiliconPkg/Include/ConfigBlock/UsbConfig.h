...
typedef struct {
  ...
  **/
  ...
  /**
    This policy setting controls state of Port Loopback Mode enabling.
    The ploicy is for CPU XHCI only in config block
    Loopback Mode can be enabled for testing through this option but defualt setting is Disabled.
    This is BitMap filed bit[n] is Port[n] 0:Disable, 1: Enable, bit[0] is Port[0]
  **/
  UINT32                   PortLoopbackModeBitMap;
  /**
  ...
  **/
  ...
  UINT32  RsvdBits2                : 31;     ///< Reserved bits
} USB_CONFIG;
