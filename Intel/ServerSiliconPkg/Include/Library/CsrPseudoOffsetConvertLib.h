/** @file
  Interface of getting pseudo register offset library.
...
#ifndef __CSR_PSEUDO_OFFSET_CONVERT_LIB_H__
#define __CSR_PSEUDO_OFFSET_CONVERT_LIB_H__
...
#endif //#ifndef __CSR_PSEUDO_OFFSET_CONVERT_LIB_H__
