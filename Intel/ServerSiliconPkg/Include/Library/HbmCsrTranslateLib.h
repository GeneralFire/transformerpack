/** @file
  HbmCsrTranslateLib.h

  This library provides functions to help caller to use HBM instance ID with
  DDR MC/CPGC register offset to access equavalent HBM MC/CPGC registers.
...
#ifndef _HBM_CSR_TRANSLATE_LIB_H_
#define _HBM_CSR_TRANSLATE_LIB_H_
...
#endif  // #ifndef _HBM_CSR_TRANSLATE_LIB_H_
