...
#define V_PCI_BRIDGE_BNUM_SCBN_SHIFT              8
...
#define  DWORD_MASK                               (BIT1|BIT0) // BIT1 | BIT0
#define  EXCAP_MASK                               0xFFFF
...
#define R_PCIE_LCAP2_OFFSET                       0x2C ///< Link Capabilities2 Register (Offset 2Ch)
...
#define R_PCIE_EX_AER_AECCR_OFFSET                0x18  ///< Advanced Error Capabilities and Control Register
#define B_PCIE_EX_AER_AECCR_EGC                   BIT5  ///< ECRC Generation Capable
#define B_PCIE_EX_AER_AECCR_EGE                   BIT6  ///< ECRC Generation Enable
#define B_PCIE_EX_AER_AECCR_ECC                   BIT7  ///< ECRC Check Capable
#define B_PCIE_EX_AER_AECCR_ECE                   BIT8  ///< ECRC Check Enable
...
//
// Define the DVSEC PCIE extended capability structure which is in PCIE spec 4.0
//
#define PCI_EXPRESS_EXTENDED_CAPABILITY_DESIGNATED_VENDOR_SPECIFIC_ID   0x0023

//
// PCIE extended capability -- Device Serial Number Capability
// Serail Number Register Offset
//
#define PCI_EXPRESS_EXTENDED_CAPABILITY_SERIAL_NUMBER_OFFSET    0x0004
