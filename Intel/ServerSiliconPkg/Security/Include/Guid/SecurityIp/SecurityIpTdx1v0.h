...
#ifndef _SECURITY_IP_TDX_1V0_H_
#define _SECURITY_IP_TDX_1V0_H_
...
} _SECURITY_IP_TDX_1V0_INPUTS_;

typedef struct {
    // NAK - Not a knob, used just for indication
  #include "SecurityIp/SecurityIpTdx1v0_Outputs.h"
} _SECURITY_IP_TDX_1V0_OUTPUTS_;

typedef struct {
  _SECURITY_IP_TDX_1V0_INPUTS_ In;
  _SECURITY_IP_TDX_1V0_OUTPUTS_ Out;
} SECURITY_IP_TDX_1V0;
