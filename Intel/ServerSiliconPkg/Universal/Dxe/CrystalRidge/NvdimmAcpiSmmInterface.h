...
#ifndef _NVDIMM_ACPI_SMM_INTERFACE_H_
#define _NVDIMM_ACPI_SMM_INTERFACE_H_
...
//
// NvDimmConfigBitmap0 - This is the bitmap for NVDIMMs present in socket 0 thru 3. Let us say that there are NVDIMMs present in dimm0 of socket 0 & 1,
...
typedef struct NVDIMM_ACPI_SMM_INTERFACE {
  UINT64           NvDimmConfigBitmap0;// This is the bitmap of NVDIMMs present in sockets 0 thru 3.
  UINT64           NvDimmConfigBitmap1;// This is the bitmap of NVDIMMs present in sockets 4 thru 7.
...
/**
  ...
  @retval EFI_SUCCESS                         NVIDMM ACPI SMM interface initialized successfully.
...
#endif //_NVDIMM_ACPI_SMM_INTERFACE_H_
