/** @file NvdimmAcpiSmmInterface.c
  Implmentation of NVDIMM ACPI SMM Interface
...
EFI_GUID mEfiNvdimmAcpiSmmInterfaceGuid = JEDEC_ACPI_SMM_INTERFACE_UEFI_VARIABLE_GUID;
  ...
  )
{
  ...
  Status = gRT->GetVariable (
                  JEDEC_ACPI_SMM_INTERFACE_UEFI_VARIABLE_NAME,
