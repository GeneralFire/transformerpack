  ...
  {
    {
      {
        PCIE_ADDR_TYPE,
        {R_PCH_PCIE_CFG_SMICSR}
      },
      S_PCH_PCIE_CFG_SMICSR,
      N_PCH_PCIE_CFG_SMICSR_HPSMIE
    },
    NULL_BIT_DESC_INITIALIZER
  },
  {
    {
      ...
      S_PCH_PCIE_CFG_SMICSR,
      N_PCH_PCIE_CFG_SMICSR_HPSMISTS
    }
  },
  {
    {
  ...
  {
    {
      ...
      S_PCH_PCIE_CFG_SMICSR,
      N_PCH_PCIE_CFG_SMICSR_HPLSCSMISTS
    }
  },
  {
    {
  ...
  )
{
  ...
  switch (PchSmiType) {
    ...
    case PchPcieSmiRpLinkEqType:
      ...
      RpContext.DmiMps = IioDmiGetMaxPayloadSize ();
