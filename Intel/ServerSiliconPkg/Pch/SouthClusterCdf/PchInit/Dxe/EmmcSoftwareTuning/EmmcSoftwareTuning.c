...
/**
  ...
  @param[in] TuningResults  Structure containing the result of the tuning.
**/
STATIC
VOID
  ...
  )
{
  ...
  EmmcBootScriptPciConfig = ScsGetEmmcS3BootScriptPciBaseAddress ();
  ...
  )
{
  ...
  EmmcPciConfig = ScsGetEmmcBaseAddress ();
