...
#define B_SPI_MEM_DLOCK_SSEQLOCKDN    BIT16                         ///< SSEQ Lock-Down
#define B_SPI_MEM_DLOCK_SPARE1        BIT15                         ///< Spare1
#define B_SPI_MEM_DLOCK_SPARE2        BIT14                         ///< Spare2
#define B_SPI_MEM_DLOCK_SPARE3        BIT13                         ///< Spare3
#define B_SPI_MEM_DLOCK_PR4LOCKDN     BIT12                         ///< PR4 Lock-Down
#define B_SPI_MEM_DLOCK_PR3LOCKDN     BIT11                         ///< PR3 Lock-Down
#define B_SPI_MEM_DLOCK_PR2LOCKDN     BIT10                         ///< PR2 Lock-Down
#define B_SPI_MEM_DLOCK_PR1LOCKDN     BIT9                          ///< PR1 Lock-Down
#define B_SPI_MEM_DLOCK_PR0LOCKDN     BIT8                          ///< PR0 Lock-Down
#define B_SPI_MEM_DLOCK_SPARE4        BIT7                          ///< Spare4
#define B_SPI_MEM_DLOCK_SPARE5        BIT6                          ///< Spare5
#define B_SPI_MEM_DLOCK_SPARE6        BIT5                          ///< Spare6
#define B_SPI_MEM_DLOCK_SPARE7        BIT4                          ///< Spare7
#define B_SPI_MEM_DLOCK_SBMRAGLOCKDN  BIT3                          ///< SBMRAG Lock-Down
#define B_SPI_MEM_DLOCK_SBMWAGLOCKDN  BIT2                          ///< SBMWAG Lock-Down
#define B_SPI_MEM_DLOCK_BMRAGLOCKDN   BIT1                          ///< BMRAG Lock-Down
#define B_SPI_MEM_DLOCK_BMWAGLOCKDN   BIT0                          ///< BMWAG Lock-Down
...
#define R_SPI_MEM_FREG5_PLATFORM_DATA       0x68                          ///< Flash Region 5(Platform Data)(32bits)
#define R_SPI_MEM_FREG6_SECONDARY_BIOS      0x6C                          ///< Flash Region 6(Secondary BIOS)(32bits)
#define R_SPI_MEM_FREG7_PLATFORM_DATA       0x70                          ///< Flash Region 7(Platform Data)(32bits)
#define R_SPI_MEM_FREG5_PLATFORM_DATA       0x68                          ///< Flash Region 5(Platform Data)(32bits)
...
#define B_SPI_FLASH_FLCOMP_ESPI_BUS_FREQ          (BIT19 | BIT18 | BIT17)   ///< eSPI / EC bus frequency.
#define N_SPI_FLASH_FLCOMP_ESPI_BUS_FREQ          17
#define V_SPI_FLASH_FLCOMP_ESPI_BUS_FREQ_20MHZ    0x00
#define V_SPI_FLASH_FLCOMP_ESPI_BUS_FREQ_24MHZ    0x01
#define V_SPI_FLASH_FLCOMP_ESPI_BUS_FREQ_30MHZ    0x02
#define V_SPI_FLASH_FLCOMP_ESPI_BUS_FREQ_48MHZ    0x03
#define V_SPI_FLASH_FLCOMP_ESPI_BUS_FREQ_60MHZ    0x04
...
#define B_SPI_PCR_PWR_CTL_EN_HAE        BIT5        ///< Hardware Autonomous Enable
#define B_SPI_PCR_PWR_CTL_EN_D3HE       BIT2        ///< D3 Hot Enable
#define B_SPI_PCR_PWR_CTL_EN_I3E        BIT1        ///< I3 Enable
#define B_SPI_PCR_PWR_CTL_EN_PMCRE      BIT0        ///< PMC Request Enable
...
//
// Descriptor Record 63
//
#define R_PCH_SPI_STRP_DSCR_63              0x40                      ///< PCH Soft Strap 63
#define B_PCH_SPI_STRP_DSCR_63_TSBS         (BIT6 | BIT5 | BIT4)      ///< Top Swap Block size
#define N_PCH_SPI_STRP_DSCR_63_TSBS         4                         ///< Top Swap Block size bit position
#define V_PCH_SPI_STRP_DSCR_63_TSBS_128K    1                         ///< Top Swap Block size 128KB

// Sideband private registers
#define R_SPI_MEM_SB_CADPDC                 0xC004                        ///< Clock and Deep Powerdown Controls
#define B_SPI_MEM_SB_CADPDC_SLSC_DCGE       BIT0                          ///< Sideband Logic, Sideband Clock, Dynamic Clock Gate Enable
#define B_SPI_MEM_SB_CADPDC_SLCC_DCGE       BIT1                          ///< Sideband Logic, Core Clock, Dynamic Clock Gate Enable
#define B_SPI_MEM_SB_CADPDC_PMSC_DCGE       BIT2                          ///< Power Management, Slow Clock, Dynamic Clock Gate Enable
#define B_SPI_MEM_SB_CADPDC_DSSC_DCGE       BIT3                          ///< DSW, Core Clock, Dynamic Clock Gate Enable
#define B_SPI_MEM_SB_CADPDC_PLPC_DCGE       BIT4                          ///< Primary Logic, Primary Clock, Dynamic Clock Gate Enable
#define B_SPI_MEM_SB_CADPDC_PLCC_DCGE       BIT5                          ///< Primary Logic, Core Clock, Dynamic Clock Gate Enable
#define B_SPI_MEM_SB_CADPDC_FCCC_DCGE       BIT8                          ///< Flash Core, Core Clock, Dynamic Clock Gate Enable
#define B_SPI_MEM_SB_CADPDC_ECCC_DCGE       BIT9                          ///< eSPI Core, Core Clock, Dynamic Clock Gate Enable
#define B_SPI_MEM_SB_CADPDC_SCCC_DCGE       BIT10                         ///< SPI Core, Core Clock, Dynamic Clock Gate Enable
#define V_SPI_MEM_SB_CADPDC_DCGE           (B_SPI_MEM_SB_CADPDC_SLSC_DCGE  |  \
                                            B_SPI_MEM_SB_CADPDC_SLCC_DCGE  |  \
                                            B_SPI_MEM_SB_CADPDC_PMSC_DCGE  |  \
                                            B_SPI_MEM_SB_CADPDC_DSSC_DCGE  |  \
                                            B_SPI_MEM_SB_CADPDC_PLPC_DCGE  |  \
                                            B_SPI_MEM_SB_CADPDC_PLCC_DCGE  |  \
                                            B_SPI_MEM_SB_CADPDC_FCCC_DCGE  |  \
                                            B_SPI_MEM_SB_CADPDC_ECCC_DCGE  |  \
                                            B_SPI_MEM_SB_CADPDC_SCCC_DCGE  )
