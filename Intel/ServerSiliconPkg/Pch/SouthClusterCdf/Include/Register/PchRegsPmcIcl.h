/** @file
  Register names for ICL PCH PMC device
...
#define V_ICL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_A       0x0
#define V_ICL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_B       0x1
#define V_ICL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_C       0x2
#define V_ICL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_D       0x3
#define V_ICL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_E       0x9
#define V_ICL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_F       0xA
#define V_ICL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_G       0x6
#define V_ICL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_H       0xB
#define V_ICL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_I       0xE
#define V_ICL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_J       0xD
#define V_ICL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_K       0xC
#define V_ICL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_R       0x4
#define V_ICL_PCH_H_PMC_PWRM_GPIO_CFG_GPP_S       0x5
#define V_ICL_PCH_H_PMC_PWRM_GPIO_CFG_GPD         0x8
#define V_ICL_PCH_H_PMC_PWRM_GPIO_CFG_VGPIO       0x7
#define V_ICL_PCH_H_PMC_PWRM_GPIO_CFG_VGPIO_0     0xF
#define V_ICL_PCH_H_PMC_PWRM_GPIO_CFG_VGPIO_3     0xF
#define V_ICL_PCH_H_PMC_PWRM_GPIO_CFG_SPI         0xF
#define V_ICL_PCH_H_PMC_PWRM_GPIO_CFG_CPU         0xF
#define V_ICL_PCH_H_PMC_PWRM_GPIO_CFG_JTAG        0xF
