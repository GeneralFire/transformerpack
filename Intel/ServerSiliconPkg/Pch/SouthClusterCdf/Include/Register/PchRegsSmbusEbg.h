...
//
// SMBus Hot Plug (SB PORT ID 0xC6)
//
#define PID_SMBUS_HOTPLUG                   0xC6


//
// SMBus Host Controller Registers (D30:F4)
//
#define PCI_BUS_NUMBER_SMBUS_HOST       0
#define PCI_DEVICE_NUMBER_SMBUS_HOST    30
#define PCI_FUNCTION_NUMBER_SMBUS_HOST  4
#define R_SMBUS_HOST_SMTBAR             0x10
#define B_SMBUS_HOST_SMTBAR_MBA         0xFFFFFFC00
#define R_SMBUS_IOSFDEVCLKGCTL          0xEC
#define V_SMBUS_IOSFDEVCLKGCTL_ICGE     BIT15
#define R_SMBUS_PLKCTL                  0xEA
#define B_SMBUS_PLKCTL_CL               BIT0
#define R_SMBUS_DEFEATURE               0x12C
#define B_SMBUS_DEFEATURE_CPERR         BIT0
#define B_SMBUS_DEFEATURE_DPERR         BIT1

//
// SMBus Host SMTBAR
// SMBDMA, C0
//
#define R_SMBUS_SMTBAR_MDBA           0x100
#define R_SMBUS_SMTBAR_MCTRL          0x108
#define B_SMBUS_SMTBAR_MCTRL_SPDDIS   BIT3
#define R_SMBUS_SMTBAR_TBBA           0x200
#define R_SMBUS_SMTBAR_SPGT           0x300
#define B_SMBUS_SMTBAR_SPGT_SPD      (BIT31 | BIT30)
#define V_SMBUS_SMTBAR_SPGT_80KHZ     0
#define V_SMBUS_SMTBAR_SPGT_100KHZ    BIT30
#define V_SMBUS_SMTBAR_SPGT_400KHZ    BIT31
#define V_SMBUS_SMTBAR_SPGT_1MHZ     (BIT31 | BIT30)

// PECI SMBus
//
#define PID_PECI_SMBUS              0x9B
#define R_PECI_SMBUS_SPGT           0x300
#define B_PECI_SMBUS_SPGT_SPD      (BIT31 | BIT30)
#define V_PECI_SMBUS_SPGT_80KHZ     0
#define V_PECI_SMBUS_SPGT_100KHZ    BIT30
#define V_PECI_SMBUS_SPGT_400KHZ    BIT31
#define V_PECI_SMBUS_SPGT_1MHZ     (BIT31 | BIT30)
...
#define B_SMBUS_PCR_PCE_D3HE              BIT2                        ///< D3-Hot Enable
#define B_SMBUS_PCR_PCE_I3E               BIT1                        ///< I3 Enable
#define B_SMBUS_PCR_PCE_PMCRE             BIT0                        ///< PMC Request Enable
