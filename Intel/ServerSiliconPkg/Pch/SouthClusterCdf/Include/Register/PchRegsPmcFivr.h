...
#define V_PMC_PWRM_IPC_SUBCMD_RFI_CTRL0_LOGIC               0x4848                      ///< IPC subcommand to control RFI Control 0 register logic write
#define V_PMC_PWRM_IPC_SUBCMD_RFI_CTRL0_FUSE                0x160                       ///< IPC subcommand to control RFI Control 0 register fuse write
#define V_PMC_PWRM_IPC_SUBCMD_EMI_CTRL0_LOGIC               0x4850                      ///< IPC subcommand to control EMI Control 0 register logic write
#define V_PMC_PWRM_IPC_SUBCMD_EMI_CTRL0_FUSE                0x164                       ///< IPC subcommand to control EMI Control 0 register fuse write
...
#define B_PMC_PWRM_CPPM_FIVR_POL1B_TNE_FIVR_VOLT_PRE_WAKE   0x1FFFF                     ///< TNTE PreWake for FIVR Voltage
