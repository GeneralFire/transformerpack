...
#define B_ESPI_CFG_CS1IORE_DPCS1RE                BIT14
...
#define B_RTC_PCR_BUC_LANDISABLE              BIT5                 ///< LAN Disable
...
#define B_LPC_PCR_PRC_HAE                     0x2000               //> Hardware Autonomous Enable
#define B_LPC_PRC_PRC_D3HE                     0x400               //> D3-Hot Enable
#define B_LPC_PRC_PRC_I3E                      0x200               //> I3 Enable
#define B_LPC_PRC_PRC_PMCPG_EN                 0x100               //> PMC Power Gating Enable
#define B_LPC_PCR_PRC_PGCBCGE                    0x8               //> PGCB Clock Gating Enable
#define B_LPC_PCR_PRC_IOSFP_INTF_CLKGATE_EN      0x4               //> IOSF-Primary Interface Clock Gating Enable
#define B_LPC_PCR_PRC_IOSFSB_INTF_CLKGATE_EN     0x2               //> IOSF-Sideband Interface Clock Gating Enable
#define B_LPC_PCR_PRC_LPC_CLK_GATE               0x1               //> LPC Clock Gate
...
#define B_ESPI_PCR_VWERR_SLV0_VWHC10OE        BIT25           ///< Master HOST_C10 (Virtual Wire) to Slave Enable (VWHC10OE)
...
#define B_ESPI_PCR_FCERR_FCNFES               BIT12           ///< Fatal Error Status
#define N_ESPI_PCR_FCERR_FCNFEC               8               ///< Flash Access Channel Error for Slave 0 bit position
#define V_ESPI_PCR_FCERR_FCNFEC_SRC_NFE       1               ///< Slave Response Code: NONFATAL_ERROR
#define V_ESPI_PCR_FCERR_FCNFEC_SCR_UC        2               ///< Slave Response Code: Unsuccessful Completion
#define V_ESPI_PCR_FCERR_FCNFEC_UCT           4               ///< Unsupported Cycle Type
#define V_ESPI_PCR_FCERR_FCNFEC_UA            6               ///< Unsupported Address
