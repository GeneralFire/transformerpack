...
//
// SMBus Hot Plug (SB PORT ID 0xCC)
//
#define PID_SMBUS_HOTPLUG                   0xCC


//
// SMBus Host Controller Registers (D15:F0)
//
#define PCI_BUS_NUMBER_SMBUS_HOST       0
#define PCI_DEVICE_NUMBER_SMBUS_HOST    15
#define PCI_FUNCTION_NUMBER_SMBUS_HOST  0
