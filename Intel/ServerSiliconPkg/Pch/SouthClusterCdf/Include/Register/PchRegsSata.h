...
#define PCI_DEVICE_NUMBER_PCH_SATA_1    7
#define PCI_FUNCTION_NUMBER_PCH_SATA_1  0

#define PCI_DEVICE_NUMBER_PCH_SATA_2    8
#define PCI_FUNCTION_NUMBER_PCH_SATA_2  0

#define PCI_DEVICE_NUMBER_PCH_SATA_3    14
...
//
//  CDF SATA Device ID's
//
#define V_PCH_CDF_SATA_DEVICE_ID_D_AHCI_1         0x18B3
#define V_PCH_CDF_SATA_DEVICE_ID_D_AHCI_2         0x18C3
#define V_PCH_CDF_SATA_DEVICE_ID_D_AHCI_3         0x18F3
#define V_PCH_CDF_SATA_DEVICE_ID_D_AHCI_1_A       0x18B2
#define V_PCH_CDF_SATA_DEVICE_ID_D_AHCI_2_A       0x18C2
#define V_PCH_CDF_SATA_DEVICE_ID_D_AHCI_3_A       0x18F2

//
//  ICL PCH-LP SATA Device ID's
//
#define V_ICL_PCH_LP_SATA_CFG_DEVICE_ID_M_AHCI        0x34D3  ///< SATA Controller (AHCI) - Mobile
#define V_ICL_PCH_LP_SATA_CFG_DEVICE_ID_M_RAID        0x34D5  ///< SATA Controller (RAID 0/1/5/10) - NOT premium - Mobile
#define V_ICL_PCH_LP_SATA_CFG_DEVICE_ID_M_RAID_PREM   0x34D7  ///< SATA Controller (RAID 0/1/5/10) - premium - Mobile

//
//  ICL PCH-N SATA Device ID's
//
#define V_ICL_PCH_N_SATA_CFG_DEVICE_ID_M_AHCI         0x38D3  ///< SATA Controller (AHCI) - Mobile
#define V_ICL_PCH_N_SATA_CFG_DEVICE_ID_M_RAID         0x38D5  ///< SATA Controller (RAID 0/1/5/10) - NOT premium - Mobile
#define V_ICL_PCH_N_SATA_CFG_DEVICE_ID_M_RAID_PREM    0x38D7  ///< SATA Controller (RAID 0/1/5/10) - premium - Mobile

//
//  ICL PCH-H SATA Device ID's
//
#define V_ICL_PCH_H_SATA_CFG_DEVICE_ID_D_AHCI         0x3DD3  ///< SATA Controller (AHCI)
#define V_ICL_PCH_H_SATA_CFG_DEVICE_ID_D_RAID         0x3DD5  ///< SATA Controller (RAID 0/1/5/10) - NOT premium
#define V_ICL_PCH_H_SATA_CFG_DEVICE_ID_D_RAID_PREM    0x3DD7  ///< SATA Controller (RAID 0/1/5/10) - premium
#define V_ICL_PCH_H_SATA_CFG_DEVICE_ID_D_RAID_IBC_1   0x2822  ///< SATA Controller (RAID 0/1/5/10) - In-box compatible
#define V_ICL_PCH_H_SATA_CFG_DEVICE_ID_D_RAID_IBC_2   0x2826  ///< SATA Controller (RAID 0/1/5/10) - In-box compatible

#define V_ICL_PCH_SATA_CFG_DEVICE_ID_RAID_IBC         0x282A  ///< SATA Controller (RAID 0/1/5/10) - In-box compatible - LP/N/H
...
#define B_SATA_CFG_SATAGC_CPEE              BIT11
#define B_SATA_CFG_SATAGC_DPPEE             BIT15
...
#define B_SATA_MEM_VS_CAP_MSL               0x1FFE                          ///< Memory Space Limit
#define N_SATA_MEM_VS_CAP_MSL               1
#define V_SATA_MEM_VS_CAP_MSL               0x1EF                           ///< Memory Space Limit Field Value
#define B_SATA_MEM_VS_CAP_NRMO              0xFFF0000                       ///< NVM Remapped Memory Offset
...
#define R_SATA_MEM_RST_PCIE_STORAGE_SPR                 0x80C                           ///< Scratch Pad Register
...
#define IS_PCH_H_SATA_AHCI_DEVICE_ID(DeviceId) \
    ( \
      (DeviceId == V_ICL_PCH_H_SATA_CFG_DEVICE_ID_D_AHCI) \
    )

#define IS_PCH_CDF_SATA_AHCI_DEVICE_ID(DeviceId) \
    ( \
      (DeviceId == V_PCH_CDF_SATA_DEVICE_ID_D_AHCI_1)  ||\
      (DeviceId == V_PCH_CDF_SATA_DEVICE_ID_D_AHCI_2)  ||\
      (DeviceId == V_PCH_CDF_SATA_DEVICE_ID_D_AHCI_3)  ||\
      (DeviceId == V_PCH_CDF_SATA_DEVICE_ID_D_AHCI_1_A)  ||\
      (DeviceId == V_PCH_CDF_SATA_DEVICE_ID_D_AHCI_2_A)  ||\
      (DeviceId == V_PCH_CDF_SATA_DEVICE_ID_D_AHCI_3_A) \
    )

#define IS_PCH_LP_SATA_AHCI_DEVICE_ID(DeviceId) \
    ( \
      (DeviceId == V_ICL_PCH_LP_SATA_CFG_DEVICE_ID_M_AHCI) \
    )

#define IS_PCH_N_SATA_AHCI_DEVICE_ID(DeviceId) \
    ( \
      (DeviceId == V_ICL_PCH_N_SATA_CFG_DEVICE_ID_M_AHCI) \
    )
...
#define IS_PCH_SATA_AHCI_DEVICE_ID(DeviceId) \
    ( \
      ...
      IS_PCH_N_SATA_AHCI_DEVICE_ID(DeviceId) ||\
      IS_PCH_CDF_SATA_AHCI_DEVICE_ID(DeviceId) \
    )
...
#define IS_PCH_H_SATA_RAID_DEVICE_ID(DeviceId) \
    ( \
      (DeviceId == V_ICL_PCH_H_SATA_CFG_DEVICE_ID_D_RAID) || \
      (DeviceId == V_ICL_PCH_H_SATA_CFG_DEVICE_ID_D_RAID_PREM) || \
      (DeviceId == V_ICL_PCH_H_SATA_CFG_DEVICE_ID_D_RAID_IBC_1) || \
      (DeviceId == V_ICL_PCH_H_SATA_CFG_DEVICE_ID_D_RAID_IBC_2) || \
      (DeviceId == V_ICL_PCH_SATA_CFG_DEVICE_ID_RAID_IBC) \
    )

#define IS_PCH_LP_SATA_RAID_DEVICE_ID(DeviceId) \
    ( \
      (DeviceId == V_ICL_PCH_LP_SATA_CFG_DEVICE_ID_M_RAID) || \
      (DeviceId == V_ICL_PCH_LP_SATA_CFG_DEVICE_ID_M_RAID_PREM) || \
      (DeviceId == V_ICL_PCH_SATA_CFG_DEVICE_ID_RAID_IBC) \
    )

#define IS_PCH_N_SATA_RAID_DEVICE_ID(DeviceId) \
    ( \
      (DeviceId == V_ICL_PCH_N_SATA_CFG_DEVICE_ID_M_RAID) || \
      (DeviceId == V_ICL_PCH_N_SATA_CFG_DEVICE_ID_M_RAID_PREM) || \
      (DeviceId == V_ICL_PCH_SATA_CFG_DEVICE_ID_RAID_IBC) \
    )
...
#define IS_PCH_SATA_RAID_DEVICE_ID(DeviceId) \
    ( \
      ...
      IS_PCH_N_SATA_RAID_DEVICE_ID(DeviceId) \
    )
...
#define IS_PCH_N_SATA_DEVICE_ID(DeviceId) \
    ( \
      IS_PCH_N_SATA_AHCI_DEVICE_ID(DeviceId) || \
      IS_PCH_N_SATA_RAID_DEVICE_ID(DeviceId) \
    )
...
#define IS_PCH_SATA_DEVICE_ID(DeviceId) \
    ( \
      ...
      IS_PCH_N_SATA_DEVICE_ID(DeviceId) \
    )
