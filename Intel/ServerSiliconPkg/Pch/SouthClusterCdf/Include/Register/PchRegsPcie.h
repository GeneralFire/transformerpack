...
#define V_ICL_PCH_LP_PCIE_CFG_DEVICE_ID_PORT1         0x34B8  ///< PCI Express Root Port #1, ICL PCH LP PCIe Device ID
#define V_ICL_PCH_LP_PCIE_CFG_DEVICE_ID_PORT2         0x34B9  ///< PCI Express Root Port #2, ICL PCH LP PCIe Device ID
#define V_ICL_PCH_LP_PCIE_CFG_DEVICE_ID_PORT3         0x34BA  ///< PCI Express Root Port #3, ICL PCH LP PCIe Device ID
#define V_ICL_PCH_LP_PCIE_CFG_DEVICE_ID_PORT4         0x34BB  ///< PCI Express Root Port #4, ICL PCH LP PCIe Device ID
#define V_ICL_PCH_LP_PCIE_CFG_DEVICE_ID_PORT5         0x34BC  ///< PCI Express Root Port #5, ICL PCH LP PCIe Device ID
#define V_ICL_PCH_LP_PCIE_CFG_DEVICE_ID_PORT6         0x34BD  ///< PCI Express Root Port #6, ICL PCH LP PCIe Device ID
#define V_ICL_PCH_LP_PCIE_CFG_DEVICE_ID_PORT7         0x34BE  ///< PCI Express Root Port #7, ICL PCH LP PCIe Device ID
#define V_ICL_PCH_LP_PCIE_CFG_DEVICE_ID_PORT8         0x34BF  ///< PCI Express Root Port #8, ICL PCH LP PCIe Device ID
#define V_ICL_PCH_LP_PCIE_CFG_DEVICE_ID_PORT9         0x34B0  ///< PCI Express Root Port #9, ICL PCH LP PCIe Device ID
#define V_ICL_PCH_LP_PCIE_CFG_DEVICE_ID_PORT10        0x34B1  ///< PCI Express Root Port #10, ICL PCH LP PCIe Device ID
#define V_ICL_PCH_LP_PCIE_CFG_DEVICE_ID_PORT11        0x34B2  ///< PCI Express Root Port #11, ICL PCH LP PCIe Device ID
#define V_ICL_PCH_LP_PCIE_CFG_DEVICE_ID_PORT12        0x34B3  ///< PCI Express Root Port #12, ICL PCH LP PCIe Device ID
#define V_ICL_PCH_LP_PCIE_CFG_DEVICE_ID_PORT13        0x34B4  ///< PCI Express Root Port #13, ICL PCH LP PCIe Device ID
#define V_ICL_PCH_LP_PCIE_CFG_DEVICE_ID_PORT14        0x34B5  ///< PCI Express Root Port #14, ICL PCH LP PCIe Device ID
#define V_ICL_PCH_LP_PCIE_CFG_DEVICE_ID_PORT15        0x34B6  ///< PCI Express Root Port #15, ICL PCH LP PCIe Device ID
#define V_ICL_PCH_LP_PCIE_CFG_DEVICE_ID_PORT16        0x34B7  ///< PCI Express Root Port #16, ICL PCH LP PCIe Device ID
...
//
#define B_PCH_PCIE_CFG_PTMECFG_PLTLFF                 (BIT20 | BIT19 | BIT18)
#define N_PCH_PCIE_CFG_PTMECFG_PLTLFF                 18
#define V_PCH_PCIE_CFG_PTMECFG_PLTLFF                 0x1
#define B_PCH_PCIE_CFG_PTMECFG_PGTSCFF                (BIT11 | BIT10 | BIT9)
#define N_PCH_PCIE_CFG_PTMECFG_PGTSCFF                9
#define B_PCH_PCIE_CFG_PTMECFG_PGTSCFE                BIT8
#define B_PCH_PCIE_CFG_PTMECFG_PTMRPAE                BIT6
#define B_PCH_PCIE_CFG_PTMECFG_PTMRNOPAD              (BIT5 | BIT4)
#define N_PCH_PCIE_CFG_PTMECFG_PTMRNOPAD              4
#define V_PCH_PCIE_CFG_PTMECFG_PTMRNOPAD              0x1
#define B_PCH_PCIE_CFG_PTMECFG_IOSF                   (BIT3 | BIT2 | BIT1 | BIT0)
#define V_PCH_PCIE_CFG_PTMECFG_IOSF                   0x2

#define V_PCH_PCIE_CFG_PTMECFG_OR_MASK                (V_PCH_PCIE_CFG_PTMECFG_PLTLFF << N_PCH_PCIE_CFG_PTMECFG_PLTLFF | \
                                                      B_PCH_PCIE_CFG_PTMECFG_PTMRPAE | \
                                                      V_PCH_PCIE_CFG_PTMECFG_PTMRNOPAD << N_PCH_PCIE_CFG_PTMECFG_PTMRNOPAD | \
                                                      V_PCH_PCIE_CFG_PTMECFG_IOSF)
#define V_PCH_PCIE_CFG_PTMECFG_AND_MASK               (UINT32) ~ (B_PCH_PCIE_CFG_PTMECFG_PLTLFF | \
                                                      B_PCH_PCIE_CFG_PTMECFG_PGTSCFF | \
                                                      B_PCH_PCIE_CFG_PTMECFG_PGTSCFE | \
                                                      B_PCH_PCIE_CFG_PTMECFG_PTMRPAE | \
                                                      B_PCH_PCIE_CFG_PTMECFG_PTMRNOPAD | \
                                                      B_PCH_PCIE_CFG_PTMECFG_IOSF)
...
// remove flags after sync to client
//
#define R_PCH_PCIE_BIFURCATION_CONFIG_REG              R_PCH_PCIE_CFG_STRPFUSECFG
#define B_PCH_PCIE_BIFURCATION_CONFIG_REG              B_PCH_PCIE_CFG_STRPFUSECFG_RPC
#define N_PCH_PCIE_BIFURCATION_CONFIG_REG              N_PCH_PCIE_CFG_STRPFUSECFG_RPC
#define PCH_PCIE_BIFURCATION_CONFIG_REG_ACCESS_TYPE    PciConfigRead

#define V_PCH_PCIE_BIFURCATION_CONFIG_REG_UNSUPPORTED  0xFFFFFFFF
#define V_PCH_PCIE_BIFURCATION_CONFIG_REG_1_1_1_1      V_PCH_PCIE_CFG_STRPFUSECFG_RPC_1_1_1_1
#define V_PCH_PCIE_BIFURCATION_CONFIG_REG_2_1_1        V_PCH_PCIE_CFG_STRPFUSECFG_RPC_2_1_1
#define V_PCH_PCIE_BIFURCATION_CONFIG_REG_2_2          V_PCH_PCIE_CFG_STRPFUSECFG_RPC_2_2
#define V_PCH_PCIE_BIFURCATION_CONFIG_REG_4            V_PCH_PCIE_CFG_STRPFUSECFG_RPC_4
#define V_PCH_PCIE_BIFURCATION_CONFIG_REG_2_2_2_2      V_PCH_PCIE_BIFURCATION_CONFIG_REG_UNSUPPORTED
#define V_PCH_PCIE_BIFURCATION_CONFIG_REG_4_2_2        V_PCH_PCIE_BIFURCATION_CONFIG_REG_UNSUPPORTED
#define V_PCH_PCIE_BIFURCATION_CONFIG_REG_2_2_4        V_PCH_PCIE_BIFURCATION_CONFIG_REG_UNSUPPORTED
#define V_PCH_PCIE_BIFURCATION_CONFIG_REG_4_4          V_PCH_PCIE_BIFURCATION_CONFIG_REG_UNSUPPORTED
#define V_PCH_PCIE_BIFURCATION_CONFIG_REG_8            V_PCH_PCIE_BIFURCATION_CONFIG_REG_UNSUPPORTED
