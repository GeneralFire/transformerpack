...
#define B_PMC_CFG_PWRM_BASE_MASK                             0xFFFFE000                    ///< PWRM must be 64KB alignment to align the source decode.
...
#define V_PMC_PWRM_IPC_CMD_WBUF0_SET_STRAP_MSG_DW1          0xAA4
#define V_PMC_PWRM_IPC_CMD_WBUF0_SET_STRAP_MSG_DW2          0xAA8
#define V_PMC_PWRM_IPC_CMD_WBUF0_SET_STRAP_MSG_DW3          0xAAC
...
#define V_PMC_PWRM_IPC_CMD_WMPHY_IO_MARGINING_ENABLE        0xAF                        ///< Enable I/O margining
...
#define B_PMC_PWRM_GEN_PMCON_B_ACPI_BASE_LOCK               BIT17            ///< Lock down the Base Address Register (ABASE)
...
#define B_PMC_PWRM_BIOS_SCRATCHPAD_1_BCLK_S3                BIT1             ///< BCLK S3 bit indicates BCLK OC reset occured during S3 resume.
...
#define B_PMC_PWRM_MODPHY_PM_CFG1_MLS0SWPGP                 0xFFFFFF ///< ModPHY Lane S0 SUS Well Power Gating Policy [29:0]
#define R_PMC_PWRM_MODPHY_PM_CFG2                           0x10C4
#define B_PMC_PWRM_MODPHY_PM_CFG2_MLSXSWPGP                 0xFFFFFF ///< ModPHY Lane Sx SUS Well Power Gating Policy [29:0]
...
#ifdef EBG_SC_FLAG
  #define B_PMC_PWRM_MODPHY_PM_CFG4_ASLOR                   0xFFFFFFFF //< ASL Over-rides [31:0]
#else
  #define B_PMC_PWRM_MODPHY_PM_CFG4_ASLOR                   0x3FFFFFF //< ASL Over-rides [25:0]
#endif // EBG_SC_FLAG
#define B_PMC_PWRM_MODPHY_PM_CFG4_ASLOR_UFS                 BIT16    ///< UFS ModPHY SPD SPD Override
#define R_PMC_PWRM_MODPHY_PM_CFG5                           0x10D0
#define B_PMC_PWRM_MODPHY_PM_CFG5_MSPDRTREQ                 0x7FFFFFF //< Controller SPD RTD3 Request [25:0]
...
#ifdef EBG_SC_FLAG
  #define B_PMC_PWRM_MODPHY_PM_CFG6_MSPDRTRACK              0xFFFFFFFF ///< Controller SPD RTD3 Request Acknowledge [31:0]
#else
  #define B_PMC_PWRM_MODPHY_PM_CFG6_MSPDRTRACK              0x7FFFFFF ///< Controller SPD RTD3 Request Acknowledge [19:0]
#endif // EBG_SC_FLAG
...
#define B_PMC_PWRM_GBETSN_PA_SLOW_RING                      BIT26                       ///< GBETSN Pegged Active to SLOW_RING
...
#define B_PMC_PWRM_GBETSN_PA_SA                             BIT26                       ///< GBETSN Pegged Active to SA
#define R_PMC_PWRM_EN_MISC_EVENT                            0x18C0                      ///< Enable Misc PM_SYNC Events
#define R_PMC_PWRM_PMSYNC_TPR_CONFIG                        0x18C4
#define B_PMC_PWRM_PMSYNC_TPR_CONFIG_CFG_LOCK               BIT31
#define R_PMC_PWRM_SLP_S0_RESIDENCY_COUNTER                 0x193C

#define V_PMC_PWRM_EN_SN_SLOW_RING2                                 1
#define V_PMC_PWRM_EN_SN_SA2                                        1
#define V_PMC_PWRM_EN_SN_SLOW_RING_CF                               0x00018000
#define V_PMC_PWRM_EN_CW_SLOW_RING                                  0x3F8DA101
#define V_PMC_PWRM_EN_CW_SLOW_RING2                                 0x0280D7E1
#define V_PMC_PWRM_EN_CW_SA                                         0x37858001
#define V_PMC_PWRM_EN_CW_SA2                                        0x0000C500
#define V_PMC_PWRM_EN_CW_SLOW_RING_CF                               0x00018000
#define V_PMC_PWRM_EN_PA_SLOW_RING2                                 0x02006001
#define V_PMC_PWRM_EN_PA_SA2                                        0x00006001
#define V_PMC_PWRM_PM_SYNC_STATE_HYS                                0x00200840
#define V_PMC_PWRM_PM_SYNC_MODE                                     0x7000F4E6
...
#define B_PMC_PWRM_PM_DOWN_PPB_CFG_LOCK                     BIT0
...
#define R_PMC_PWRM_TSC_OVRD_CFG                             0x1918
#define B_PMC_PWRM_TSC_OVRD_CFG_LOCK                        BIT31
...
#define R_PMC_PWRM_THROT_1_LOCK                             BIT15
...
#define B_PMC_PWRM_GBL2HOST_EN_G2H_FEAT_EN                  BIT0     ///< G2H Feature Enable
