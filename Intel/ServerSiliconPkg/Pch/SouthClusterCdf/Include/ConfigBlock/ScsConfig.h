...
typedef struct {
  ...
  UINT32      Reserved       : 29;
  SCS_SD_DLL  CustomDllValues;     ///<  Structure containing custom DLL values for eMMC
...
typedef struct {
  ...
  SCS_EMMC_SOFTWARE_TUNING_RESULTS  PreviousTuningResults;  ///< Informes software tuning module about previous software tuning results.
} SCS_EMMC_DXE_CONFIG;
