...
typedef struct {
  ...
  **/
  ...
  UINT32  PchAllUnlock   :  1;            ///< Unlock all locable registers in PCH. <b>0: Lock</b>; 1: Unlock.
  UINT32  BiosWpd        :  1;            ///< Bios write disable. 0: Protection enabled; 1: Protection disabled.
