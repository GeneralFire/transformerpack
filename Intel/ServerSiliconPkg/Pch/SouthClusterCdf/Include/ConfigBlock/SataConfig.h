...
typedef struct {
  ...
  **/
  UINT8                         SataMode;
  /**
    Indicates the maximum speed the SATA controller can support (PCH_SATA_SPEED)
    <b>0h: PchSataSpeedDefault</b>; 1h: 1.5 Gb/s (Gen 1); 2h: 3 Gb/s(Gen 2); 3h: 6 Gb/s (Gen 3)
  **/
  UINT8                         SpeedLimit;
  UINT8                         Rsvd1[2];
  /**
