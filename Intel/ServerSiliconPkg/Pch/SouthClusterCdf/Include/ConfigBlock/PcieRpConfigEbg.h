...
#include <PchLimits.h>
#include <ConfigBlock/PcieConfig.h>
...
typedef struct {
  ...
  /// Entries in the PcieEqCoefficientsList or PcieEqPresetList(depending on chosen mode) need to be valid up to the number specified in this field.
  ///
