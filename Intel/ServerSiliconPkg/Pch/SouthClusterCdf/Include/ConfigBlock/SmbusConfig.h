...
#define PchSMBusStandard80Khz     0x0
#define PchSMBusStandard100Khz    0x1
#define PchSMBusFastMode400Khz    0x2
#define PchSMBusFastModePlus1Mhz  0x3
///
...
typedef struct {
  ...
  **/
  ...
  UINT32  SmbusDefeaturing     :  1;    ///< Enable SMBus defeaturing. 0: Disabled, 1: <b>Enabled<b>.
  UINT32  DmaSmbusEnable       :  1;
