...
#define GPIO_NATIVE_GET_GPIO_PAD(GpioNativePad) ((GpioNativePad) & 0x0F1F01FF)
...
#define GPIO_VISA_CLK              GPIO_NATIVE_FUNCTION_DEF(372,373)
#define GPIO_VISA_D0               GPIO_NATIVE_FUNCTION_DEF(374,375)
#define GPIO_VISA_D1               GPIO_NATIVE_FUNCTION_DEF(376,377)
#define GPIO_VISA_D2               GPIO_NATIVE_FUNCTION_DEF(378,379)
#define GPIO_VISA_D3               GPIO_NATIVE_FUNCTION_DEF(380,381)
#define GPIO_VISA_D4               GPIO_NATIVE_FUNCTION_DEF(382,383)
#define GPIO_VISA_D5               GPIO_NATIVE_FUNCTION_DEF(384,385)
#define GPIO_VISA_D6               GPIO_NATIVE_FUNCTION_DEF(386,387)
#define GPIO_VISA_D7               GPIO_NATIVE_FUNCTION_DEF(388,389)
#define GPIO_SML_CLK               GPIO_NATIVE_FUNCTION_DEF(390,390)
#define GPIO_SML_DATA              GPIO_NATIVE_FUNCTION_DEF(391,391)
...
// VISA Interface
//
#define GPIO_VISA_RANGE               2     // Number of VISA interface instances supported in GPIO_NATIVE_PAD encodig

#define GPIO_FUNCTION_VISA_CLK(ChanIndex)   (GPIO_VISA_CLK + ((UINT32)ChanIndex))
#define GPIO_FUNCTION_VISA_D0(ChanIndex)    (GPIO_VISA_D0  + ((UINT32)ChanIndex))
#define GPIO_FUNCTION_VISA_D1(ChanIndex)    (GPIO_VISA_D1  + ((UINT32)ChanIndex))
#define GPIO_FUNCTION_VISA_D2(ChanIndex)    (GPIO_VISA_D2  + ((UINT32)ChanIndex))
#define GPIO_FUNCTION_VISA_D3(ChanIndex)    (GPIO_VISA_D3  + ((UINT32)ChanIndex))
#define GPIO_FUNCTION_VISA_D4(ChanIndex)    (GPIO_VISA_D4  + ((UINT32)ChanIndex))
#define GPIO_FUNCTION_VISA_D5(ChanIndex)    (GPIO_VISA_D5  + ((UINT32)ChanIndex))
#define GPIO_FUNCTION_VISA_D6(ChanIndex)    (GPIO_VISA_D6  + ((UINT32)ChanIndex))
#define GPIO_FUNCTION_VISA_D7(ChanIndex)    (GPIO_VISA_D7  + ((UINT32)ChanIndex))

//
// SML
//
#define GPIO_SML_RANGE                1     // Number of SML device instances supported in GPIO_NATIVE_PAD encodig

#define GPIO_FUNCTION_SML_CLK(SmlDev)       (GPIO_SML_CLK  + (UINT32)SmlDev)
#define GPIO_FUNCTION_SML_DATA(SmlDev)      (GPIO_SML_DATA + (UINT32)SmlDev)
