...
typedef struct {
  ...
  **/
  ...
  UINT32   SMBusIOSFClockGating   :  1;
  UINT32   SmbusDefeaturing       :  1;
  UINT32   RsvdBits0              : 29;
...
/**
  The HSUART_HOB block describes HSUART device.
**/
typedef struct {
  UINT8                        HsuartMode[3];
  UINT8                        Rsvd0;
...
typedef struct {
  UINT32  Enabled               :  1;  ///< Indicates if controller has been enabled
  UINT32  PowerEnableActiveHigh :  1;  ///< SD_PWREN# active high
  UINT32  Reserved              : 30;
} SD_CARD_HOB;
...
typedef struct {
  ...
  **/
  UINT32  BiosLock        :  1;
  UINT32  SpiEiss         :  1; ///< Separate EISS policy to be handled separately from BiosLock
  UINT32  BiosWpd         :  1;
  /**
    BIOS Write Protect Disable.
    0: Enable write protection; 1: Disable write protection.
   **/
  UINT32  RsvdBits        : 27;
} LOCK_DOWN_HOB;
...
**/
typedef struct {
  UINT32 S0i3Support            :  1; ///< S0i3 Support. 0: Disable; <b>1: Enable; </b>;
...
**/
typedef struct {
  UINT32  PchTraceHubMode; ///< <b>0 = Disable</b>; 1 = Target Debugger mode; 2 = Host Debugger mode
  UINT32  MemReg0Size;
  UINT32  MemReg1Size;
} PCH_TRACEHUB_HOB;
...
typedef struct {
  ...
  SD_CARD_HOB        SdCard;             ///< SdCard HOB definition
