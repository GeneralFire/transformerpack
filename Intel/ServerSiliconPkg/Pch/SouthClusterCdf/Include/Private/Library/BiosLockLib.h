...
/**
  ...
  The usage to disable EISS is to support set variable in PEI phase.
...
/**
  ...
  @param[in] SpiEissEnable      Policy for SpiEissEnable bit programming
  @param[in] BiosInterfaceLock  Policy for BiosInterfaceLock bit programming

**/
VOID
BiosLockEnableAndBiosInterfaceLockWithS3BootScript (
  IN BOOLEAN  BiosLockEnable,
  IN BOOLEAN  SpiEissEnable,
