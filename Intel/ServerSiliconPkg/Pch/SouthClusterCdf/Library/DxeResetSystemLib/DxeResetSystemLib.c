  ...
  )
{
  ...
  switch (ResetType) {
    case EfiResetCold:
      ResetTypeMessage = "Cold Reset";
      break;
    case EfiResetWarm:
      ResetTypeMessage = "Warm Reset";
      break;
    case EfiResetShutdown:
      ResetTypeMessage = "Shutdown Reset";
      break;
    case EfiResetPlatformSpecific:
      ResetTypeMessage = "Platform Specific Reset";
      break;
    default:
      ResetTypeMessage = "Unknown Reset";
      break;
  }
  ...
  )
{
  ...
  DumpResetMessage (EfiResetShutdown);
  ...
  )
{
  ...
  DumpResetMessage (EfiResetPlatformSpecific);
  //
