...
// Note: Prototype available in ResetSystemLib.h (edk2\mdemodulepkg\include\library) i client bios
/**
  ...
  )
{
  ...
  case EfiResetPlatformSpecific:
    ...
    DEBUG((DEBUG_ERROR, "Waiting for PMC to perform reset."));
  ...
  )
{
  ...
  ///
  EfiPeiReset2Ppi->ResetSystem  = PchResetSystem;
