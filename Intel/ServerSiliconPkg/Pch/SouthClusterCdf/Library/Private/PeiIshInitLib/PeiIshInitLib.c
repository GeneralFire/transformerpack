  ...
  )
{
  ...
  if (IshConfig->SpiGpioAssign) {
    ...
    GpioSetNativePadByFunction (GPIO_FUNCTION_ISH_SPI_MOSI(0), 0);
    GpioSetNativePadByFunction (GPIO_FUNCTION_ISH_SPI_MISO(0), 0);
    GpioSetNativePadByFunction (GPIO_FUNCTION_ISH_SPI_CLK(0), 0);
    GpioSetNativePadByFunction (GPIO_FUNCTION_ISH_SPI_CS(0, 0), 0);
  }
  if (IshConfig->Uart0GpioAssign) {
    DEBUG ((DEBUG_INFO, "ISH UART0 pins set to Native Mode\n"));
    GpioSetNativePadByFunction (GPIO_FUNCTION_ISH_UART_RX (0), 0);
    GpioSetNativePadByFunction (GPIO_FUNCTION_ISH_UART_TX (0), 0);
    GpioSetNativePadByFunction (GPIO_FUNCTION_ISH_UART_RTS (0), 0);
    GpioSetNativePadByFunction (GPIO_FUNCTION_ISH_UART_CTS (0), 0);
  }
  if (IshConfig->Uart1GpioAssign) {
    DEBUG ((DEBUG_INFO, "ISH UART1 pins set to Native Mode\n"));
    GpioSetNativePadByFunction (GPIO_FUNCTION_ISH_UART_RX (1), 0);
    GpioSetNativePadByFunction (GPIO_FUNCTION_ISH_UART_TX (1), 0);
    GpioSetNativePadByFunction (GPIO_FUNCTION_ISH_UART_RTS (1), 0);
    GpioSetNativePadByFunction (GPIO_FUNCTION_ISH_UART_CTS (1), 0);
  }
  if (IshConfig->I2c0GpioAssign) {
    DEBUG ((DEBUG_INFO, "ISH I2C0 pins set to Native Mode\n"));
    GpioSetNativePadByFunction (GPIO_FUNCTION_ISH_I2C_SDA (0), 0);
    GpioSetNativePadByFunction (GPIO_FUNCTION_ISH_I2C_SCL (0), 0);
  }
  if (IshConfig->I2c1GpioAssign) {
    DEBUG ((DEBUG_INFO, "ISH I2C1 pins set to Native Mode\n"));
    GpioSetNativePadByFunction (GPIO_FUNCTION_ISH_I2C_SDA (1), 0);
    GpioSetNativePadByFunction (GPIO_FUNCTION_ISH_I2C_SCL (1), 0);
  }
  if (IshConfig->I2c2GpioAssign) {
    DEBUG ((DEBUG_INFO, "ISH I2C2 pins set to Native Mode\n"));
    GpioSetNativePadByFunction (GPIO_FUNCTION_ISH_I2C_SDA (2), 0);
    GpioSetNativePadByFunction (GPIO_FUNCTION_ISH_I2C_SCL (2), 0);
  }
  if (IshConfig->Gp0GpioAssign) {
    DEBUG ((DEBUG_INFO, "ISH GP_0 pin set to Native Mode\n"));
    GpioSetNativePadByFunction (GPIO_FUNCTION_ISH_GP (0), 0);
  }
  if (IshConfig->Gp1GpioAssign) {
    DEBUG ((DEBUG_INFO, "ISH GP_1 pin set to Native Mode\n"));
    GpioSetNativePadByFunction (GPIO_FUNCTION_ISH_GP (1), 0);
  }
  if (IshConfig->Gp2GpioAssign) {
    DEBUG ((DEBUG_INFO, "ISH GP_2 pin set to Native Mode\n"));
    GpioSetNativePadByFunction (GPIO_FUNCTION_ISH_GP (2), 0);
  }
  if (IshConfig->Gp3GpioAssign) {
    DEBUG ((DEBUG_INFO, "ISH GP_3 pin set to Native Mode\n"));
    GpioSetNativePadByFunction (GPIO_FUNCTION_ISH_GP (3), 0);
  }
  if (IshConfig->Gp4GpioAssign) {
    DEBUG ((DEBUG_INFO, "ISH GP_4 pin set to Native Mode\n"));
    GpioSetNativePadByFunction (GPIO_FUNCTION_ISH_GP (4), 0);
  }
  if (IshConfig->Gp5GpioAssign) {
    DEBUG ((DEBUG_INFO, "ISH GP_5 pin set to Native Mode\n"));
    GpioSetNativePadByFunction (GPIO_FUNCTION_ISH_GP (5), 0);
  }
  if (IshConfig->Gp6GpioAssign) {
    DEBUG ((DEBUG_INFO, "ISH GP_6 pin set to Native Mode\n"));
    GpioSetNativePadByFunction (GPIO_FUNCTION_ISH_GP (6), 0);
  }
  if (IshConfig->Gp7GpioAssign) {
    DEBUG ((DEBUG_INFO, "ISH GP_7 pin set to Native Mode\n"));
    GpioSetNativePadByFunction (GPIO_FUNCTION_ISH_GP (7), 0);
  }
}
