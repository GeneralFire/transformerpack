  ...
  )
{
  ...
  PchPcrAndThenOr32 (PID_LPC, R_LPC_PCR_PRC, (UINT32)
                    ~(B_LPC_PRC_PRC_D3HE |
                      B_LPC_PRC_PRC_I3E |
                      B_LPC_PRC_PRC_PMCPG_EN |
                      B_LPC_PCR_PRC_HAE),
                     (B_LPC_PCR_PRC_PGCBCGE |
                      B_LPC_PCR_PRC_IOSFP_INTF_CLKGATE_EN |
                      B_LPC_PCR_PRC_IOSFSB_INTF_CLKGATE_EN |
                      B_LPC_PCR_PRC_LPC_CLK_GATE));
  ...
  )
{
  ...
  if (SerialIrqConfig->SirqMode == PchQuietMode) {
    RegData8 &= (UINT8) ~B_LPC_CFG_SERIRQ_CNT_SIRQMD;
  }
