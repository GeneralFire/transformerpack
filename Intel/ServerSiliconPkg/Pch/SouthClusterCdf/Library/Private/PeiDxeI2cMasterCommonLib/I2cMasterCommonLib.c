  ...
  )
{
  ...
  if ( *BusClockHertz < 100*1000) {
    ...
    *BusClockHertz = 100000;
    ...
    MmioWrite32 ((UINTN) MmioAddress + R_I2C_MEM_SDA_HOLD, 0x001C001C);
    MmioWrite32 ((UINTN) MmioAddress + R_I2C_MEM_SS_SCL_HCNT, 706);
    MmioWrite32 ((UINTN) MmioAddress + R_I2C_MEM_SS_SCL_LCNT, 612);
    ...
    *BusClockHertz = 400000;
    ...
    MmioWrite32 ((UINTN) MmioAddress + R_I2C_MEM_SDA_HOLD, 0x001C001C);
    MmioWrite32 ((UINTN) MmioAddress + R_I2C_MEM_FS_SCL_HCNT, 207);
    MmioWrite32 ((UINTN) MmioAddress + R_I2C_MEM_FS_SCL_LCNT, 110);
  } else if ( *BusClockHertz < 3400*1000) {
    //for any request in range [1MHz, 3.4MHz), set 1MHz
    *BusClockHertz = 1000000;
    Speed = V_I2C_MEM_SPEED_FAST;
    MmioWrite32 ((UINTN) MmioAddress + R_I2C_MEM_SDA_HOLD, 0x00280028);
    MmioWrite32 ((UINTN) MmioAddress + R_I2C_MEM_FS_SCL_HCNT, 76);
    MmioWrite32 ((UINTN) MmioAddress + R_I2C_MEM_FS_SCL_LCNT, 43);
  } else {
    //for any request in range [3.4MHz, +inf), set 3.4MHz
    *BusClockHertz = 3400000;
    Speed = V_I2C_MEM_SPEED_HIGH;
    MmioWrite32 ((UINTN) MmioAddress + R_I2C_MEM_SDA_HOLD, 0x00280028); //todo
    MmioWrite32 ((UINTN) MmioAddress + R_I2C_MEM_FS_SCL_HCNT, 19);
    MmioWrite32 ((UINTN) MmioAddress + R_I2C_MEM_FS_SCL_LCNT, 11);
  }
