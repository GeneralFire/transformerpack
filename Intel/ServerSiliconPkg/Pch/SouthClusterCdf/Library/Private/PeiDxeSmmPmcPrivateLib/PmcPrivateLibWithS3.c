  ...
  )
{
  ...
  //
  MmioOr32 (PchPwrmBase + R_PMC_PWRM_CFG, B_PMC_PWRM_CFG_DBG_MODE_LOCK | B_PMC_PWRM_CFG_PMCREAD_DISABLE);
...
/**
  This function sets SLP_SX Stretching Policy, locks acpi base
  and adds lock setting to S3 Boot Script
**/
VOID
  ...
  )
{
  ...
  MmioOr8 (
    ...
    (UINT8) ((B_PMC_PWRM_GEN_PMCON_B_SLPSX_STR_POL_LOCK | B_PMC_PWRM_GEN_PMCON_B_ACPI_BASE_LOCK) >> 16)
    );
  ...
  )
{
  ...
  S3BootScriptSaveMemWrite (
    S3BootScriptWidthUint8,
    (UINT32) (PchPwrmBase + R_PMC_PWRM_ST_PG_FDIS_PMC_1),
    1,
    (VOID *) (UINTN) (PchPwrmBase + R_PMC_PWRM_ST_PG_FDIS_PMC_1)
    );


  MmioOr32 (PchPwrmBase + R_PMC_PWRM_PM_DOWN_PPB_CFG, B_PMC_PWRM_PM_DOWN_PPB_CFG_LOCK);

  S3BootScriptSaveMemWrite (
    S3BootScriptWidthUint32,
    (UINTN) (PchPwrmBase + R_PMC_PWRM_PM_DOWN_PPB_CFG),
    1,
    (VOID *) (UINTN) (PchPwrmBase + R_PMC_PWRM_PM_DOWN_PPB_CFG)
    );

  MmioOr32 (PchPwrmBase + R_PMC_PWRM_TSC_OVRD_CFG, B_PMC_PWRM_TSC_OVRD_CFG_LOCK);

  S3BootScriptSaveMemWrite (
    S3BootScriptWidthUint32,
    (UINTN) (PchPwrmBase + R_PMC_PWRM_TSC_OVRD_CFG),
    1,
    (VOID *) (UINTN) (PchPwrmBase + R_PMC_PWRM_TSC_OVRD_CFG)
    );

  MmioOr32 (PchPwrmBase + R_PMC_PWRM_GEN_PMCON_A, B_PMC_PWRM_GEN_PMCON_A_ESPI_SMI_LOCK);

  S3BootScriptSaveMemWrite (
    S3BootScriptWidthUint32,
    (UINTN) (PchPwrmBase + R_PMC_PWRM_GEN_PMCON_A),
    1,
    (VOID *) (UINTN) (PchPwrmBase + R_PMC_PWRM_GEN_PMCON_A)
    );

  MmioOr32 (PchPwrmBase + R_PMC_PWRM_PMSYNC_TPR_CONFIG, B_PMC_PWRM_PMSYNC_TPR_CONFIG_CFG_LOCK);

  S3BootScriptSaveMemWrite (
    S3BootScriptWidthUint32,
    (UINTN) (PchPwrmBase + R_PMC_PWRM_PMSYNC_TPR_CONFIG),
    1,
    (VOID *) (UINTN) (PchPwrmBase + R_PMC_PWRM_PMSYNC_TPR_CONFIG)
    );

  MmioOr32 (PchPwrmBase + R_PMC_PWRM_THROT_1, R_PMC_PWRM_THROT_1_LOCK);

  S3BootScriptSaveMemWrite (
    S3BootScriptWidthUint32,
    (UINTN) (PchPwrmBase + R_PMC_PWRM_THROT_1),
    1,
    (VOID *) (UINTN) (PchPwrmBase + R_PMC_PWRM_THROT_1)
    );
}
  ...
  )
{
  ...
  MmioOr32 ((UINT32) (PchPwrmBase + R_PMC_PWRM_SSML), B_PMC_PWRM_SSML_SSL);

  S3BootScriptSaveMemWrite (
    S3BootScriptWidthUint8,
    (UINT32) (PchPwrmBase + R_PMC_PWRM_SSML),
    1,
  ...
  )
{
  ...
  S3BootScriptSaveMemWrite (
    S3BootScriptWidthUint32,
    (UINT32) (PchPwrmBase + R_PMC_PWRM_CRID),
    1,
