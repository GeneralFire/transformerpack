  ...
  )
{
  ...
  PchPcrAndThenOr32 (
    PID_ESPISPI, R_SPI_PCR_PWR_CTL,
    ~(UINT32) (B_SPI_PCR_PWR_CTL_EN_HAE |
               B_SPI_PCR_PWR_CTL_EN_D3HE |
               B_SPI_PCR_PWR_CTL_EN_I3E |
               B_SPI_PCR_PWR_CTL_EN_PMCRE),
    0
    );
}
  ...
  )
{
  ...
  //
  // SPI/eSPI power management configuration is required even if eSPI is disabled.
  //
  EspiConfigurePm ();
