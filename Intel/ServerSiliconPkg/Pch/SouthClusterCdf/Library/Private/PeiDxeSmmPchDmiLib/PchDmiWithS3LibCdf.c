  ...
  )
{
  ...
  Data32Or  = B_PCH_RLINK_PCR_DMIC_SRL;

  PchPcrAndThenOr32 (
    PID_DMI, R_PCH_RLINK_PCR_DMIC,
    Data32And,
    Data32Or
    );
  ...
  )
{
  ...
  //
  Data32And = 0xFFFFFFFF;
  Data32Or = B_PCH_RLINK_PCR_BILD;
  PchPcrAndThenOr32 (PID_DMI, R_PCH_RLINK_PCR_GCS, Data32And, Data32Or);
  PCH_PCR_BOOT_SCRIPT_READ_WRITE (
    S3BootScriptWidthUint32,
    PID_DMI, R_PCH_RLINK_PCR_GCS,
    &Data32Or,
    &Data32And
    );
}
