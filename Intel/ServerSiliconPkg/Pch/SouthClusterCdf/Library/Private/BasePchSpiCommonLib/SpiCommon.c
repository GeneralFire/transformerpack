  ...
  )
{
  ...
  if (((MmioRead32 (PchSpiBar0 + R_SPI_MEM_BFPR) & B_PCH_SPI_BFPR_SBRS) != 0) && (FlashRegionType == FlashRegionBios)) {
  ...
  if (FlashRegionType < FlashRegion10Gbe_B) {
    ...
    ReadValue = MmioRead32 (PchSpiBar0 + (R_PCH_SPI_FREG12 + (S_SPI_MEM_FREGX * ((UINT32) (FlashRegionType - FlashRegion10Gbe_B)))));
  }
