   ...
   )
{
  ...
  switch (Reg) {
  case MB_SMM_CMD_CWV_DPA_MAPPED_0_REG:
    // Command Register
    Index = MB_REG_COMMAND;
    break;
  case MB_SMM_NONCE_0_CWV_DPA_MAPPED_0_REG:
    Index = MB_REG_NONCE0;
    break;
  case MB_SMM_NONCE_1_CWV_DPA_MAPPED_0_REG:
    Index = MB_REG_NONCE1;
    break;
  case MB_SMM_STATUS_CWV_DPA_MAPPED_0_REG:
    Index = MB_REG_STATUS;
    break;
  default:
    Index = -1;
