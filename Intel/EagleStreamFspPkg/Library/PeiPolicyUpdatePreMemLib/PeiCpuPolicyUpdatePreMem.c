/** @file
  This file is SampleCode of the library for Intel CPU PEI Policy update.
  ...
  )
{
  ...
  CpuPolicy->CheckCpuBist = 0;

  //@todo Update CPU Pre Mem policy with UPD data.

  return SetCpuPreMemPolicy(CpuPolicy, sizeof(CPU_PRE_MEM_POLICY));
}
