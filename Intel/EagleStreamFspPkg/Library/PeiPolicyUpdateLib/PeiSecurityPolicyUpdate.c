  ...
  )
{
  ...
  BiosGuardConfig->SendEcCmd = FspsUpd->FspsConfig.SendEcCmd;
  BiosGuardConfig->EcCmdProvisionEav = FspsUpd->FspsConfig.EcCmdProvisionEav;
  BiosGuardConfig->EcCmdLock = FspsUpd->FspsConfig.EcCmdLock;
