  ...
  )
{
  ...
  if (FspsUpd->FspsConfig.SkipMpInit) {
    DEBUG((DEBUG_ERROR, "Deprecated FSPS UPD SkipMpInit used! Please use FSPM UPD SkipMpInitPreMem instead!\n"));
    ASSERT (FspsUpd->FspsConfig.SkipMpInit != 0);
  }

  CpuPowerMgmtBasicConfig->TurboMode   = FspsUpd->FspsConfig.TurboMode;

  CpuPowerMgmtVrConfig->Psi3Enable     = FspsUpd->FspsConfig.Psi3Enable;
  CpuPowerMgmtVrConfig->Psi4Enable     = FspsUpd->FspsConfig.Psi4Enable;
  CpuPowerMgmtVrConfig->ImonSlope      = FspsUpd->FspsConfig.ImonSlope;
  CpuPowerMgmtVrConfig->ImonOffset     = FspsUpd->FspsConfig.ImonOffset;
  CpuPowerMgmtVrConfig->VrConfigEnable = FspsUpd->FspsConfig.VrConfigEnable;
  CpuPowerMgmtVrConfig->TdcEnable      = FspsUpd->FspsConfig.TdcEnable;
  CpuPowerMgmtVrConfig->TdcTimeWindow  = FspsUpd->FspsConfig.TdcTimeWindow;
  CpuPowerMgmtVrConfig->TdcLock        = FspsUpd->FspsConfig.TdcLock;
  CpuPowerMgmtVrConfig->TdcPowerLimit  = FspsUpd->FspsConfig.TdcPowerLimit;
  CpuPowerMgmtVrConfig->AcLoadline     = FspsUpd->FspsConfig.AcLoadline;
  CpuPowerMgmtVrConfig->DcLoadline     = FspsUpd->FspsConfig.DcLoadline;
  CpuPowerMgmtVrConfig->Psi1Threshold  = FspsUpd->FspsConfig.Psi1Threshold;
  CpuPowerMgmtVrConfig->Psi2Threshold  = FspsUpd->FspsConfig.Psi2Threshold;
  CpuPowerMgmtVrConfig->Psi3Threshold  = FspsUpd->FspsConfig.Psi3Threshold;
  CpuPowerMgmtVrConfig->IccMax         = FspsUpd->FspsConfig.IccMax;
  CpuPowerMgmtVrConfig->VrVoltageLimit = FspsUpd->FspsConfig.VrVoltageLimit;
  ...
  CpuPowerMgmtVrConfig->PreWake                   = FspsUpd->FspsConfig.PreWake;
  CpuPowerMgmtVrConfig->RampUp                    = FspsUpd->FspsConfig.RampUp;
  CpuPowerMgmtVrConfig->RampDown                  = FspsUpd->FspsConfig.RampDown;
  ...
  //
  if ((FspsUpd->FspsConfig.MonitorMwaitEnable == 0) && (FspsUpd->FspsConfig.ApIdleManner == AP_IN_MWAIT_LOOP)) {
    FspsUpd->FspsConfig.ApIdleManner = AP_IN_HALT_LOOP;
  }
  ...
  CpuPowerMgmtTestConfig->AutoThermalReporting          = FspsUpd->FspsConfig.AutoThermalReporting;
