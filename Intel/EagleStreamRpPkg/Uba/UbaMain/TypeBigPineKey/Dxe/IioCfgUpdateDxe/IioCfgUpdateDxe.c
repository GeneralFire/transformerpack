...
PLATFORM_IIO_CONFIG_UPDATE_TABLE  TypeBigPineKeyIioConfigTable =
{
...
)
{
  ...
  DEBUG((EFI_D_ERROR, "UBA:IioCfgUpdate-TypeBigPineKey\n"));
  ...
  Status = UbaConfigProtocol->AddData (
                                     ...
                                     &TypeBigPineKeyIioConfigTable,
                                     sizeof(TypeBigPineKeyIioConfigTable)
                                     );
