...
PLATFORM_PCH_EARLY_UPDATE_TABLE  TypeBigPineKeyPchEarlyUpdateTable =
{
  ...
  )
{
  ...
  Status = UbaConfigPpi->AddData (
                               ...
                               &TypeBigPineKeyPchEarlyUpdateTable,
                               sizeof(TypeBigPineKeyPchEarlyUpdateTable)
                               );
