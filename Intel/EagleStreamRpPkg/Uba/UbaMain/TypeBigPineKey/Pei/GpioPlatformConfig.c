...
STATIC PLATFORM_GPIO_CONFIG_TABLE mGpioPlatformConfigBigPineKey = {
  ...
  // WHEA SCI generation pad; not needed for EGS (HSD 14010729742)
  UNUSED_GPIO,
...
)
{
  ...
  Status = UbaConfigPpi->AddData (
                                 ...
                                 &mGpioPlatformConfigBigPineKey,
                                 sizeof(mGpioPlatformConfigBigPineKey)
                                 );
