...
PCIE_BIFURCATION_CONFIG TypeBigPineKeyPchPcieBifurcationConfig[PCH_MAX_PCIE_CONTROLLERS] =
{
  //
  ...
  //
  // SPB Controller - Not used - default
  //
  PcieBifurcationDefault,

  //
  // SPC Controller - Not used - default
  //
  PcieBifurcationDefault,

  //
  // SPD Controller - Not used - default
  //
  PcieBifurcationDefault
};
...
**/
EFI_STATUS
TypeBigPineKeyPchPcieBifurcationUpdateCallback (
  ...
  )
{
  ...
  *PchPcieBifurcationConfig   = TypeBigPineKeyPchPcieBifurcationConfig;
  *PchSlotConfig = PchSlotTable;
  return EFI_SUCCESS;
}

PLATFORM_PCH_PCIE_BIFURCATION_UPDATE_TABLE  TypeBigPineKeyPchPcieBifurcationUpdate =
{
  ...
  )
{
  ...
  Status = UbaConfigPpi->AddData (
                                 ...
                                 &TypeBigPineKeyPchPcieBifurcationUpdate,
                                 sizeof(TypeBigPineKeyPchPcieBifurcationUpdate)
                                 );
