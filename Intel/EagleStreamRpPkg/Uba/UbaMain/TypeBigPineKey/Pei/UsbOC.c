...
USB_OVERCURRENT_PIN TypeBigPineKeyUsb20OverCurrentMappings[MAX_USB2_PORTS] = {
  0x4,           //Port00: Internal
  0x4,           //Port01: Internal
...
USB_OVERCURRENT_PIN TypeBigPineKeyUsb30OverCurrentMappings[MAX_USB3_PORTS] = {
  USB_OC_SKIP,
  USB_OC_SKIP,
  USB_OC_SKIP,
  USB_OC_SKIP,
...
USB2_PHY_PARAMETERS TypeBigPineKeyUsb20AfeParams[4] = {
  {7, 0, 2, 1},   // PP0
  {7, 0, 2, 1},   // PP1
  {7, 0, 2, 1},   // PP2
  {7, 0, 2, 1},   // PP3
...
EFI_STATUS
TypeBigPineKeyPlatformUsbOcUpdateCallback (
...
{
  *Usb20OverCurrentMappings = &TypeBigPineKeyUsb20OverCurrentMappings[0];
  *Usb30OverCurrentMappings = &TypeBigPineKeyUsb30OverCurrentMappings[0];
  *Usb20AfeParams           = TypeBigPineKeyUsb20AfeParams;
  return EFI_SUCCESS;
}

PLATFORM_USBOC_UPDATE_TABLE  TypeBigPineKeyUsbOcUpdate = {
  ...
  )
{
  ...
  Status = UbaConfigPpi->AddData (
                           ...
                           &TypeBigPineKeyUsbOcUpdate,
                           sizeof(TypeBigPineKeyUsbOcUpdate)
                           );
