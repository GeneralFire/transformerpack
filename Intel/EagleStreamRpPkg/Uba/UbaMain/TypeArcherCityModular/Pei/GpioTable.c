...
//
// Board     : Archer City Modular
//

static GPIO_INIT_CONFIG mGpioTableArcherCityModular [] =
{
...
)
{
  ...
  Status = UbaConfigPpi->AddData (
                                 ...
                                 &mGpioTableArcherCityModular,
                                 sizeof(mGpioTableArcherCityModular)
                                 );
  Status = PcdSet32S (PcdOemSku_GPIO_TABLE_SIZE, sizeof (mGpioTableArcherCityModular));
