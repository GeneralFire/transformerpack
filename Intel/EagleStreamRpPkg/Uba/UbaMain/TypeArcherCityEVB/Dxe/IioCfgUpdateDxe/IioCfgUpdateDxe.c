...
PLATFORM_IIO_CONFIG_UPDATE_TABLE  TypeArcherCityEVBIioConfigTable =
{
...
)
{
  ...
  DEBUG((EFI_D_ERROR, "UBA:IioCfgUpdate-TypeArcherCityEVB\n"));
  ...
  Status = UbaConfigProtocol->AddData (
                                     ...
                                     &TypeArcherCityEVBIioConfigTable,
                                     sizeof(TypeArcherCityEVBIioConfigTable)
                                     );
