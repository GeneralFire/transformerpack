...
//Transformers_JK008 +++>
  ...
  { Iio_Socket0, Iio_Mcp1, IIO_BIFURCATE_xxxxxx16 },
  { Iio_Socket1, Iio_Iou0, IIO_BIFURCATE_x4x4x4x4 },
  { Iio_Socket1, Iio_Iou1, IIO_BIFURCATE_xxxxxx16 },
  { Iio_Socket1, Iio_Iou2, IIO_BIFURCATE_xxxxxx16 },
  { Iio_Socket1, Iio_Mcp0, IIO_BIFURCATE_xxxxxx16 },
  { Iio_Socket1, Iio_Mcp1, IIO_BIFURCATE_xxx8xxx8 },  
//Transformers_JK008 <+++
};
...
PLATFORM_IIO_CONFIG_UPDATE_TABLE  TypeArcherCityRPIioConfigTable =
{
...
)
{
  ...
  DEBUG((EFI_D_ERROR, "UBA:IioCfgUpdate-TypeArcherCityRP\n"));
  ...
  Status = UbaConfigProtocol->AddData (
                                     ...
                                     &TypeArcherCityRPIioConfigTable,
                                     sizeof(TypeArcherCityRPIioConfigTable)
                                     );
