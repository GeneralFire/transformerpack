...
PCIE_BIFURCATION_CONFIG TypeArcherCityRPPchPcieBifurcationConfig[PCH_MAX_PCIE_CONTROLLERS] =
{
  //
...
static PCH_SLOT_CONFIG_DATA_ENTRY_EX   PchSlotTable[] = {
  ...
  {SOCKET_0_INDEX +
    PORT_8_INDEX, NO_SLT_IMP , DISABLE , PWR_SCL_MAX , PWR_VAL_MAX , DISABLE ,            0 ,          0x0 , DISABLE , VPP_PORT_MAX , VPP_ADDR_MAX , NOT_HIDE , ENABLE  , DISABLE , DISABLE , SMB_ADDR_MAX , ENABLE  , VPP_PORT_0   , 0x4C         , DISABLE , SMB_ADDR_MAX   , DISABLE , VPP_PORT_MAX   , SMB_ADDR_MAX   , 0x0      },
  {SOCKET_0_INDEX +
...
**/
EFI_STATUS
TypeArcherCityRPPchPcieBifurcationUpdateCallback (
  ...
  )
{
  ...
  *PchPcieBifurcationConfig   = TypeArcherCityRPPchPcieBifurcationConfig;
  *PchSlotConfig = PchSlotTable;
  return EFI_SUCCESS;
}

PLATFORM_PCH_PCIE_BIFURCATION_UPDATE_TABLE  TypeArcherCityRPPchPcieBifurcationUpdate =
{
...
**/
EFI_STATUS
TypeArcherCityRPPchPcieBifurcation (
  ...
  )
{
  ...
  Status = UbaConfigPpi->AddData (
                                 ...
                                 &TypeArcherCityRPPchPcieBifurcationUpdate,
                                 sizeof(TypeArcherCityRPPchPcieBifurcationUpdate)
                                 );
