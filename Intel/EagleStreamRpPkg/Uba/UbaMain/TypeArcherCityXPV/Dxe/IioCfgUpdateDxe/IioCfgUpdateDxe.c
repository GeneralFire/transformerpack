...
PLATFORM_IIO_CONFIG_UPDATE_TABLE  TypeArcherCityXPVIioConfigTable =
{
...
)
{
  ...
  DEBUG((EFI_D_ERROR, "UBA:IioCfgUpdate-TypeArcherCityXPV\n"));
  ...
  Status = UbaConfigProtocol->AddData (
                                     ...
                                     &TypeArcherCityXPVIioConfigTable,
                                     sizeof(TypeArcherCityXPVIioConfigTable)
                                     );
