...
/**
  Update XPV IMON SVID Information

  retval N/A
**/
VOID
TypeArcherCityXPVPlatformUpdateImonAddress (
  VOID
  )
{
...
EFI_STATUS
TypeArcherCityXPVPlatformPcdUpdateCallback (
  VOID
  )
{
  ...
  CHAR16    PlatformName[]   = L"TypeArcherCityXPV";
  UINTN     PlatformNameSize = 0;
  EFI_STATUS Status;

  //#Integer for BoardID, must match the SKU number and be unique.
  Status = PcdSet16S (PcdOemSkuBoardID                      , TypeArcherCityXPV);
  ...
  Status = TypeArcherCityXPVPlatformUpdateAcpiTablePcds ();
...
PLATFORM_PCD_UPDATE_TABLE    TypeArcherCityXPVPcdUpdateTable =
{
...
EFI_STATUS
TypeArcherCityXPVInstallPcdData (
  ...
  )
{
  ...
  Status = UbaConfigPpi->AddData (
                                 ...
                                 &TypeArcherCityXPVPcdUpdateTable,
                                 sizeof(TypeArcherCityXPVPcdUpdateTable)
                                 );
