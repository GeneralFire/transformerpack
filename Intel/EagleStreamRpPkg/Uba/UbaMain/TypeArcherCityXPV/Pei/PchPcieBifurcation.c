...
PCIE_BIFURCATION_CONFIG TypeArcherCityXPVPchPcieBifurcationConfig[PCH_MAX_PCIE_CONTROLLERS] =
{
  //
...
**/
EFI_STATUS
TypeArcherCityXPVPchPcieBifurcationUpdateCallback (
  ...
  )
{
  ...
  *PchPcieBifurcationConfig   = TypeArcherCityXPVPchPcieBifurcationConfig;
  *PchSlotConfig = PchSlotTable;
  return EFI_SUCCESS;
}

PLATFORM_PCH_PCIE_BIFURCATION_UPDATE_TABLE  TypeArcherCityXPVPchPcieBifurcationUpdate =
{
...
**/
EFI_STATUS
TypeArcherCityXPVPchPcieBifurcation (
  ...
  )
{
  ...
  Status = UbaConfigPpi->AddData (
                                 ...
                                 &TypeArcherCityXPVPchPcieBifurcationUpdate,
                                 sizeof(TypeArcherCityXPVPchPcieBifurcationUpdate)
                                 );
