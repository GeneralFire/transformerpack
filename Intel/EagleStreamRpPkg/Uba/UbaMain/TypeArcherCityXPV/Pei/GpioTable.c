...
static GPIO_INIT_CONFIG mGpioTableXPV [] =
{
    ...
    {GPIO_VER3_GPP_B0,       { GpioPadModeNative4, GpioHostOwnDefault,    GpioDirOut,      GpioOutDefault, GpioIntDis,                     GpioHostDeepReset,   GpioTermNone,   GpioPadConfigLock}},//GPP_B_0_FM_PCH_GSXDOUT_PTI0_CLK
    {GPIO_VER3_GPP_B1,       { GpioPadModeNative4, GpioHostOwnDefault,    GpioDirOut,      GpioOutHigh,    GpioIntDis,                     GpioHostDeepReset,   GpioTermNone,   GpioPadConfigLock}},//GPP_B_1_FM_PCH_GSXSLOAD_PTI0
    {GPIO_VER3_GPP_B2,       { GpioPadModeNative4, GpioHostOwnDefault,    GpioDirOut,      GpioOutDefault, GpioIntDis,                     GpioHostDeepReset,   GpioTermNone,   GpioPadConfigLock}},//GPP_B_2_FM_PCH_GSXDIN_PTI1
    {GPIO_VER3_GPP_B3,       { GpioPadModeNative4, GpioHostOwnDefault,    GpioDirOut,      GpioOutLow,     GpioIntDis,                     GpioHostDeepReset,   GpioTermNone,   GpioPadConfigLock}},//GPP_B_3_FM_PCH_GSXRESET_N_PTI2
    {GPIO_VER3_GPP_B4,       { GpioPadModeNative4, GpioHostOwnDefault,    GpioDirOut,      GpioOutDefault, GpioIntDis,                     GpioHostDeepReset,   GpioTermNone,   GpioPadConfigLock}},//GPP_B_4_FM_PCH_GSXCLK_PTI3
...
EFI_STATUS
TypeArcherCityXPVInstallGpioData (
...
)
{
  ...
  Status = UbaConfigPpi->AddData (
                                 ...
                                 &mGpioTableXPV,
                                 sizeof(mGpioTableXPV)
                                 );
  Status = PcdSet32S (PcdOemSku_GPIO_TABLE_SIZE, sizeof (mGpioTableXPV));
