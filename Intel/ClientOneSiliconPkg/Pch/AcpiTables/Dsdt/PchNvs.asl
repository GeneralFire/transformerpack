...
**/
  ...
  Offset(690),    LTRP, 8,  // Offset(690),   Latency Tolerance Reporting Enable
  Offset(691),    LTRQ, 8,  // Offset(691),   Latency Tolerance Reporting Enable
  Offset(692),    LTRR, 8,  // Offset(692),   Latency Tolerance Reporting Enable
  Offset(693),    LTRS, 8,  // Offset(693),   Latency Tolerance Reporting Enable
  Offset(694),    GBES, 8,  // Offset(694),   GbE Support
  Offset(695),    PPDS, 32, // Offset(695),   PCH xDCI Power Down Scale Value, DWC_USB3_GCTL_INIT[31:19]
  Offset(699),    EMCE, 8,  // Offset(699),   Set to indicate that eMMC is enabled
  Offset(700),    SDCE, 8,  // Offset(700),   Set to indicate that SD card is enabled
  Offset(701),    TGEA, 8,  // Offset(701),   Set to indicate that Timed GPIO 0 is enabled
  Offset(702),    TGEB, 8,  // Offset(702),   Set to indicate that Timed GPIO 1 is enabled
  Offset(703),    CR00, 8,  // Offset(703),   CLOCK index to root port index map. Used during PCIe D3Cold flows
  Offset(704),    CR01, 8,  // Offset(704),
  Offset(705),    CR02, 8,  // Offset(705),
  Offset(706),    CR03, 8,  // Offset(706),
  Offset(707),    CR04, 8,  // Offset(707),
  Offset(708),    CR05, 8,  // Offset(708),
  Offset(709),    CR06, 8,  // Offset(709),
  Offset(710),    CR07, 8,  // Offset(710),
  Offset(711),    CR08, 8,  // Offset(711),
  Offset(712),    CR09, 8,  // Offset(712),
  Offset(713),    CR10, 8,  // Offset(713),
  Offset(714),    CR11, 8,  // Offset(714),
  Offset(715),    CR12, 8,  // Offset(715),
  Offset(716),    CR13, 8,  // Offset(716),
  Offset(717),    CR14, 8,  // Offset(717),
  Offset(718),    CR15, 8,  // Offset(718),
  Offset(719),    CR16, 8,  // Offset(719),
  Offset(720),    CR17, 8,  // Offset(720),
  Offset(721),    TCOB, 16, // Offset(721),   TCO base address
  Offset(723),    ICKP, 16, // Offset(723),   Iclk PID number
  Offset(725),    PCNV, 16, // Offset(725),   CNVi sideband port id
  Offset(727),    HBSL, 32, // Offset(727),
  Offset(731),    PU2C, 8,  // Offset(731),   Number of USB2 ports in PCH
  Offset(732),    PU3C, 8,  // Offset(732),   Number of USB3 ports in PCH
  Offset(733),    SPPR, 8,  // Offset(733),   Holds information from SATA PCS register about SATA ports which recieved COMINIT from connected devices.
  Offset(734),    IPCC, 8,  // Offset(734),   PCIE CLKREQ IPC command support
  Offset(735),    CQ00, 8,  // Offset(735),   CLOCK Source index to ClkReq Number. Used during PCIe D3Cold flows
  Offset(736),    CQ01, 8,  // Offset(736),
  Offset(737),    CQ02, 8,  // Offset(737),
  Offset(738),    CQ03, 8,  // Offset(738),
  Offset(739),    CQ04, 8,  // Offset(739),
  Offset(740),    CQ05, 8,  // Offset(740),
  Offset(741),    CQ06, 8,  // Offset(741),
  Offset(742),    CQ07, 8,  // Offset(742),
  Offset(743),    CQ08, 8,  // Offset(743),
  Offset(744),    CQ09, 8,  // Offset(744),
  Offset(745),    CQ10, 8,  // Offset(745),
  Offset(746),    CQ11, 8,  // Offset(746),
  Offset(747),    CQ12, 8,  // Offset(747),
  Offset(748),    CQ13, 8,  // Offset(748),
  Offset(749),    CQ14, 8,  // Offset(749),
  Offset(750),    CQ15, 8,  // Offset(750),
  Offset(751),    CQ16, 8,  // Offset(751),
  Offset(752),    CQ17, 8,  // Offset(752),
  #ifdef RESTRICTED_FLAG
  Offset(753),    CBTI, 8,  // Offset(753),   CNVi BT interface
  Offset(754),    CBTU, 8,  // Offset(754),   CNVi BT UART type
  #endif
  }
