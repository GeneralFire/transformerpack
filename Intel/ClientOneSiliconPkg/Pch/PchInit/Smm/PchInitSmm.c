  ...
  )
{
  ...
  if (((Pm1Cnt & B_ACPI_IO_PM1_CNT_SLP_TYP) == V_ACPI_IO_PM1_CNT_S5 ||
    ...
    MmioOr32 (XhciMmioBase + R_XHCI_MEM_SOCHWSTSAVE1, B_XHCI_MEM_SOCHWSTSAVE1_CMD_SSV);
  ...
  )
{
  ...
  //
  if (mFivrExtVnnRailSxConfig.IccMaximum == 0 &&
    mFivrExtVnnRailSxConfig.IccMax != 0) {
    ExtVnnRailSxIccMaximum = (UINT16)mFivrExtVnnRailSxConfig.IccMax;
  } else {
    ExtVnnRailSxIccMaximum = (UINT16)mFivrExtVnnRailSxConfig.IccMaximum;
  }

  IccMax = (UINT16) ((ExtVnnRailSxIccMaximum * (2 << 13))/1000);
