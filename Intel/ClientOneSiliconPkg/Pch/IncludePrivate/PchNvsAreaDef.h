...
typedef struct {
  ...
  //
  UINT8    LtrEnable[28];                           ///< Offset 666     Latency Tolerance Reporting Enable
  ...
  UINT8    GBES;                                    ///< Offset 694     GbE Support
  UINT32   PchxDCIPwrDnScale;                       ///< Offset 695     PCH xDCI Power Down Scale Value, DWC_USB3_GCTL_INIT[31:19]
  UINT8    EmmcEnabled;                             ///< Offset 699     Set to indicate that eMMC is enabled
  UINT8    SdCardEnabled;                           ///< Offset 700     Set to indicate that SD card is enabled
  UINT8    EnableTimedGpio0;                        ///< Offset 701     Set to indicate that Timed GPIO 0 is enabled
  UINT8    EnableTimedGpio1;                        ///< Offset 702     Set to indicate that Timed GPIO 1 is enabled
  UINT8    ClockToRootPortMap[18];                  ///< Offset 703     CLOCK index to root port index map. Used during PCIe D3Cold flows
  UINT16   TcoBase;                                 ///< Offset 721     TCO base address
  UINT16   IclkPid;                                 ///< Offset 723     Iclk PID number
  UINT16   CnviPortId;                              ///< Offset 725     CNVi sideband port id
  UINT32   HybridStorageLocation;                   ///< Offset 727
  UINT8    PchUsb2PortCount;                        ///< Offset 731     Number of USB2 ports in PCH
  UINT8    PchUsb3PortCount;                        ///< Offset 732     Number of USB3 ports in PCH
  UINT8    SataPortPresence;                        ///< Offset 733     Holds information from SATA PCS register about SATA ports which recieved COMINIT from connected devices.
  UINT8    ClkreqIpcCmdSupported;                   ///< Offset 734     PCIE CLKREQ IPC command support
  UINT8    ClockReq[18];                            ///< Offset 735     CLOCK Source index to ClkReq Number. Used during PCIe D3Cold flows
  #ifdef RESTRICTED_FLAG
  UINT8    CnviBtInterface;                         ///< Offset 753     CNVi BT interface
  UINT8    CnviBtUartType;                          ///< Offset 754     CNVi BT UART type
  #endif
} PCH_NVS_AREA;
