/** @file
  USB Type C port map support Fru Library header file
...
**/
#ifndef _PEI_PCH_USB_TYPEC_MAP_SUPPORT_LIB_H_
#define _PEI_PCH_USB_TYPEC_MAP_SUPPORT_LIB_H_
...
#endif // _PEI_PCH_USB_TYPEC_MAP_SUPPORT_LIB_H_
