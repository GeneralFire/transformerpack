...
#define V_SA_PCI_DEV_2_GT2_TGL_ULT_ID      0x9A49 ///< Dev2 TGL-U GT2 (4+2)
#define V_SA_PCI_DEV_2_GT2_TGL_ULX_ID      0x9A40 ///< Dev2 TGL-Y GT2 (4+2)
#define V_SA_PCI_DEV_2_GT3_TGL_ULT_ID      0x9A52 ///< Dev2 TGL-U GT3 (4+3e)
#define V_SA_PCI_DEV_2_GT2_TGL_HALO_ID     0x9A60 ///< Dev2 TGL-H (8+1)
#define V_SA_PCI_DEV_2_GT2_TGL_DTP_ID      0x9A68 ///< Dev2 TGL-S (8+1)
#define V_SA_PCI_DEV_2_GT0_TGL_ID          0x9A7F ///< Dev2 TGL GT0

#define V_SA_PCI_DEV_2_GT2_ADL_ULT_ID    0x46A0 ///< Dev2 ADL-U GT2
#define V_SA_PCI_DEV_2_GT1_ADL_DTP_ID    0x4680 ///< Dev2 ADL-S GT1
#define V_SA_PCI_DEV_2_GT0_ADL_ID        0x46FF ///< Dev2 ADL GT0
...
#define R_SA_IGD_MSAC_OFFSET_GEN9  0x0062  ///< Multisize Aperture Control for Gen 9
...
#define R_SA_GTTMMADR_PP_STATUS_2       0xC7300
...
#define B_SA_GTTMMADR_PWR_WELL_CTL_PG_1_STATE_GEN9   BIT28  ///< PG1 State for GEN9
#define B_SA_GTTMMADR_PWR_WELL_CTL_PG_1_ENABLE_GEN9  BIT29  ///< PG1 Enable for GEN9
#define B_SA_GTTMMADR_PWR_WELL_CTL_PG_2_STATE_GEN9   BIT30  ///< PG2 State for GEN9
#define B_SA_GTTMMADR_PWR_WELL_CTL_PG_2_ENABLE_GEN9  BIT31  ///< PG2 Enable for GEN9
...
#define R_SA_GTTMMADR_CDCLK_PLL_ENABLE_OFFSET_GEN9 0x46010  ///< CDCLK_PLL_ENABLE GEN9
...
#define V_SA_CDCLK_CTL_CD_FREQ_DECIMAL_192         0x17E
...
#define V_SA_CDCLK_PLL_RATIO_192MHZ_REF_19_2MHZ    0x14
...
#define V_SA_CDCLK_PLL_RATIO_192MHZ_REF_38_4MHZ    0x0A
...
#define V_SA_CDCLK_PLL_RATIO_192MHZ_REF_24MHZ      0x10
...
//
// Register offsets: Display memory map programming for DFD Restore
//
#define R_SA_GTTMMADR_DFD_LIMIT_OFFSET              0x10170C
#define R_SA_GTTMMADR_DFD_BASE_OFFSET               0x101704
...
#define N_MSR_GT_COS_TAG_WAYS_OFFSET                0
...
#define R_SA_GTTMMADR_PORT_A_GPIO_CTL               0xC5014 ///< GPIO_CTL_1
#define R_SA_GTTMMADR_PORT_B_GPIO_CTL               0xC5018 ///< GPIO_CTL_2
#define R_SA_GTTMMADR_SCHICKEN_1                    0xC2000
#define B_SA_GTTMMADR_SECOND_PPS_IO_SELECT          BIT2
#endif
