...
#define R_PMC_PWRM_SSMD                                     0x1054           ///< Set Strap Msg Data DW1
#define R_PMC_PWRM_SSMD_DW2                                 0x1058           ///< Set Strap Msg Data DW2
#define R_PMC_PWRM_SSMD_DW3                                 0x105C           ///< Set Strap Msg Data DW3
...
#define B_PMC_PWRM_ADR_GPIO_SEL                             (BIT31 | BIT30)
#define N_PMC_PWRM_ADR_GPIO_SEL                             30
#define V_PMC_PWRM_ADR_GPIO_B                               0x1
#define V_PMC_PWRM_ADR_GPIO_C                               0x2
#define B_PMC_PWRM_ADR_EN_HPR_ADR_EN                        BIT28
#define N_PMC_PWRM_ADR_EN_HPR_ADR_EN                        28
#define B_PMC_PWRM_ADR_EN_ADR_FEAT_EN                       0x1        ///< ADR Feature Enable
#define N_PMC_PWRM_ADR_EN_ADR_FEAT_EN                       0
...
#define R_PMC_PWRM_ADR_GEN_CFG_V2                           0x1908
#define B_PMC_PWRM_ADR_GEN_CFG_ADR_P2_TIMER_SCALE           0x1C000000 ///< ADR Timer Scale
#define N_PMC_PWRM_ADR_GEN_CFG_ADR_P2_TIMER_SCALE           26
#define B_PMC_PWRM_ADR_GEN_CFG_ADR_P2_EN                    0x80000    ///< ADR Phase 2 Enable
#define N_PMC_PWRM_ADR_GEN_CFG_ADR_P2_EN                    19
#define B_PMC_PWRM_ADR_GEN_CFG_ADR_P2_TIMER_TOV             0x7F800    ///< ADR Timer Base
#define N_PMC_PWRM_ADR_GEN_CFG_ADR_P2_TIMER_TOV             11
#define B_PMC_PWRM_ADR_GEN_CFG_ADR_P1_TIMER_SCALE           0x700      ///< ADR Timer Scale (Tick Frequency)
#define N_PMC_PWRM_ADR_GEN_CFG_ADR_P1_TIMER_SCALE           8
#define B_PMC_PWRM_ADR_GEN_CFG_ADR_P1_TIMER_TOV             0xFF       ///< ADR Timer Base
...
#define R_PMC_PWRM_ADR_CTRL_STS                             0x1960
#define B_PMC_PWRM_ADR_CTRL_STS_ADR_RST_STS                 0x10000    ///< ADR Reset Status
#define N_PMC_PWRM_ADR_CTRL_STS_ADR_RST_STS                 16

#define R_PMC_PWRM_ADR_GBLRST_EN_0                          0x191C     ///< ADR Global Reset Enable 0
#define B_PMC_PWRM_ADR_GBLRST_EN_0_PPBR_PARITY_ERR          0x20000000 ///< ppbr_parity_err
#define B_PMC_PWRM_ADR_GBLRST_EN_0_PMC_RF_FUSA_ERR          0x1000000  ///< pmc_rf_fusa_err
#define B_PMC_PWRM_ADR_GBLRST_EN_0_PMC_IROM_PARITY          0x800000   ///< pmc_irom_parity
#define B_PMC_PWRM_ADR_GBLRST_EN_0_PMC_SRAM_UNC_ERR         0x400000   ///< pmc_sram_unc_err
#define B_PMC_PWRM_ADR_GBLRST_EN_0_CSE_HEC_UNC_ERR          0x200000   ///< cse_hec_unc_err
#define B_PMC_PWRM_ADR_GBLRST_EN_0_OCWDT_ICC                0x100000   ///< ocwdt_icc
#define B_PMC_PWRM_ADR_GBLRST_EN_0_OCWDT_NOICC              0x80000    ///< ocwdt_noicc
#define B_PMC_PWRM_ADR_GBLRST_EN_0_ADR_GPIO                 0x40000    ///< adr_gpio
#define B_PMC_PWRM_ADR_GBLRST_EN_0_ME_UNC_ERR               0x20000    ///< me_unc_err
#define B_PMC_PWRM_ADR_GBLRST_EN_0_CPU_THRM_WDT             0x10000    ///< cpu_thrm_wdt
#define B_PMC_PWRM_ADR_GBLRST_EN_0_MIA_UX_ERR               0x8000     ///< mia_ux_err
#define B_PMC_PWRM_ADR_GBLRST_EN_0_MIA_UXS_ERR              0x4000     ///< mia_uxs_err
#define B_PMC_PWRM_ADR_GBLRST_EN_0_SYSPWR_FLR               0x1000     ///< syspwr_flr
#define B_PMC_PWRM_ADR_GBLRST_EN_0_PCHPWR_FLR               0x800      ///< pchpwr_flr
#define B_PMC_PWRM_ADR_GBLRST_EN_0_PMC_FW                   0x400      ///< pmc_fw
#define B_PMC_PWRM_ADR_GBLRST_EN_0_ME_WDT                   0x200      ///< me_wdt
#define B_PMC_PWRM_ADR_GBLRST_EN_0_PMC_WDT                  0x100      ///< pmc_wdt
#define B_PMC_PWRM_ADR_GBLRST_EN_0_LT_RESET                 0x80       ///< lt_reset
#define B_PMC_PWRM_ADR_GBLRST_EN_0_MEGBL                    0x40       ///< megbl
#define B_PMC_PWRM_ADR_GBLRST_EN_0_CPU_THRM                 0x20       ///< cpu_thrm
#define B_PMC_PWRM_ADR_GBLRST_EN_0_ME_PBO                   0x10       ///< me_pbo
#define B_PMC_PWRM_ADR_GBLRST_EN_0_PCH_THRM                 0x8        ///< pch_thrm
#define B_PMC_PWRM_ADR_GBLRST_EN_0_PMC_UNC_ERR              0x4        ///< pmc_unc_err
#define B_PMC_PWRM_ADR_GBLRST_EN_0_PBO                      0x2        ///< pbo
...
#define R_PMC_PWRM_LPM_EN_V2                                0x179C
...
#define R_PMC_PWRM_TNTE_CTL_CFG                             0x1F5C
