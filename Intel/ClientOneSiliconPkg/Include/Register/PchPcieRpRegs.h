...
// @todo Ebg: register for server PCH only, to review after all ebg pcie libraries will be moved to C1S
...
#define R_PCH_PCIE_CFG_V0CTL                          0x294 ///< Virtual Channel 0 Resource Control
...
#define  V_PCH_PCIE_RXMC1_MSRVS                         0x1F
