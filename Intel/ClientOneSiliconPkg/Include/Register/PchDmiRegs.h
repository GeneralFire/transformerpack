...
//
// Internal Link Configuration (PCH DMI Only)
//
...
#define N_PCH_DMI_PCR_GPMRX_GPMRL1               16                           ///< General Purpose Memory Range Limit 1 bits position
#define R_PCH_DMI_PCR_GPMR1DID                   0x2780                       ///< General Purpose Memory Range 1 Destination ID
#define B_PCH_DMI_PCR_GPMRXDID_GPMR1DE           BIT31                        ///< General Purpose Memory Range 1 Decode Enable bit
...
// Opi PHY registers
//
#define R_OPIPHY_PCR_0000                        0x0000
#define R_OPIPHY_PCR_0110                        0x0110
#define R_OPIPHY_PCR_0118                        0x0118
#define R_OPIPHY_PCR_011C                        0x011C
#define R_OPIPHY_PCR_0354                        0x0354
#define R_OPIPHY_PCR_B104                        0xB104
#define R_OPIPHY_PCR_B10C                        0xB10C
