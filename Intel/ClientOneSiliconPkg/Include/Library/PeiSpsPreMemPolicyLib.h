/** @file
  Prototype of the SpsPolicyLibPei library.
...
**/
#ifndef _PEI_SPS_PRE_MEM_POLICY_LIB_H_
#define _PEI_SPS_PRE_MEM_POLICY_LIB_H_
...
/**
  SpsPreMemAddConfigBlocks add all SPS config blocks.
...
#endif // _PEI_SPS_PRE_MEM_POLICY_LIB_H_
