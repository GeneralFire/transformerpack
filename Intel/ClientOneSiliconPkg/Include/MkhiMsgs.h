...
typedef union {
  ...
  struct {
    ...
    UINT32  IntegratedTouch : 1;      ///< [4] Intel Integrated Touch [Deprecated]
...
#define MCA_PLAT_ID_SUPPORT_FILE_ID       0x1001B900
...
/// HW Anti-Rollback
///
#define MFT_KEY_USAGE_INDEX_CSE_RBE_MANIFEST    3    ///< Manifest Key Usage
