...
#define ME_PEI_PREMEM_CONFIG_REVISION 4
...
typedef struct {
  ...
  **/
  ...
  UINT32 HeciFullTrace                    : 1;  ///< <b>(Test)</b> 0: Disable; <b>1: Enable</b> - Enable/Disable Full HECI communication information logged to serial
