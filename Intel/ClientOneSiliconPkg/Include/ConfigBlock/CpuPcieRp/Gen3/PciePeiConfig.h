...
#define SA_PCIE_PEI_CONFIG_GEN3_REVISION 1
...
typedef struct {
  ...
  **/
  ...
  UINT8                  Rsvd1[1];                                    ///< Offset 33 to 35
  UINT8                  PegDeEmphasis[SA_PEG_MAX_FUN_GEN3];               ///< Offset 36 This field is used to describe the DeEmphasis control for PEG (-6 dB and -3.5 dB are the options)SA_PEG_MAX_FUN = 3 for CFL and SA_PEG_MAX_FUN = 4 for CNL, offsets are adjusted accordingly
  UINT8                  PegMaxPayload[SA_PEG_MAX_FUN_GEN3];               ///< <b>(Test)</b> Offset 39/40 This field is used to describe the PEG Max Pay Load Size (0xFF: Auto, 0:128B, 1:256B)
  /**
  ...
  **/
  UINT8                  PegSlotPowerLimitValue[SA_PEG_MAX_FUN_GEN3];      ///< Offset 42/44 8 bit value
  UINT8                  PegSlotPowerLimitScale[SA_PEG_MAX_FUN_GEN3];      ///< Offset 45/48 2 bit value: <b>00 = 1.0x</b>, 01 = 0.1x, 10 = 0.01x and 11 = 0.001x
  /**
   Offset 48/52
   PCIe Physical Slot Number (13 bit value). Indicates the physical slot number attached to the port.
  **/
  UINT16                 PegPhysicalSlotNumber[SA_PEG_MAX_FUN_GEN3];
} PCIE_PEI_CONFIG;
#pragma pack(pop)
