...
#define HDAUDIO_PREMEM_CONFIG_REVISION 3
...
typedef struct {
  ...
  UINT32             IoControlEnabled :  1;  ///< @deprecated
  UINT32             RsvdBits0        : 30;
} HDA_LINK_SNDW;
...
typedef struct {
  ...
  **/
  ...
  UINT8   AudioFpgaSocVer;                  ///< Audio IP version enumerate on FPGA, if set to 0 Audio on FPGA is disabled.
  UINT8   Rsvd0[1];                         ///< Reserved bytes, align to multiple 4
