...
typedef struct {
  ...
  UINT32  RsvdO64B20t31:12;          ///<           Bits 20:31 reserved
  /**
  ...
  **/
  ...
  UINT32 ReservedBits2 :17;       ///< Bits 15:31 - Reserved
  ...
  UINT32  RsvdO92B22t31:10;         ///<           Bit 22-31: Rsvd
  ...
  **/
  ...
  UINT8   IbeccProtectedRegionEnable[MEM_MAX_IBECC_REGIONS];  ///< Offset 164 Enable use of address range for ECC Protection:  <b>0=Default</b>, 1
  UINT16  IbeccProtectedRegionBase[MEM_MAX_IBECC_REGIONS];    ///< Offset 172 Base address for address range of ECC Protection:  <b>0=Default</b>, 1
  UINT16  IbeccProtectedRegionMask[MEM_MAX_IBECC_REGIONS];    ///< Offset 188 Mask address for address range of ECC Protection:  <b>0=Default</b>, 1
