...
typedef UINT64     (EFIAPI * SA_GET_CPU_TIME)            (VOID *GlobalData);                                                                                                                                                                              ///< The current CPU time in milliseconds.
...
typedef struct {
  ...
  **/
  ...
  UINT32 RDTOPT       : 1;   ///< BIT14 - Read Timing Optimization
  UINT32 ReservedBits2 : 17;
  ...
  UINT8   RefreshPanicWm;         ///< Offset 102 Refresh Panic Watermark, Range 1-9, default 9.
  UINT8   RefreshHpWm;            ///< Offset 103 Refresh High Profile Watermark, Range 1-9, default 8.
  UINT8   Reserved104[36];        ///< Offset 104 - 139 Reserved
  ...
  UINT32  DisPgCloseIdleTimeout:1;///< Offset 232 Bit 6: Disable Page Close Idle Timeout: 0=Enable, <b>1=Disable</b>
  UINT32  Off232RsvdBits:25;      ///< Offset 232 Bit 7-31: Reserved
