...
typedef struct {
  ...
  UINT8    VmdPchRp1;                               ///< Offset 384     VMD PCH RP 1 <0:Disabled, 1:Enabled>
  UINT8    VmdPchRp2;                               ///< Offset 385     VMD PCH RP 2 <0:Disabled, 1:Enabled>
  UINT8    VmdPchRp3;                               ///< Offset 386     VMD PCH RP 3 <0:Disabled, 1:Enabled>
  UINT8    VmdPchRp4;                               ///< Offset 387     VMD PCH RP 4 <0:Disabled, 1:Enabled>
  UINT8    VmdSataPort[8];                          ///< Offset 388     VMD SATA PORT 0 <0:Disabled, 1:Enabled>
                                                    ///< Offset 389     VMD SATA PORT 1 <0:Disabled, 1:Enabled>
                                                    ///< Offset 390     VMD SATA PORT 2 <0:Disabled, 1:Enabled>
                                                    ///< Offset 391     VMD SATA PORT 3 <0:Disabled, 1:Enabled>
                                                    ///< Offset 392     VMD SATA PORT 4 <0:Disabled, 1:Enabled>
                                                    ///< Offset 393     VMD SATA PORT 5 <0:Disabled, 1:Enabled>
                                                    ///< Offset 394     VMD SATA PORT 6 <0:Disabled, 1:Enabled>
                                                    ///< Offset 395     VMD SATA PORT 7 <0:Disabled, 1:Enabled>
  UINT8    VmdCpuRp;                                ///< Offset 396     VMD CPU RP      <0:Disabled, 1:Enabled>
  UINT8    CpuPcieRtd3;                             ///< Offset 397     RTD3 Support for CPU PCIE.
  UINT32   LaneUsed;                                ///< Offset 398     Lane Used of each CSI Port <0:Not Configured, 1:x1, 2:x2, 3:x3 4:x4>
  UINT32   CsiSpeed;                                ///< Offset 402     Speed of each CSI Port <0:Not configured, 1:<416GMbps, 2:<1.5Gbps, 3:<2.0Gbps, 4:<2.5Gbps, 5:<4Gbps, 6:>4Gbps>
  UINT8    MaxPegPortNumber;                        ///< Offset 406     Max PEG port number
  UINT8    MemBootMode;                             ///< Offset 407     Current Memory Boot Mode <0: BOOT_MODE_1LM(Default), 1: BOOT_MODE_2LM, 2: BOOT_MODE_PROVISION>
  UINT8    DpmemSupport;                            ///< Offset 408     Dynamic PMem Support <0: Disabled, 1:Enabled>
  UINT64   PmemStartingAddress;                     ///< Offset 409     Private Pmem Starting address
  UINT64   PmemRangeLength;                         ///< Offset 417     Private Pmem Range Length
