...
/**
  ...
  <b>Revision 4</b>:
  - Add CstateLatencyControl0TimeUnit and CstateLatencyControl0Irtl.
**/
typedef struct {
  ...
  UINT16 CstateLatencyControl0Irtl;                ///< Offset 42-43 Interrupt Response Time Limit of LatencyContol0 MSR 0x60A[9:0].<b>0 is Auto</b>.
