  ...
  )
{
  ...
  if (IsBootGuardSupported ()) {
    ...
    MeFwSts4.ul = PciSegmentRead32 (PCI_SEGMENT_LIB_ADDRESS (ME_SEGMENT, ME_BUS, ME_DEVICE_NUMBER, HECI_FUNCTION_NUMBER, R_ME_HFS_4));
    ...
    ///
    if ((MeFwSts4.r.AllTpmDisconnected != 0 || MeFwSts4.r.FwInEnfFlow != 0) ||
