...
{
  switch (LaneOwner) {
    case V_PCH_FIA_15_PCR_LANE_OWN_PCIEDMI:
      if (PchFiaIsLaneDmi (LaneNum)) {
        return PchFiaOwnerDmi;
      } else {
        return PchFiaOwnerPcie;
      }
    case V_PCH_FIA_15_PCR_LANE_OWN_USB3:
      return PchFiaOwnerUsb3;
    case V_PCH_FIA_15_PCR_LANE_OWN_SATA:
      return PchFiaOwnerSata;
    case V_PCH_FIA_15_PCR_LANE_OWN_GBE:
      return PchFiaOwnerGbe;
    case V_PCH_FIA_15_PCR_LANE_OWN_UFS:
      return PchFiaOwnerUfs;
    case V_PCH_FIA_15_PCR_LANE_OWN_TSN:
      return PchFiaOwnerTsn;
    case V_PCH_FIA_15_PCR_LANE_OWN_PCIE_2:
      return PchFiaOwnerPcie;
    default:
      return PchFiaOwnerInvalid;
  }
