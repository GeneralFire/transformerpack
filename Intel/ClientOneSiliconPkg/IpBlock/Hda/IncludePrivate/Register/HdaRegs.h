/** @file
  Register names for High Definition Audio device (cAvs version).
...
#define B_HDA_CFG_MEMORY_TYPE_MASK              (BIT1 | BIT2)
#define B_HDA_CFG_MEMORY_TYPE_64                BIT2
...
#define B_HDA_CFG_SPCE_PMCRE                    BIT0
#define B_HDA_CFG_SPCE_I3E                      BIT1
#define B_HDA_CFG_SPCE_D3HE                     BIT2
