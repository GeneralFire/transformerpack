/** @file
  Device IDs for Serial IO Controllers for EBG PCH
...
//
#define V_VER3_PCH_SERIAL_IO_CFG_UART0_DEVICE_ID     0x1BAD

//
//  Serial IO UART1 Controller Registers
//
#define V_VER3_PCH_SERIAL_IO_CFG_UART1_DEVICE_ID     0x1BAE
