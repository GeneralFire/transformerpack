/** @file
  Serial IO Private Uart Lib implementation Emmitsburg specific.
...
GLOBAL_REMOVE_IF_UNREFERENCED UINT16 mPchSerialIoUartDevId [] = {
  V_VER3_PCH_SERIAL_IO_CFG_UART0_DEVICE_ID,
  V_VER3_PCH_SERIAL_IO_CFG_UART1_DEVICE_ID
};
...
{
  return mPchSerialIoUartDevId[UartNumber];
}
