...
/**
  Return 2-wire DCI OOB connection status and report DCI connection port ID

  @param[in out] DciPortId        Pointer to DCI connection port ID

  @retval TRUE                    2-wire DCI OOB is connected
  @retval FALSE                   2-wire DCI OOB is not connected
**/
BOOLEAN
Is2wireDciOobConnected (
  IN OUT UINT8                    *DciPortId
  );
