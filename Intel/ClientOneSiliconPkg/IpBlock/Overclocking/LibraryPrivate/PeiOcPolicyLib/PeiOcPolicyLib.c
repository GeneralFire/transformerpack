  ...
  )
{
  ...
  DEBUG ((DEBUG_INFO, " OVERCLOCKING_PREMEM_CONFIG:: SaVoltageMode : 0x%X\n", OverClockingPreMemConfig->SaVoltageMode));
  DEBUG ((DEBUG_INFO, " OVERCLOCKING_PREMEM_CONFIG:: SaVoltageOverride : 0x%X\n", OverClockingPreMemConfig->SaVoltageOverride));
  DEBUG ((DEBUG_INFO, " OVERCLOCKING_PREMEM_CONFIG:: SaExtraTurboVoltage : 0x%X\n", OverClockingPreMemConfig->SaExtraTurboVoltage));
  ...
  DEBUG ((DEBUG_INFO, " OVERCLOCKING_PREMEM_CONFIG:: AtomMaxOcRatio : 0x%X\n", OverClockingPreMemConfig->AtomMaxOcRatio));
  DEBUG ((DEBUG_INFO, " OVERCLOCKING_PREMEM_CONFIG:: AtomVoltageMode : 0x%X\n", OverClockingPreMemConfig->AtomVoltageMode));
  DEBUG ((DEBUG_INFO, " OVERCLOCKING_PREMEM_CONFIG:: AtomVoltageOverride : 0x%X\n", OverClockingPreMemConfig->AtomVoltageOverride));
  DEBUG ((DEBUG_INFO, " OVERCLOCKING_PREMEM_CONFIG:: AtomVoltageAdaptive : 0x%X\n", OverClockingPreMemConfig->AtomVoltageAdaptive));
  DEBUG ((DEBUG_INFO, " OVERCLOCKING_PREMEM_CONFIG:: AtomVoltageOffset : 0x%X\n", OverClockingPreMemConfig->AtomVoltageOffset));
