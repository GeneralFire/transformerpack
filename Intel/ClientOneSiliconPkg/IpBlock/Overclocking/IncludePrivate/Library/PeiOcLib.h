...
#define OC_LIB_CMD_GET_AVX_VOLTAGE_GUARDBAND        0x20
#define OC_LIB_CMD_SET_AVX_VOLTAGE_GUARDBAND        0x21
...
#define OC_LIB_DOMAIN_ID_L2_ATOM            0x05
...
#define AVX512_VOLTAGE_SCALING_OFFSET       8
#define AVX_VOLTAGE_SCALING_MAX             199
...
/**
  ...
  @param[in] MpServicesPpi            Pointer to this instance of the MpServices.
...
CpuOcInitPostMem (
  ...
  IN EFI_PEI_MP_SERVICES_PPI      *MpServicesPpi
  );
