...
// @todo: VER3: PIR offsets should be updated once known
...
//Dev, Reg
  ...
  {19, 19}, // HSUART
  {20, 20}, // USB
  {21, 21}, // IE HECI, PTIO, PMT
  {22, 22}, // ME HECI, PTIO, PMT
  {23, 23}, // SATA1
  {24, 24}, // SATA2
  {25, 25}, // SATA3
  {27, 27}, // Root Port
  {28, 28}, // Root Port
  {29, 29}, // Root Port
  {31, 31} // D31 LPC/eSPI, P2SB, PMC, FTH/EH, SMBUS legacy, SPI, NPK
};
...
/**
  Configure PCH ITSS registers as needed.
**/
VOID
ItssPchConfigure(
  VOID
