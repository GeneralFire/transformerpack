...
// Common
//
#define R_THC_MEM_COMMON_LTR_CTRL                          0x14          // THC LTR Control Register
...
#define  V_THC_MEM_PORT_SPI_CONFIG_HIGH_FREQ_40MHZ         (BIT0|BIT1)        // 40 MHz 011b Divide by 3, SPI_LOW_FREQ_EN = 0
...
#define R_THC_MEM_PORT_WRITE_INT_STS                       0x109C         // THC Write DMA Interrupt Status
...
#define  B_THC_PCR_SB_PM_CTRL_THC_LTR_EN                   BIT16          // This bit must be set to enable LTR messaging from THC to the PMC.
//
// Device Registers
//
