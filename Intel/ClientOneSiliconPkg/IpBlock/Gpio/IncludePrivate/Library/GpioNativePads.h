...
#define GPIO_SERIAL_IO_I3C_SCL     GPIO_NATIVE_FUNCTION_DEF(397,398)
#define GPIO_SERIAL_IO_I3C_SDA     GPIO_NATIVE_FUNCTION_DEF(399,400)
...
// Serial IO I3C
//
#define GPIO_SERIAL_IO_I3C_RANGE  2  // Number of Serial IO I3C controllers supported in GPIO_NATIVE_PAD encoding
