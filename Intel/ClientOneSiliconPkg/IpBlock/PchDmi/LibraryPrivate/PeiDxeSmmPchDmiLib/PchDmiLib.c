...
{
  return (UINT8) ((PchPcrRead16 (PID_DMI, R_PCH_DMI15_PCR_LSTS) & B_PCIE_LSTS_NLW) >> N_PCIE_LSTS_NLW);
}

/**
  Read DMI Maximum Link width

  @return DMI Maximum Link Width
**/
UINT8
PchDmiMaxLinkWidth (
  VOID
...
{
  return (UINT8) ((PchPcrRead16 (PID_DMI, R_PCH_DMI15_PCR_LCAP) & B_PCIE_LCAP_MLW) >> N_PCIE_LCAP_MLW);
}
