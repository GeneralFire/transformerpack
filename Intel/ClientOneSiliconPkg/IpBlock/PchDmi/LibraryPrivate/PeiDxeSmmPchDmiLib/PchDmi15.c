  ...
  )
{
  ...
  if (IsAdlPch () && IsPchS ()) {
    PchPcrAndThenOr32 (
      PID_DMI, R_PCH_DMI17_PCR_LPCR,
      (UINT32)~0u,
      (UINT32)(B_PCH_DMI17_PCR_LPCR_DIDOVRLOCK | B_PCH_DMI17_PCR_LPCR_LTRCFGLOCK |
               B_PCH_DMI17_PCR_LPCR_SERL | B_PCH_DMI17_PCR_LPCR_SRL)
      );
    PchPcrAndThenOr32 (
      PID_DMI, R_PCH_DMI17_PCR_SRL,
      (UINT32)~0u,
      (UINT32)(B_PCH_DMI17_PCR_SRL_SRL)
      );
