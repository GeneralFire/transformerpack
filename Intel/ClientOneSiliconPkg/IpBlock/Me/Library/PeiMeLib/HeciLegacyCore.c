/** @file
  Heci legacy driver core. For Pei Phase
  Wrapper for HECI_CONTROL API to HECI_PPI
  ...
  )
{
  ...
  Status = HeciControlPpi->HeciReceive (
                             HeciControlPpi,
                             HECI_DEFAULT_PCH_ID,
                             NULL,
                             NULL,
  ...
  )
{
  ...
  Status = HeciControlPpi->HeciSend (
                             HeciControlPpi,
                             HECI_DEFAULT_PCH_ID,
                             NULL,
                             HostAddress,
...
/**
  ...
  @param[in]      Length          Length of the request message in bytes.
  ...
  )
{
  ...
  Status = HeciControlPpi->HeciSendAndReceive (
                             HeciControlPpi,
                             HECI_DEFAULT_PCH_ID,
                             NULL,
  ...
  IN  HECI_DEVICE             HeciDev)
{
  ...
  Status = HeciControlPpi->HeciReset (
                             HeciControlPpi,
                             HECI_DEFAULT_PCH_ID,
                             NULL
                             );
  ...
  )
{
  ...
  Status = HeciControlPpi->HeciFirmwareStatus (
                             HeciControlPpi,
                             HECI_DEFAULT_PCH_ID,
                             1,
                             &(MeFirmwareStatus.ul)
...
/**
  Wait for HECI interface Reset execution

  @param[in] HeciDev              HECI interface we should wait on for reset
