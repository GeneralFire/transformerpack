/** @file
  Contains definitions relevant to the PPR & VLS Error Log Listener.
...
#ifndef _PPR_VLS_ERROR_LOG_LISTENER_H_
#define _PPR_VLS_ERROR_LOG_LISTENER_H_
...
#endif //  _PPR_VLS_ERROR_LOG_LISTENER_H_
