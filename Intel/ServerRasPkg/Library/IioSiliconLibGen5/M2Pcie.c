...
{
  R2PINGERRLOG0_IIO_M2IAL_STRUCT        R2PingErrLog0;
  R2EGRERRLOG_IIO_M2IAL_STRUCT          R2EgrErrLog;

  if (ErrSeverity == NONFATAL_ERROR_TYPE || ErrSeverity == FATAL_ERROR_TYPE) {
    R2PingErrLog0.Data = MmioRead32 (MmPciAddressExt (Socket, Bus, Device, Function, ONLY_REGISTER_OFFSET (R2PINGERRLOG0_IIO_M2IAL_REG), NULL));
    R2EgrErrLog.Data = MmioRead32 (MmPciAddressExt (Socket, Bus, Device, Function, ONLY_REGISTER_OFFSET (R2EGRERRLOG_IIO_M2IAL_REG), NULL));
  ...
  )
{
  ...
  if (R2PingErrLog0.Data != 0) {
    MmioWrite32 (MmPciAddressExt (Socket, Bus, Device, Function, ONLY_REGISTER_OFFSET (R2PINGERRLOG0_IIO_M2IAL_REG), NULL), R2PingErrLog0.Data);
  }
  R2EgrErrLog.Data = MmioRead32 (MmPciAddressExt (Socket, Bus, Device, Function, ONLY_REGISTER_OFFSET (R2EGRERRLOG_IIO_M2IAL_REG), NULL));
  if (R2EgrErrLog.Data != 0) {
    MmioWrite32 (MmPciAddressExt (Socket, Bus, Device, Function, ONLY_REGISTER_OFFSET (R2EGRERRLOG_IIO_M2IAL_REG), NULL), R2EgrErrLog.Data);
  }
