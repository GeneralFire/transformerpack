  ...
  )
{
  ...
  UINTN                         LekBArAddress;
  LEKBERR_IIO_PCIE_G5_STRUCT    LeakyBucketError;
  LEKBERR0_IIO_PCIE_G5_STRUCT   LeakyBucketTimeWindow0;
  LEKBERR1_IIO_PCIE_G5_STRUCT   LeakyBucketTimeWindow1;
  LEKBAR_IIO_PCIE_G5_STRUCT     LeakyBucketActions;
  ...
  LekBErrAddress  = MmPciAddressExt (Socket, Bus, Device, Function, ONLY_REGISTER_OFFSET (LEKBERR_IIO_PCIE_G5_REG), NULL);
  LekBErr0Address = MmPciAddressExt (Socket, Bus, Device, Function, ONLY_REGISTER_OFFSET (LEKBERR0_IIO_PCIE_G5_REG), NULL);
  LekBErr1Address = MmPciAddressExt (Socket, Bus, Device, Function, ONLY_REGISTER_OFFSET (LEKBERR1_IIO_PCIE_G5_REG), NULL);
  LekBArAddress   = MmPciAddressExt (Socket, Bus, Device, Function, ONLY_REGISTER_OFFSET (LEKBAR_IIO_PCIE_G5_REG), NULL);
  ...
  )
{
  ...
  UINTN                             G4StsAddress;
  LEKBPROERR_IIO_PCIE_G5_STRUCT     ProlongedError;
  LEKBLNERRCNT0_IIO_PCIE_G5_STRUCT  LaneErrorCount0;
  LEKBLNERRCNT1_IIO_PCIE_G5_STRUCT  LaneErrorCount1;
  LEKBLNERRCNT2_IIO_PCIE_G5_STRUCT  LaneErrorCount2;
  LEKBAR_IIO_PCIE_G5_STRUCT         LeakyBucketActions;
  LINKSTS2_IIO_PCIE_G5_STRUCT       LinkStatus2;
  G4STS_IIO_PCIE_G5_STRUCT          Gen4Status;

  LekBProErrAddress    = MmPciAddressExt (Socket, Bus, Device, Function, ONLY_REGISTER_OFFSET (LEKBPROERR_IIO_PCIE_G5_REG), NULL);
  LekBLnErrCnt0Address = MmPciAddressExt (Socket, Bus, Device, Function, ONLY_REGISTER_OFFSET (LEKBLNERRCNT0_IIO_PCIE_G5_REG), NULL);
  LekBLnErrCnt1Address = MmPciAddressExt (Socket, Bus, Device, Function, ONLY_REGISTER_OFFSET (LEKBLNERRCNT1_IIO_PCIE_G5_REG), NULL);
  LekBLnErrCnt2Address = MmPciAddressExt (Socket, Bus, Device, Function, ONLY_REGISTER_OFFSET (LEKBLNERRCNT2_IIO_PCIE_G5_REG), NULL);
  LekBArAddress        = MmPciAddressExt (Socket, Bus, Device, Function, ONLY_REGISTER_OFFSET (LEKBAR_IIO_PCIE_G5_REG), NULL);
  LinkSts2Address      = MmPciAddressExt (Socket, Bus, Device, Function, ONLY_REGISTER_OFFSET (LINKSTS2_IIO_PCIE_G5_REG), NULL);
  G4StsAddress         = MmPciAddressExt (Socket, Bus, Device, Function, ONLY_REGISTER_OFFSET (G4STS_IIO_PCIE_G5_REG), NULL);
...
{
  ERRCORMSK_IIO_PCIE_G5_STRUCT         CorErrMsk;
  ERRUNCMSK_IIO_PCIE_G5_STRUCT         UncErrMsk;
  CORERRCNT_IIO_PCIE_G5_STRUCT         CorErrCnt;
  ...
  if (!PcieIsDevicePresent (Socket, Bus, Device, Function, NULL)) {
    ...
    CorErrMsk.Data = MmioRead32 (
      MmPciAddressExt (Socket, Bus, Device, Function, ONLY_REGISTER_OFFSET (ERRCORMSK_IIO_PCIE_G5_REG), NULL)
      );
    UncErrMsk.Data = MmioRead32 (
      MmPciAddressExt (Socket, Bus, Device, Function, ONLY_REGISTER_OFFSET (ERRUNCMSK_IIO_PCIE_G5_REG), NULL)
      );
    CorErrCnt.Data = MmioRead32 (
      MmPciAddressExt (Socket, Bus, Device, Function, ONLY_REGISTER_OFFSET (CORERRCNT_IIO_PCIE_G5_REG), NULL)
      );

    RAS_DEBUG ((LEVEL_FUNC_FLOW, "  ERRCORMSK_IIO_PCIE_G5_REG:      0x%08x\n", CorErrMsk.Data));
    RAS_DEBUG ((LEVEL_FUNC_FLOW, "  ERRUNCMSK_IIO_PCIE_G5_REG:      0x%08x\n", UncErrMsk.Data));
    RAS_DEBUG ((LEVEL_FUNC_FLOW, "  CORERRCNT_IIO_PCIE_G5_REG:      0x%08x\n", CorErrCnt.Data));
  }
}
