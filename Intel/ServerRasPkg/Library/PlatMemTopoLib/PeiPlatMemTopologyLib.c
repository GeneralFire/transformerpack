...
/** @file
  Construct of PeiPlatMemTopologyLib.
...
/**
  ...
  The constructor function initialize PEI memory topology library.
  ...
  )
{
  ...
  mMemTopology = GetRasGlobalData (L"PeiPlatMemTopology", sizeof (MEM_TOPOLOGY), &NewAllocation);
