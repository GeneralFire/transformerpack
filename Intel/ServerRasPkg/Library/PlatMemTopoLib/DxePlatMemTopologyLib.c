...
/** @file
  Construct of DxePlatMemTopologyLib.
...
/**
  ...
  The constructor function initialize DXE memory topology library.
  ...
  )
{
  ...
  mMemTopology = GetRasGlobalData (L"DxePlatMemTopology", sizeof (MEM_TOPOLOGY), &NewAllocation);
