...
#ifdef GNRSRF_HOST
  KTI_MCA_CFG_N0_KTI_LLPMON_STRUCT   KtiMcaN0Reg;
#else // GNRSRF_HOST
...
#ifdef GNRSRF_HOST
      KtiMcaN0Reg.Data = ReadCpuCsr (Skt, LinkIndex, KTI_MCA_CFG_N0_KTI_LLPMON_REG);
      KtiMcaN0Reg.Bits.latch_first_ce = KtiFirstCeLatchEn;
      WriteCpuCsr (Skt, LinkIndex, KTI_MCA_CFG_N0_KTI_LLPMON_REG, KtiMcaN0Reg.Data);
#else // GNRSRF_HOST
...
{
  UINT8                               Skt;
  CBOMCACONFIG_LBW_CHABC_SAD_STRUCT   CboMcaCfgReg;
  ...
  for (Skt = 0; Skt < MAX_SOCKET; Skt ++) {
    ...
    CboMcaCfgReg.Data = ReadCpuCsr (Skt, 0, CBOMCACONFIG_LBW_CHABC_SAD_REG);
    CboMcaCfgReg.Bits.clr_sbit = LlcEwbErrorControl;
    WriteCpuCsr (Skt, 0, CBOMCACONFIG_LBW_CHABC_SAD_REG, CboMcaCfgReg.Data);
  }
}
