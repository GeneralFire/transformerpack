  ...
  )
{
  ...
  if (MailBox->IioInitPar.IioIrpErrorEn == 1) {
    ...
    if (IsSiliconWorkaroundEnabled ("S2206628166")) {
    ...
    IrpErrCtl.Bits.wrcache_uncecc_error_cs1 = 1;
    IrpErrCtl.Bits.wrcache_uncecc_error_cs0 = 1;
    IrpErrCtl.Bits.protocol_rcvd_poison = 1;
    IrpErrCtl.Bits.wrcache_correcc_error_cs1 = 1;
    IrpErrCtl.Bits.wrcache_correcc_error_cs0 = 1;
  ...
  )
{
  ...
  OTcErrCtl.Bits.otc_sb_of = 1;
  OTcErrCtl.Bits.otc_sb_uf = 1;
