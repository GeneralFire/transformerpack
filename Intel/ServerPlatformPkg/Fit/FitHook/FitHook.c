...
#define FIT_TABLE_OFFSET_START          (FV_ACM_BASE - FLASH_BASE)
// APTIOV_SERVER_OVERRIDE_RC_START: ACM region not updated with AFU Flash option /p /b /n 
#define FIT_TABLE_OFFSET_END            (FIT_TABLE_OFFSET_START + BIOSACM_SIZE)
// APTIOV_SERVER_OVERRIDE_RC_END: ACM region not updated with AFU Flash option /p /b /n
//----------------------------------------------------------------------
