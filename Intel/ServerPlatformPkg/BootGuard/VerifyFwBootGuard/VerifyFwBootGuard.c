...
// APTIOV_SERVER_OVERRIDE_START : Changed as per TXT_BtG_BiosSpec
#define R_ME_HFSTS6                          0x6C
// APTIOV_SERVER_OVERRIDE_END : Changed as per TXT_BtG_BiosSpec
...
)
{
    ...
    //
    // APTIOV_SERVER_OVERRIDE_START : As per Table 2-2 Server ACM Sizes, ACM should be 256 KB aligned
    //
    ...
    //
    // APTIOV_SERVER_OVERRIDE_END : Below limitation is not mentioned in TXT BtG Spec & this condition does not satisfy.
    //
...
)
{
    ...
    DEBUG((EFI_D_INFO,"[VerifyFwBootGuard.c]  %a : - Start\n",__FUNCTION__));
    ...
    DEBUG((EFI_D_INFO,"[VerifyFwBootGuard.c]  %a : - End\n",__FUNCTION__));
    return Status;
}
