...
#ifndef _EFI_VIDEOPRINT_DXE_H
#define _EFI_VIDEOPRINT_DXE_H
...
typedef
EFI_STATUS
(EFIAPI *EFI_VIDEOPRINT_PROTOCOL_VIDEO_PRINT ) (
...
typedef 
EFI_STATUS
(EFIAPI *EFI_VIDEOPRINT_PROTOCOL_VIDEO_PRINT_COLOR ) (
...
typedef 
UINT32
(EFIAPI *EFI_VIDEOPRINT_PROTOCOL_VIDEO_PRINT_XY_COLOR ) (
  IN UINT8 Row, 
  IN UINT8 Column,
  IN UINT8 ForegroundColor,
  IN UINT8 BackgroundColor,
...
typedef
EFI_STATUS
(EFIAPI *EFI_VIDEOPRINT_PROTOCOL_CONSOLE_CLEAR ) ();

typedef struct _EFI_VIDEOPRINT_PROTOCOL {
  EFI_VIDEOPRINT_PROTOCOL_VIDEO_PRINT            ConsolePrint; 
  EFI_VIDEOPRINT_PROTOCOL_VIDEO_PRINT_COLOR      ConsolePrintColor;
  EFI_VIDEOPRINT_PROTOCOL_VIDEO_PRINT_XY_COLOR   ConsolePrintXYColor;
  EFI_VIDEOPRINT_PROTOCOL_CONSOLE_CLEAR          ConsoleClear;
} EFI_VIDEOPRINT_PROTOCOL;
...
extern EFI_GUID   gEfiVideoPrintProtocolGuid;
