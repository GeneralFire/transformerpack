/** @file
  Header file for PEI MemoryPolicyUpdateLib Library.
...
#ifndef _PEI_MEMORY_POLICY_UPDATE_LIB_H_
#define _PEI_MEMORY_POLICY_UPDATE_LIB_H_
...
#endif // _PEI_MEMORY_POLICY_UPDATE_LIB_H_
