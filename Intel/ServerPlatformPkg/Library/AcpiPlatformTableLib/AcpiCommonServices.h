...
#ifndef _ACPI_COMMON_SERVICES_H_
#define _ACPI_COMMON_SERVICES_H_
...
//
// This structure represents any particular stack attributes. If needed,
// add more stack attributes
//
typedef struct {
  UINT8   SocketId;
  UINT8   StackId;
