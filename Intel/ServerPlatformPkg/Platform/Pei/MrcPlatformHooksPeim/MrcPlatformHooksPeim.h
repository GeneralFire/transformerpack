/** @file
  Header file for the MrcPlatformHooksPeim that produces the MRC_PLATFORM_HOOKS_INTERFACE.
...
#ifndef _MRC_PLATFORM_HOOKS_PEIM_H_
#define _MRC_PLATFORM_HOOKS_PEIM_H_
...
#endif // _MRC_PLATFORM_HOOKS_PEIM_H_
