  ...
  )
{
  ...
  AsciiStrCpyS (AsciiBuffer, BufferAsciiSize, PchGetSeriesStr ());
  ...
  PchGetSteppingStr (AsciiBuffer, BufferAsciiSize);
  AsciiStrToUnicodeStrS (AsciiBuffer, UnicodeBuffer, STRING_WIDTH_40);
  ZeroMem (AsciiBuffer, BufferAsciiSize);
  ...
  AsciiStrCpyS (AsciiBuffer, BufferAsciiSize, PchGetSkuStr ());
  AsciiStrToUnicodeStrS (AsciiBuffer, UnicodeBuffer, STRING_WIDTH_40);
  ZeroMem (AsciiBuffer, BufferAsciiSize);
  StrCatS (PchName, STRING_WIDTH_40, UnicodeBuffer);
