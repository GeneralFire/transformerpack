  ...
  )
{
  ...
  if (!mModeInitialized) {
    ...
    //
    mSetupHorizontalResolution = 100; //PcdGet32 (PcdSetupVideoHorizontalResolution);
    mSetupVerticalResolution   = 100; //PcdGet32 (PcdSetupVideoVerticalResolution);
    mSetupTextModeColumn       = 100; //PcdGet32 (PcdSetupConOutColumn);
    mSetupTextModeRow          = 100; //PcdGet32 (PcdSetupConOutRow);
