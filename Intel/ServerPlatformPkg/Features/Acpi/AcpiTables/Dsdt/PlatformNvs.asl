...
**/
  ...
  Offset(11),     P80D, 32, // Offset(11),    Port 80 Debug Port Value
  ...
  // Revision Field:
  //
  Offset(29),     REVN, 8,  // Offset(29),    Revison of GlobalNvsArea
  //
  // CPU Identification Registers:
  //
  Offset(30),     APIC, 8,  // Offset(30),    APIC Enabled by SBIOS (APIC Enabled = 1)
  Offset(31),     TCNT, 8,  // Offset(31),    Number of Enabled Threads
  Offset(32),     PCP0, 8,  // Offset(32),    PDC Settings, Processor 0
  Offset(33),     PCP1, 8,  // Offset(33),    PDC Settings, Processor 1
  Offset(34),     PPCM, 8,  // Offset(34),    Maximum PPC state
  Offset(35),     PPMF, 32, // Offset(35),    PPM Flags (Same as CFGD)
  Offset(39),     C67L, 8,  // Offset(39),    C6/C7 Entry/Exit latency
  //
  // SIO Configuration Registers:
  //
  Offset(40),     NATP, 8,  // Offset(40),    National SIO Present
  Offset(41),     CMAP, 8,  // Offset(41),    COM A Port
  Offset(42),     CMBP, 8,  // Offset(42),    COM B Port
  Offset(43),     LPTP, 8,  // Offset(43),    LPT Port
  Offset(44),     FDCP, 8,  // Offset(44),    FDC Port
  Offset(45),     W381, 8,  // Offset(45),    WPCN381U SIO Present
  //
  ...
  // Already defined in 10nmServerPlatformPkg/Acpi/AcpiTables/Dsdt/BiosParameterRegion.asi
  //
  ...
  Offset(97),     RTIP, 8,  // Offset(97),    Run Time Interface for Intelligent Power Savings
  Offset(98),     TSOD, 8,  // Offset(98),    TS-on-DIMM is chosen in SETUP and present on the DIMM
  //
  // Board info
  //
  Offset(99),     PFLV, 8,  // Offset(99),    Platform Flavor
  Offset(100),    BREV, 8,  // Offset(100),   Board Rev
  //
  // Package temperature
  //
  ...
  Offset(127),    SACR, 8,  // Offset(127),   CriticalThermalTripPointSa
  ...
  //
  Offset(500),              // Offset(183) : Offset(499), Reserved bytes
  ...
  Offset(540),    WGRC, 8,  // Offset(540),   Enable RTD3 Cold Support for Wigig
  Offset(541),    WWRC, 8,  // Offset(541),   Enable RTD3 Cold Support for WWAN
  // Conflict with 10nmServerPlatformPkg/Acpi/AcpiTables/Dsdt/BiosParameterRegion.asi
  //
  // Driver Mode
  //
  ...
  // DPTF
  //
  Offset(820),    PERE, 8,  // Offset(820),   EnablePerCParticipant
  Offset(821),    PEAT, 8,  // Offset(821),   ActiveThermalTripPointPerC
  Offset(822),    PEPV, 8,  // Offset(822),   PassiveThermalTripPointPerC
  Offset(823),    PECR, 8,  // Offset(823),   CriticalThermalTripPointPerC
  Offset(824),    PEC3, 8,  // Offset(824),   CriticalThermalTripPointPerCS3
  Offset(825),    PEHT, 8,  // Offset(825),   HotThermalTripPointPerC
  Offset(826),    ECLP, 8,  // Offset(826),   EC Low Power Mode: 1 - Enabled, 0 - Disabled
  Offset(827),    SSP1, 8,  // Offset(827),   SensorSamplingPeriodSen1
  Offset(828),    SSP2, 8,  // Offset(828),   SensorSamplingPeriodSen2
  Offset(829),    SSP3, 8,  // Offset(829),   SensorSamplingPeriodSen3
  Offset(830),    SSP4, 8,  // Offset(830),   SensorSamplingPeriodSen4
  Offset(831),    SSP5, 8,  // Offset(831),   SensorSamplingPeriodSen5
  Offset(832),    SGE1, 8,  // Offset(832),   EnableStorageParticipantST1
  Offset(833),    SAT1, 8,  // Offset(833),   ActiveThermalTripPointST1
  Offset(834),    SPT1, 8,  // Offset(834),   PassiveThermalTripPointST1
  Offset(835),    SCT1, 8,  // Offset(835),   CriticalThermalTripPointST1
  Offset(836),    SC31, 8,  // Offset(836),   CriticalThermalTripPointS3ST1
  Offset(837),    SHT1, 8,  // Offset(837),   HotThermalTripPointST1
  Offset(838),    SGE2, 8,  // Offset(838),   EnableStorageParticipantST2
  Offset(839),    SAT2, 8,  // Offset(839),   ActiveThermalTripPointST2
  Offset(840),    SPT2, 8,  // Offset(840),   PassiveThermalTripPointST2
  Offset(841),    SCT2, 8,  // Offset(841),   CriticalThermalTripPointST2
  Offset(842),    SC32, 8,  // Offset(842),   CriticalThermalTripPointS3ST2
  Offset(843),    SHT2, 8,  // Offset(843),   HotThermalTripPointST2
  Offset(844),    VSP1, 8,  // Offset(844),   EnableVS1Participant
  Offset(845),    V1AT, 8,  // Offset(845),   ActiveThermalTripPointVS1
  Offset(846),    V1PV, 8,  // Offset(846),   PassiveThermalTripPointVS1
  Offset(847),    V1CR, 8,  // Offset(847),   CriticalThermalTripPointVS1
  Offset(848),    V1C3, 8,  // Offset(848),   CriticalThermalTripPointVS1S3
  Offset(849),    V1HT, 8,  // Offset(849),   HotThermalTripPointVS1
  Offset(850),    VSP2, 8,  // Offset(850),   EnableVS2Participant
  Offset(851),    V2AT, 8,  // Offset(851),   ActiveThermalTripPointVS2
  Offset(852),    V2PV, 8,  // Offset(852),   PassiveThermalTripPointVS2
  Offset(853),    V2CR, 8,  // Offset(853),   CriticalThermalTripPointVS2
  Offset(854),    V2C3, 8,  // Offset(854),   CriticalThermalTripPointVS2S3
  Offset(855),    V2HT, 8,  // Offset(855),   HotThermalTripPointVS2
  Offset(856),    S1DE, 8,  // Offset(856),   EnableSen1Participant
  Offset(857),    S1AT, 8,  // Offset(857),   ActiveThermalTripPointSen1
  Offset(858),    S1PT, 8,  // Offset(858),   PassiveThermalTripPointSen1
  Offset(859),    S1CT, 8,  // Offset(859),   CriticalThermalTripPointSen1
  Offset(860),    S1HT, 8,  // Offset(860),   HotThermalTripPointSen1
  Offset(861),    S2DE, 8,  // Offset(861),   EnableSen2Participant
  Offset(862),    S2AT, 8,  // Offset(862),   ActiveThermalTripPointSen2
  Offset(863),    S2PT, 8,  // Offset(863),   PassiveThermalTripPointSen2
  Offset(864),    S2CT, 8,  // Offset(864),   CriticalThermalTripPointSen2
  Offset(865),    S2HT, 8,  // Offset(865),   HotThermalTripPointSen2
  Offset(866),    S3DE, 8,  // Offset(866),   EnableSen3Participant
  Offset(867),    S3AT, 8,  // Offset(867),   ActiveThermalTripPointSen3
  Offset(868),    S3PT, 8,  // Offset(868),   PassiveThermalTripPointSen3
  Offset(869),    S3CT, 8,  // Offset(869),   CriticalThermalTripPointSen3
  Offset(870),    S3HT, 8,  // Offset(870),   HotThermalTripPointSen3
  Offset(871),    S4DE, 8,  // Offset(871),   EnableSen4Participant
  Offset(872),    S4AT, 8,  // Offset(872),   ActiveThermalTripPointSen4
  Offset(873),    S4PT, 8,  // Offset(873),   PassiveThermalTripPointSen4
  Offset(874),    S4CT, 8,  // Offset(874),   CriticalThermalTripPointSen4
  Offset(875),    S4HT, 8,  // Offset(875),   HotThermalTripPointSen4
  Offset(876),    S5DE, 8,  // Offset(876),   EnableSen5Participant
  Offset(877),    S5AT, 8,  // Offset(877),   ActiveThermalTripPointSen5
  Offset(878),    S5PT, 8,  // Offset(878),   PassiveThermalTripPointSen5
  Offset(879),    S5CT, 8,  // Offset(879),   CriticalThermalTripPointSen5
  Offset(880),    S5HT, 8,  // Offset(880),   HotThermalTripPointSen5
  Offset(881),    S1S3, 8,  // Offset(881),   CriticalThermalTripPointSen1S3
  Offset(882),    S2S3, 8,  // Offset(882),   CriticalThermalTripPointSen2S3
  Offset(883),    S3S3, 8,  // Offset(883),   CriticalThermalTripPointSen3S3
  Offset(884),    S4S3, 8,  // Offset(884),   CriticalThermalTripPointSen4S3
  Offset(885),    S5S3, 8,  // Offset(885),   CriticalThermalTripPointSen5S3
  Offset(888),              // Offset(886) : Offset(887), Reserved bytes
  ...
  Offset(898),    PDT2, 8,  // Offset(898),   PsmSplcDomainType2
  Offset(899),    PLM2, 32, // Offset(899),   PsmSplcPowerLimit2
  Offset(903),    PTW2, 32, // Offset(903),   PsmSplcTimeWindow2
  ...
  Offset(923),    DDT2, 8,  // Offset(923),   PsmDplcDomainType2
  Offset(924),    DDP2, 8,  // Offset(924),   PsmDplcDomainPreference2
  Offset(925),    DLI2, 16, // Offset(925),   PsmDplcPowerLimitIndex2
  Offset(927),    DPL2, 16, // Offset(927),   PsmDplcDefaultPowerLimit2
  Offset(929),    DTW2, 32, // Offset(929),   PsmDplcDefaultTimeWindow2
  Offset(933),    DMI2, 16, // Offset(933),   PsmDplcMinimumPowerLimit2
  Offset(935),    DMA2, 16, // Offset(935),   PsmDplcMaximumPowerLimit2
  Offset(937),    DMT2, 16, // Offset(937),   PsmDplcMaximumTimeWindow2
  ...
  Offset(947),    DOM2, 8,  // Offset(947),   WifiDomainType2
  Offset(948),    LIM2, 16, // Offset(948),   WifiPowerLimit2
  Offset(950),    TIM2, 32, // Offset(950),   WifiTimeWindow2
  Offset(954),    DOM3, 8,  // Offset(954),   WifiDomainType3
  Offset(955),    LIM3, 16, // Offset(955),   WifiPowerLimit3
  Offset(957),    TIM3, 32, // Offset(957),   WifiTimeWindow3
  ...
  Offset(968),    WDM2, 8,  // Offset(968),   WrddDomainType2
  Offset(969),    CID2, 16, // Offset(969),   WrddCountryIndentifier2
  ...
  Offset(1034),   TPLB, 8,  // Offset(1034),  custom touchpanel's bus address
  Offset(1035),   TPLH, 16, // Offset(1035),  custom touchpanel's HID address
  Offset(1037),   WTVX, 8,  // Offset(1037),  WITT test devices' version
  Offset(1038),   WITX, 8,  // Offset(1038),  WITT test devices' connection point
  Offset(1039),   GPTD, 8,  // Offset(1039),  GPIO test devices
  Offset(1040),   GDBT, 16, // Offset(1040),  GPIO test devices' debounce value,
  Offset(1042),   UTKX, 8,  // Offset(1042),  UTK test devices' connection point
  Offset(1043),   SPTD, 8,  // Offset(1043),  SerialIo additional test devices
  Offset(1065),             // Offset(1044) : Offset(1064), Reserved bytes
  ...
  Offset(1655),             // Offset(1648) : Offset(1654), Reserved bytes
  Offset(1655),   ECR1, 8,  // Offset(1655),
  Offset(1656),   I2SC, 8,  // Offset(1656),  HD Audio I2S Codec Selection
  Offset(1657),   I2SI, 32, // Offset(1657),  HD Audio I2S Codec Interrupt Pin
  Offset(1661),   ODV0, 8,  // Offset(1661),  DPTF Oem Design Variables
  Offset(1662),   ODV1, 8,  // Offset(1662),  DPTF Oem Design Variables
  Offset(1663),   ODV2, 8,  // Offset(1663),  DPTF Oem Design Variables
  Offset(1664),   ODV3, 8,  // Offset(1664),  DPTF Oem Design Variables
  Offset(1665),   ODV4, 8,  // Offset(1665),  DPTF Oem Design Variables
  Offset(1666),   ODV5, 8,  // Offset(1666),  DPTF Oem Design Variables
  Offset(1667),   UBCB, 32, // Offset(1667),  USB Type C Opregion base address
  Offset(1672),             // Offset(1671) : Offset(1671), Reserved bytes
  Offset(1672),   WIFC, 8,  // Offset(1672),  WirelessCharging
  // RTD3 Settings
  #ifdef TESTMENU_FLAG
  Offset(1673),   TPRP, 8,  // Offset(1673),  Test menu Pcie Root Ports RTD3 Configuration
  Offset(1674),   TSAT, 8,  // Offset(1674),  Test menu Sata RTD3 Configuration
  Offset(1675),   TUSB, 8,  // Offset(1675),  Test menu Usb RTD3 Configuration
  Offset(1676),   TACD, 8,  // Offset(1676),  Test menu AudioCodec RTD3 Configuration
  Offset(1677),   THAD, 8,  // Offset(1677),  Test menu HD Audio RTD3 Configuration
  Offset(1678),   TTPL, 8,  // Offset(1678),  Test menu Touch Panel RTD3 Configuration
  #endif
  Offset(1680),             // Offset(1673) : Offset(1679), Reserved bytes
  Offset(1680),   TPLS, 8,  // Offset(1680),  custom touchpanel's bus speed
  Offset(1681),   TPDB, 8,  // Offset(1681),  custom touchpad's bus address
  Offset(1682),   TPDH, 16, // Offset(1682),  custom touchpad's HID address
  Offset(1684),   TPDS, 8,  // Offset(1684),  custom touchpad's bus speed
  Offset(1685),   ADPM, 32, // Offset(1685),  HD-Audio DSP Post-Processing Module Mask
  Offset(1689),   AG1L, 64, // Offset(1689),  HDA PP module custom GUID 1 - first 64bit  [0-63]
  Offset(1697),   AG1H, 64, // Offset(1697),  HDA PP module custom GUID 1 - second 64bit [64-127]
  Offset(1705),   AG2L, 64, // Offset(1705),  HDA PP module custom GUID 2 - first 64bit  [0-63]
  Offset(1713),   AG2H, 64, // Offset(1713),  HDA PP module custom GUID 2 - second 64bit [64-127]
  Offset(1721),   AG3L, 64, // Offset(1721),  HDA PP module custom GUID 3 - first 64bit  [0-63]
  Offset(1729),   AG3H, 64, // Offset(1729),  HDA PP module custom GUID 3 - second 64bit [64-127]
  Offset(1737),   HEFE, 8,  // Offset(1737),  HID Event Filter Driver enable
  Offset(1738),   XDCE, 8,  // Offset(1738),  XDCI Enable/Disable status
  Offset(1739),   STXE, 8,  // Offset(1739),  WrdsWiFiSarEnable
  Offset(1740),   ST10, 8,  // Offset(1740),  WrdsWiFiSarTxPowerSet1Limit1
  Offset(1741),   ST11, 8,  // Offset(1741),  WrdsWiFiSarTxPowerSet1Limit2
  Offset(1742),   ST12, 8,  // Offset(1742),  WrdsWiFiSarTxPowerSet1Limit3
  Offset(1743),   ST13, 8,  // Offset(1743),  WrdsWiFiSarTxPowerSet1Limit4
  Offset(1744),   ST14, 8,  // Offset(1744),  WrdsWiFiSarTxPowerSet1Limit5
  Offset(1745),   ST15, 8,  // Offset(1745),  WrdsWiFiSarTxPowerSet1Limit6
  Offset(1746),   ST16, 8,  // Offset(1746),  WrdsWiFiSarTxPowerSet1Limit7
  Offset(1747),   ST17, 8,  // Offset(1747),  WrdsWiFiSarTxPowerSet1Limit8
  Offset(1748),   ST18, 8,  // Offset(1748),  WrdsWiFiSarTxPowerSet1Limit9
  Offset(1749),   ST19, 8,  // Offset(1749),  WrdsWiFiSarTxPowerSet1Limit10
  Offset(1750),   ENVM, 8,  // Offset(1750),  Enable Voltage Margining
  Offset(1751),   DHSP, 16, // Offset(1751),  D-State for xHCI HS port(BIT0:USB HS Port0 ~ BIT15:USB HS Port15)
// APTIOV_SERVER_OVERRIDE_RC_START : DSSP conflicts with HDD_SECURITY_SUPPORT
//  Offset(1753),   DSSP, 16, // Offset(1753),  D-State for xHCI SS port(BIT0:USB SS Port0 ~ BIT15:USB SS Port15)
  Offset(1753),   DSRP, 16, // Offset(1753),  D-State for xHCI SS port(BIT0:USB SS Port0 ~ BIT15:USB SS Port15)
// APTIOV_SERVER_OVERRIDE_RC_END : DSSP conflicts with HDD_SECURITY_SUPPORT
  Offset(1755),   DSTP, 8,  // Offset(1755),  D-State for SATA port(BIT0:SATA Port0 ~ BIT7:SATA Port7)
  Offset(1756),   WRFE, 8,  // Offset(1756),  WigigRfe
  Offset(1757),   WRC1, 8,  // Offset(1757),  WiGigRfeCh1
  Offset(1758),   WRC2, 8,  // Offset(1758),  WiGigRfeCh2
  Offset(1759),   WRC3, 8,  // Offset(1759),  WiGigRfeCh3
  Offset(1760),   WRC4, 8,  // Offset(1760),  WiGigRfeCh4
  Offset(1761),   AWVI, 32, // Offset(1761),  AwvClassIndex
  ...
  Offset(1872),   TPPT, 8,  // Offset(1872),  Power Participant
  Offset(1873),   ZPOD, 8,  // Offset(1873),  ZPODD
  Offset(1874),   RGBC, 8,  // Offset(1874),  RGB Camera Address
  Offset(1875),   DPTC, 8,  // Offset(1875),  Depth Camera Addresy
  Offset(1876),   SRSP, 32, // Offset(1876),  SMC Runtime Sci Pin
  Offset(1880),   CEDS, 8,  // Offset(1880),  Convertable Dock Support
  Offset(1881),   EHK3, 8,  // Offset(1881),  Ec Hotkey F3 Support
  Offset(1882),   EHK4, 8,  // Offset(1882),  Ec Hotkey F4 Support
  Offset(1883),   EHK5, 8,  // Offset(1883),  Ec Hotkey F5 Support
  Offset(1884),   EHK6, 8,  // Offset(1884),  Ec Hotkey F6 Support
  Offset(1885),   EHK7, 8,  // Offset(1885),  Ec Hotkey F7 Support
  Offset(1886),   EHK8, 8,  // Offset(1886),  Ec Hotkey F8 Support
  Offset(1887),   VBVP, 8,  // Offset(1887),  Virtual Button Volume Up Support
  Offset(1888),   VBVD, 8,  // Offset(1888),  Virtual Button Volume Down Support
  Offset(1889),   VBHB, 8,  // Offset(1889),  Virtual Button Home Button Support
  Offset(1890),   VBRL, 8,  // Offset(1890),  Virtual Button Rotation Lock Support
  Offset(1891),   SMSS, 8,  // Offset(1891),  Slate Mode Switch Support
  ...
  Offset(1917),             // Offset(1902) : Offset(1916), Reserved bytes
  ...
  Offset(1926),   WGWS, 8,  // Offset(1926),  Wake on S3-S4 WiGig Docking Support
  //
  // UCMC setup option, GPIO Pad
  //
  Offset(1928),   UCSI, 8,  // Offset(1928),  Option to Enable/Disable UCSI/UCMC device
  Offset(1929),   UCG1, 32, // Offset(1929),  Gpio for UCMC Port 1 Interrupt
  Offset(1933),   UCG2, 32, // Offset(1933),  Gpio for UCMC Port 2 Interrupt
  Offset(1959),             // Offset(1937) : Offset(1958), Reserved bytes
  Offset(1963),   SRLD, 8,  // Offset(1963),  Serial Port ACPI debug
  Offset(1964),   TTUP, 8,  // Offset(1964),  Total Number of type C ports that are supported by platform
  Offset(1965),   TP1T, 8,  // Offset(1965),  Type C Connector 1  Port mapping within the controller the port exposed
  Offset(1966),   TP1P, 8,  // Offset(1966),  Type C Connector 1  Port mapping within the PCH controller (If Split mode supported)
  Offset(1967),   TP1D, 8,  // Offset(1967),  Type C Connector 1  Portperties Split Support/Controller(PCH/TBT/CPU)/Root port (vaild for TBT)
  Offset(1968),   TP2T, 8,  // Offset(1968),  Type C Connector 2  Port mapping within the controller the port exposed
  Offset(1969),   TP2P, 8,  // Offset(1969),  Type C Connector 2  Port mapping within the PCH controller (If Split mode supported)
  Offset(1970),   TP2D, 8,  // Offset(1970),  Type C Connector 2  Portperties Split Support/Controller(PCH/TBT/CPU)/Root port (vaild for TBT)
  Offset(1971),   TP3T, 8,  // Offset(1971),  Type C Connector 3  Port mapping within the controller the port exposed
  Offset(1972),   TP3P, 8,  // Offset(1972),  Type C Connector 3  Port mapping within the PCH controller (If Split mode supported)
  Offset(1973),   TP3D, 8,  // Offset(1973),  Type C Connector 3  Portperties Split Support/Controller(PCH/TBT/CPU)/Root port (vaild for TBT)
  Offset(1974),   TP4T, 8,  // Offset(1974),  Type C Connector 4  Port mapping within the controller the port exposed
  Offset(1975),   TP4P, 8,  // Offset(1975),  Type C Connector 4  Port mapping within the PCH controller (If Split mode supported)
  Offset(1976),   TP4D, 8,  // Offset(1976),  Type C Connector 4  Portperties Split Support/Controller(PCH/TBT/CPU)/Root port (vaild for TBT)
  Offset(1977),   TP5T, 8,  // Offset(1977),  Type C Connector 5  Port mapping within the controller the port exposed
  Offset(1978),   TP5P, 8,  // Offset(1978),  Type C Connector 5  Port mapping within the PCH controller (If Split mode supported)
  Offset(1979),   TP5D, 8,  // Offset(1979),  Type C Connector 5  Portperties Split Support/Controller(PCH/TBT/CPU)/Root port (vaild for TBT)
  Offset(1980),   TP6T, 8,  // Offset(1980),  Type C Connector 6  Port mapping within the controller the port exposed
  Offset(1981),   TP6P, 8,  // Offset(1981),  Type C Connector 6  Port mapping within the PCH controller (If Split mode supported)
  Offset(1982),   TP6D, 8,  // Offset(1982),  Type C Connector 6  Portperties Split Support/Controller(PCH/TBT/CPU)/Root port (vaild for TBT)
  Offset(1983),   UDGF, 8,  // Offset(1983),  Upstream Facing port or Downstream Facing port Global Flag from LPC EC
  Offset(1984),   UDUP, 8,  // Offset(1984),  Upstream Facing port or Downstream Facing port number from LPC EC
  Offset(1985),   DBGF, 8,  // Offset(1985),  Debug Mode Global Flag from LPC EC
  Offset(1986),   DBUP, 8,  // Offset(1986),  Debug Mode USB Port Number from LPC EC
  }
