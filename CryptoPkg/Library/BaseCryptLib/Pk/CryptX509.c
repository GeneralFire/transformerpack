...
#include "internal/evp_int.h"    //APTIOV OVERRIDE - To avoid build error for Openssl-1.1.0
#include "internal/x509_int.h"   //APTIOV OVERRIDE - To avoid build error for Openssl-1.1.0
