...
{
  // APTIOV_SERVER_OVERRIDE_RC_START : Commented Hob creation/consumption and made changes to always use the current TSC frequency.
  ...
  //  if (PerformanceCounterFrequency == NULL) {
  ...
  // APTIOV_SERVER_OVERRIDE_RC_END : Commented Hob creation/consumption and made changes to always use the current TSC frequency.
}
