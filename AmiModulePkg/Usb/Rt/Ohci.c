...
//        USB_DEBUG(DEBUG_DEV_INIT|DEBUG_HC, "after OHCI_ProcessRootHubStatusChange\n");
    ...
    for (;;) {
        ...
        do {
            ...
            NextTd = (OHCI_TD*)(UINTN)Td->fpLinkPointer;
...
)
{
    ...
    *SetupData++ = Length;
    ...
    do {
        ...
        Td->bActiveFlag = TRUE;
        Td = (OHCI_TD*)(UINTN)Td->fpLinkPointer;
    } while (Td);
    //
...
)
{
    ...
    ((OHCI_TD*)DevInfo->PollTdPtr)->dCSReloadValue = (UINT32)(GTD_BUFFER_ROUNDING | GTD_IN_PACKET | GTD_IntD |
                GTD_NO_ERRORS | (GTD_NOT_ACCESSED << 28));
    ((OHCI_TD*)DevInfo->PollTdPtr)->fpCurrentBufferPointer = (UINT32)(UINTN)(DevInfo->PollDataBuffer); 
     ((OHCI_TD*)DevInfo->PollTdPtr)->fpBufferEnd  = (UINT32)(UINTN)(DevInfo->PollDataBuffer + DevInfo->PollingLength - 1);
...
)
{
    ...
    for (Index = 0; Index < HcStruc->AsyncListSize; Index += Ed->Interval) {
        ...
        while (Current != NULL) {
            ...
            Current = (OHCI_ED*)(UINTN)Current->fpEDLinkPointer;
        }
