...
#define OHCI_FIXED_DELAY_MS( OhciDevPtr, milliseconds ) \
        if (gUsbPeiStall!=NULL) \
            gUsbPeiStall->Stall( (CONST EFI_PEI_SERVICES**)OhciDevPtr->PeiServices, \
            gUsbPeiStall, milliseconds * 1000 );
