...
GetUsbPcdPolicy (VOID)
{
    ...
    //=======================================================================================================================================================================
    // Init Usb State flag
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdUsbMassEmulationForNoMedia),   (UINT32*)(UINTN)&gUsbData->UsbStateFlag,       USB_FLAG_MASS_EMULATION_FOR_NO_MEDIA,   USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdUsbEfiMsDirectAccess),         (UINT32*)(UINTN)&gUsbData->UsbStateFlag,       USB_FLAG_EFIMS_DIRECT_ACCESS,           USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdSkipCardReaderConnectBeep),    (UINT32*)(UINTN)&gUsbData->UsbStateFlag,       USB_FLAG_SKIP_CARD_READER_CONNECT_BEEP, USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdUsbIsoctransferSupport),       (UINT32*)(UINTN)&gUsbData->UsbStateFlag,       USB_FLAG_USB_ISOCTRANSFER_SUPPORT,      USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdUsbItdMemAllocForAllEhci),     (UINT32*)(UINTN)&gUsbData->UsbStateFlag,       USB_FLAG_ITD_MEM_ALLOC_FOR_ALL_EHCI,    USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdUsbDcbaaMemAllocForAllXhci),   (UINT32*)(UINTN)&gUsbData->UsbStateFlag,       USB_FLAG_DCBAA_MEM_ALLOC_FOR_ALL_XHCI,  USB_PCD_TYPE_BOOLEAN },

    
    // Init Usb Feature Flag
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdUhciSupport),                  (UINT32*)(UINTN)&gUsbData->UsbFeature,         USB_HC_UHCI_SUPPORT,                    USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdOhciSupport),                  (UINT32*)(UINTN)&gUsbData->UsbFeature,         USB_HC_OHCI_SUPPORT,                    USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdEhciSupport),                  (UINT32*)(UINTN)&gUsbData->UsbFeature,         USB_HC_EHCI_SUPPORT,                    USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdXhciSupport),                  (UINT32*)(UINTN)&gUsbData->UsbFeature,         USB_HC_XHCI_SUPPORT,                    USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdGpiDispatchByBitmap),          (UINT32*)(UINTN)&gUsbData->UsbFeature,         USB_GPI_DISPATCH_BY_BITMAP,             USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdUsbHotplugFddSupport),         (UINT32*)(UINTN)&gUsbData->UsbFeature,         USB_HOTPLUG_FDD_SUPPORT,                USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdUsbHotplugHddSupport),         (UINT32*)(UINTN)&gUsbData->UsbFeature,         USB_HOTPLUG_HDD_SUPPORT,                USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdUsbHotplugCdromSupport),       (UINT32*)(UINTN)&gUsbData->UsbFeature,         USB_HOTPLUG_CDROM_SUPPORT,              USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdDifferentiateMassDeviceName),  (UINT32*)(UINTN)&gUsbData->UsbFeature,         USB_DIFFERENTIATE_DEVICE_NAME,          USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdHideHispeedSetupQuestion),     (UINT32*)(UINTN)&gUsbData->UsbFeature,         USB_HIDE_HISPEED_SETUP_QUESTION,        USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdExternalUsbControllerSupport), (UINT32*)(UINTN)&gUsbData->UsbFeature,         USB_EXTERNAL_CONTROLLER_SUPPORT,        USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdSetupVariableRuntimeAccess),   (UINT32*)(UINTN)&gUsbData->UsbFeature,         USB_SETUP_VARIABLE_RUN_ACCESS,          USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdUsbRegisterPeriodicTimerInDxe),(UINT32*)(UINTN)&gUsbData->UsbFeature,         USB_REG_PERIODIC_TIMER_IN_DXE,          USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdStorageDeviceRmbCheck),        (UINT32*)(UINTN)&gUsbData->UsbFeature,         USB_MASS_STORAGE_DEV_RMB_CHECK,         USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdUsbIrqSupport),                (UINT32*)(UINTN)&gUsbData->UsbFeature,         USB_IRQ_INTERRUPT_SUPPORT,              USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdUsbResetPortPolicy),           (UINT32*)(UINTN)&gUsbData->UsbFeature,         USB_HC_RESET_PORT_POLICY,               USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdUsbHostErrorsSupport),         (UINT32*)(UINTN)&gUsbData->UsbFeature,         USB_HC_SYSTEM_ERRORS_SUPPORT,           USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdUsbMouseUpdateEbdaData),       (UINT32*)(UINTN)&gUsbData->UsbFeature,         USB_DEV_MOUSE_UPDATE_EBDA_DATA,         USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdEhci64bitDataStructure),       (UINT32*)(UINTN)&gUsbData->UsbFeature,         USB_EHCI_64_BIT_DATA_STRUCTURE,         USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdCcidUseIntInsRemoval),         (UINT32*)(UINTN)&gUsbData->UsbFeature,         USB_CCID_USE_INT_INS_REMOVAL,           USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdStartUnitBeforeMsdEnumeration),(UINT32*)(UINTN)&gUsbData->UsbFeature,         USB_MASS_START_UNIT_BEFORE_MSD_ENUMERATION,USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdUsbBeepEnable),                (UINT32*)(UINTN)&gUsbData->UsbFeature,         USB_BEEP_SUPPORT,                       USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdExtraCheckDeviceReady),        (UINT32*)(UINTN)&gUsbData->UsbFeature,         USB_EXTRA_CHECK_DEVICE_READY,           USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdHidKeyRepeatUseSetIdle),       (UINT32*)(UINTN)&gUsbData->UsbFeature,         USB_HID_USE_SETIDLE,                    USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdBootProtocolSupport),          (UINT32*)(UINTN)&gUsbData->UsbFeature,         USB_BOOT_PROTOCOL_SUPPORT,              USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdClearKbBufferAtReadyToBoot),   (UINT32*)(UINTN)&gUsbData->UsbFeature,         USB_CLEAR_USB_KB_BUFFER_AT_READYTOBOOT, USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdSpecificEhciOwnershipChange),  (UINT32*)(UINTN)&gUsbData->UsbFeature,         USB_SPECIFIC_EHCI_OWNERSHIP_CHANGE_MECHANISM,USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdLegacyUsbDisableForUsbMass),   (UINT32*)(UINTN)&gUsbData->UsbFeature,         USB_LEGACY_DISABLE_FOR_USB_MASS,        USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdXhciComplianceMoedWorkrouund), (UINT32*)(UINTN)&gUsbData->UsbFeature,         USB_XHCI_COMPLIANCE_MODE_WORKAROUND,    USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdShowSkipPortInformation),      (UINT32*)(UINTN)&gUsbData->UsbFeature,         USB_SHOW_SKIP_PORT_INFORMATION,         USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdUsbHcInterruptOutSupport),     (UINT32*)(UINTN)&gUsbData->UsbFeature,         USB_EFI_USB_HC_INTERRUPT_OUT_SUPPORT,   USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdUsbIadProtocolSupport),        (UINT32*)(UINTN)&gUsbData->UsbFeature,         USB_IAD_PROTOCOL,                       USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdUsbGetBosDescSupport),         (UINT32*)(UINTN)&gUsbData->UsbFeature2,        USB_GET_BOS_DESC_SUPPORT,               USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdUsbDisconnectExitBootService), (UINT32*)(UINTN)&gUsbData->UsbFeature2,        USB_DISCONNECT_USBIO_EXIT_BOOT,         USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdUsbDebugMessages),             (UINT32*)(UINTN)&gUsbData->UsbFeature2,        USB_DEBUG_SWITCH,                       USB_PCD_TYPE_BOOLEAN },

    //Init Usb device flag
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdUsbKbdDevices),                (UINT32*)(UINTN)&gUsbData->UsbDevSupport,      USB_KB_DEV_SUPPORT,                     USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdUsbMouseDevices),              (UINT32*)(UINTN)&gUsbData->UsbDevSupport,      USB_MS_DEV_SUPPORT,                     USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdUsbHubDevices),                (UINT32*)(UINTN)&gUsbData->UsbDevSupport,      USB_HUB_DEV_SUPPORT,                    USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdUsbMassDevices),               (UINT32*)(UINTN)&gUsbData->UsbDevSupport,      USB_MASS_DEV_SUPPORT,                   USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdUsbPointDevices),              (UINT32*)(UINTN)&gUsbData->UsbDevSupport,      USB_POINT_DEV_SUPPORT,                  USB_PCD_TYPE_BOOLEAN },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdUsbCcidDevice),                (UINT32*)(UINTN)&gUsbData->UsbDevSupport,      USB_CCID_DEV_SUPPORT,                   USB_PCD_TYPE_BOOLEAN },

    // PcdGetEx8 
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdXhciEventServiceMode),         (UINT32*)(UINTN)&gUsbData->XhciEventServiceMode,  0,                                   USB_PCD_TYPE_UINT8   },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdKeyrepeatInterval),            (UINT32*)(UINTN)&gUsbData->RepeatIntervalMode,    0,                                   USB_PCD_TYPE_UINT8   },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdMassStorageDeviceName),        (UINT32*)(UINTN)&gUsbData->MassStorageDeviceName, 0,                                   USB_PCD_TYPE_UINT8   },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdUsbRuntimeDriverInSmm),        (UINT32*)(UINTN)&gUsbData->UsbRuntimeDriverInSmm, 0,                                   USB_PCD_TYPE_UINT8   },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdUsbSendCommandToKbc),          (UINT32*)(UINTN)&gUsbData->UsbSendCmdToKbc,       0,                                   USB_PCD_TYPE_UINT8   },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdUseT0T1Protocol),              (UINT32*)(UINTN)&gUsbData->UseT0T1Protocol,       0,                                   USB_PCD_TYPE_UINT8   },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdUsbSwSmi),                     (UINT32*)(UINTN)&gUsbData->UsbSwSmi,              0,                                   USB_PCD_TYPE_UINT8   },

    // PcdGetEx16 
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdFullSpeedMaxBulkDataSizePerFrame),(UINT32*)(UINTN)&gUsbData->FullSpeedMaxBulkDataSizePerFrame,0,             USB_PCD_TYPE_UINT16  },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdHighSpeedMaxBulkDataSize),        (UINT32*)(UINTN)&gUsbData->HighSpeedMaxBulkDataSize,0,                            USB_PCD_TYPE_UINT16  },


    // PcdGetEx64
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdUsbInterruptPollingPeriod),       (UINT32*)(UINTN)&gUsbData->InterruptPollingPeriod,0,                              USB_PCD_TYPE_UINT64  },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdSizeForFloppyEmulation),          (UINT32*)(UINTN)&gUsbData->SizeForFloppyEmulation,0,                              USB_PCD_TYPE_UINT64  },
    { PcdTokenEx(&gAmiUsbPkgTokenSpaceGuid,AmiPcdUsbDebugMessagesBitMap),          (UINT32*)(UINTN)&gUsbData->UsbDbgMaskMap,         0,                              USB_PCD_TYPE_UINT64  }
    ...
    IN EFI_DEVICE_PATH_PROTOCOL     *RemainingDevicePath )
{
    ...
    if (EFI_ERROR(Status))
      USB_DEBUG(DEBUG_DEV_INIT, "Fail to get PciIo attribute!\n");
...
)
{
    ...
    USB_DEBUG(DEBUG_DEV_INIT, "AddHC for device %x\n", PciAddr);
...
)
{
    ...
    if (EfiToLegacy) {  // Changing to Legacy
        ...
        if (((gUsbData->UsbFeature & USB_IRQ_INTERRUPT_SUPPORT) == 0) &&
            ...
            // get HCD protocol
            if (gDxeUsbHcdTable == NULL) GetHcdTable();
            OldTpl = gBS->RaiseTPL(TPL_HIGH_LEVEL);
            for (Index = 0; Index < gUsbDataList->HcTableCount; Index++) {
                HcStruc = gHcTable[Index];
                if (HcStruc == NULL) {
