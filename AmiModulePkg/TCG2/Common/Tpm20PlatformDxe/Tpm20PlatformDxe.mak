...
[Protocols]$(EOL)\
  ...
  gEfiDevicePathToTextProtocolGuid      ## CONSUMES$(EOL)\
...
"[Pcd]$(EOL)\
  ...
  gAmiTcgPkgTokenSpaceGuid.PcdAmiDbtPolicy  $(EOL)\
  gAmiTcgPkgTokenSpaceGuid.PcdAmiGptPolicy  $(EOL)\
">> $(BUILD_DIR)/Tpm20PlatformDxe.inf
...
#//>>>$(EOL)\
[Depex]$(EOL)\
  gEfiVariableWriteArchProtocolGuid AND $(EOL)\
  gEfiVariableArchProtocolGuid $(EOL)\
#//<<<$(EOL)\
$(EOL)\
[BuildOptions]$(EOL)\
