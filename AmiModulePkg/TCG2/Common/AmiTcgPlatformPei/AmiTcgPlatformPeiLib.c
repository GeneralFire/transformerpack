    ...
    IN EFI_BOOT_MODE    BootMode )
{
    ...
    cmdStartup.Header.Tag       = SwapBytes16( TPM_TAG_RQU_COMMAND );
    cmdStartup.Header.ParamSize = SwapBytes32( sizeof (cmdStartup));
    cmdStartup.Header.Ordinal   = SwapBytes32( TPM_ORD_Startup );
    cmdStartup.StartupType      = SwapBytes16( TpmSt );
    ...
    DEBUG((DEBUG_INFO,
           ...
           SwapBytes32(retHeader.ParamSize ),
           SwapBytes32(retHeader.RetCode ),
           (UINT32)
           SwapBytes16(retHeader.Tag )));
    ...
    IN EFI_BOOT_MODE    BootMode )
{
    ...
    cmdStartup.Header.Tag       = SwapBytes16( TPM_TAG_RQU_COMMAND );
    cmdStartup.Header.ParamSize = SwapBytes32( sizeof (cmdStartup));
    cmdStartup.Header.Ordinal   = SwapBytes32( TCM_ORD_Startup );
    ...
    return (Status | SwapBytes32( retHeader.RetCode ));
}
    ...
    IN EFI_PEI_SERVICES **ps )
{
    ...
    cmd.Ordinal   = SwapBytes32( TPM_ORD_ContinueSelfTest );
    ...
    IN EFI_PEI_SERVICES **ps )
{
    ...
    cmd.Tag       = SwapBytes16( TPM_TAG_RQU_COMMAND );
    cmd.ParamSize = SwapBytes32( sizeof (cmd));
    cmd.Ordinal   = SwapBytes32(TCM_ORD_ContinueSelfTest );
    ...
    IN EFI_PEI_SERVICES **PeiServices )
{
    ...
    cmdGetTpmStatus.tag         = SwapBytes16( TPM_TAG_RQU_COMMAND );
    cmdGetTpmStatus.paramSize   = SwapBytes32( sizeof (TPM_RQU_COMMAND_HDR));
    cmdGetTpmStatus.ordinal     = SwapBytes32( NTC_ORD_GET_TPM_STATUS );
    ...
    IN PEI_TCG_PPI      *tcg )
{
    ...
    UINT8                         *EvntData;
    EFI_STATUS                    status;
    CHAR8                         *biosVenderName = (AMI_TCG2_LOG_BIOS_NAME);
    CHAR8                         *oemVenderName  = (AMI_TCG2_LOG_VENDOR_NAME);
    ...
    TcgInfo.uintnSize         = 1;
#endif
    TcgInfo.VendorInfoSize    = (UINT8)(Size - sizeof(TCG_PCClientSpecIDEventStruct));
