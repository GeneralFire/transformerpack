...
EFI_GUID TcgSetupVariableGuid  = { 0xEC87D643, 0xEBA4, 0x4BB5, { 0xA1, 0xE5, 0x3F, 0x3E, 0x36, 0xB2, 0x0D, 0xA9 } };
...
**/
VOID TcgDefaultsEnterSetupHook(VOID)
{
    UINTN   VariableSize;

    DEBUG ((DEBUG_INFO, "TcgDefaultsEnterSetupHook Enter\n"));
  
    VariableSize = sizeof(SETUP_DATA);
    gRT->GetVariable(
                  L"Setup",
                  &TcgSetupVariableGuid,
                  NULL,
                  &VariableSize,
                  &SetupData
                  );
