...
static void null_progress_init (FLASH_PROGRESS *self) {}
static void null_progress_close (FLASH_PROGRESS *self) {}
static void esrt_progress_update (FLASH_PROGRESS *self, UINTN percent)
{
    AmiShowProgress (percent);
}

static void fmp_progress_update (FLASH_PROGRESS *self, UINTN percent)
{
    progress_uefi *pr = (progress_uefi *)(self->Extra);
