 ...
 * 
 * If Buffer is NULL and BufferSize is 0, the function will save the detected 
 * data to gCurHardwareConfigData. Otherwise,  it will compare the input data 
 * and the  detected data to determine the PS2 Keyboard is present or not.
 * 
    ...
    IN VOID  *Buffer )
{
    ...
    Status = Ps2DetectKeyboard (AMI_HARDWARE_SIGNATURE_PS2_KEYBOARD_CONFIG, 
 ...
 * input data and the  detected data to determine the PS2 Mouse is present or not.
 * 
 * @param[in]  BufferSize   Size of buffer for recording the PS2 Mouse configuration. 
    ...
    IN VOID  *Buffer )
{
   ...
   Status = Ps2DetectMouse (AMI_HARDWARE_SIGNATURE_PS2_MOUSE_CONFIG, 
...
#if HARDWARE_SIGNATURE_DETECT_PS2_KEYBOARD  
    AmiHardwareSignatureSetHardwareConfigData (AMI_HARDWARE_SIGNATURE_PS2_KEYBOARD_CONFIG, 0, NULL);
#endif
    
#if HARDWARE_SIGNATURE_DETECT_PS2_MOUSE
    AmiHardwareSignatureSetHardwareConfigData (AMI_HARDWARE_SIGNATURE_PS2_MOUSE_CONFIG, 0, NULL);
#endif
