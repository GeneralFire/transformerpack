...
/** @file CspMeud10Gbe.c
    ...
    Preserve 10GBE Mac address and fill the checksum.
    These functions are sample code that is for Intel Ethernet Connection X722.
...
extern  BOOLEAN                         gMappingAddress;
...
FlashAccess10Gbe(
    ...
    IN  BOOLEAN Restore )
{
    AmiFlashReadEx( Source, Destination, (UINT32)Length, gMappingAddress );
}
/**
    Memory access 10Gbe region
