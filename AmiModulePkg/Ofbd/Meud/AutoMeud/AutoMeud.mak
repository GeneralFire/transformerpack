...
ifeq ($(SPS_FW_RECOVERY_UPDATE_SUPPORT), 1)
	$(CP) /y $(BIOS_ME_FILE) $(BUILD_DIR)$(PATH_SLASH)FullImage.bin
	split -f $(BUILD_DIR)$(PATH_SLASH)FullImage.bin -s $(NonBIOS_LENGTH) -o $(BUILD_DIR)$(PATH_SLASH)MeRegion.bin -t $(BUILD_DIR)$(PATH_SLASH)BiosRegion.bin
	del $(BUILD_DIR)$(PATH_SLASH)FullImage.bin
	del $(BUILD_DIR)$(PATH_SLASH)BiosRegion.bin
else	
	$(CP) /y $(BIOS_ME_FILE) $(BUILD_DIR)$(PATH_SLASH)MeRegion.bin
endif	
