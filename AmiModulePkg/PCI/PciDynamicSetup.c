...
**/
VOID EFIAPI PciSetupCreatePaddingOptions(VOID *OpcodeHandle, UINT8 OpType, UINT64 PaddingResource){
...
//--------------------------------
    ...
    switch(OpType){
        ...
        break;
        case optIo:
            PaddingResource = PaddingResource / 0x4000;
            d=PaddingResource;
            strid=&iostr[0];
        ...
        break;
        case optMmio:
            PaddingResource = PaddingResource / 0x100000;
            {
                UINT8 Index1 = 0;
                while(PaddingResource != 0){
                    PaddingResource = PaddingResource >> 1;
                    Index1++;
                }
                d=Index1;
            }
...
//    gPciDevForm.Mmio64OpCodeHandle = HiiAllocateOpCodeHandle ();
    ...
    PciSetupCreatePaddingOptions(gPciDevForm.BusPaddOpCodeHandle,optBus, GotoData->PciSdlInfo->ResourcePadding[0]);
    ...
    PciSetupCreatePaddingOptions(gPciDevForm.IoPaddOpCodeHandle,optIo, GotoData->PciSdlInfo->ResourcePadding[1]);
    ...
    PciSetupCreatePaddingOptions(gPciDevForm.Mmio32OpCodeHandle,optMmio, GotoData->PciSdlInfo->ResourcePadding[3]);
    ...
    PciSetupCreatePaddingOptions(gPciDevForm.Mmio32PfOpCodeHandle,optMmio, GotoData->PciSdlInfo->ResourcePadding[4]);
...
/*    
    ...
    PciSetupCreatePaddingOptions(gPciDevForm.Mmio64OpCodeHandle,optMmio64, GotoData->PciSdlInfo->ResourcePadding[5]);
...
*/    
    ...
    PciSetupCreatePaddingOptions(gPciDevForm.Mmio64PfOpCodeHandle,optMmio64, GotoData->PciSdlInfo->ResourcePadding[6]);
