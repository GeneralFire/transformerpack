...
///Physical Layer 32.0 PCIe Ext Capability 
typedef struct _PCIE5_DATA {
    UINT16              PhyPcieCapOffs;
    UINT32              ControlReg; ///32 bit reg
    UINT32              StatusReg; ///32 bit reg
    UINT32              RcvdModifiedTSData1;
    UINT32              RcvdModifiedTSData2;
    UINT32              TransModifiedTSData1;
    UINT32              TransModifiedTSData2;
    UINT8               MaxLanesCount;    
} PCIE5_DATA;
/**
