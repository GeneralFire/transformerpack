...
)
{
    ...
    Csm16BootTable->BbsTable = (UINT32)(UINTN)gCoreBiosInfo->BbsTable;
    ...
    // Get extended memory size into Csm16BootTable->OsMemoryAbove1Mb
    // Note we can not pass &Csm16BootTable->OsMemoryAbove1Mb because of potential alignment problem
    GetExtendedMemSize(&ExtendedMemSize);
    Csm16BootTable->OsMemoryAbove1Mb = ExtendedMemSize;
