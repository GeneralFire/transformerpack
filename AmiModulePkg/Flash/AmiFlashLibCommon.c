...
)
{
    ...
    Status = Rs->ConvertPointer( 0, (VOID**)&(gFlashApi->FlashReadCommand) );
    Status = Rs->ConvertPointer( 0, (VOID**)&(gFlashApi->FlashEraseCommand) );
    Status = Rs->ConvertPointer( 0, (VOID**)&(gFlashApi->FlashEraseCommandEx) );
    Status = Rs->ConvertPointer( 0, (VOID**)&(gFlashApi->FlashProgramCommand) );
    Status = Rs->ConvertPointer( 0, (VOID**)&(gFlashApi->FlashBlockWriteEnable) );
    Status = Rs->ConvertPointer( 0, (VOID**)&(gFlashApi->FlashBlockWriteDisable) );
    Status = Rs->ConvertPointer( 0, (VOID**)&(gFlashApi->FlashDeviceWriteEnable) );
    Status = Rs->ConvertPointer( 0, (VOID**)&(gFlashApi->FlashDeviceWriteDisable) );
    Status = Rs->ConvertPointer( 0, (VOID**)&(gFlashApi->FlashGetEraseGranularity) );
    Status = Rs->ConvertPointer( 0, (VOID**)&(gFlashApi->FlashVirtualFixup) );
    Status = Rs->ConvertPointer( 0, (VOID**)&(gFlashApi->FlashPartNumber) );
...
{
    return AmiFlashWrite( BlockAddress, Data, gFlashBlockSize, TRUE );
}
...
{
    return AmiFlashErase( BlockAddress, gFlashBlockSize, TRUE );
}
...
{
    AmiFlashWriteEnable( BlockAddress, gFlashBlockSize, TRUE );
}
...
{
    AmiFlashWriteDisable( BlockAddress, gFlashBlockSize, TRUE );
}
...
{
    return AmiFlashProgramEx( Address, Data, Length, TRUE );
}
...
{
    return AmiFlashReadEx( Address, Data, Length, TRUE );
}
