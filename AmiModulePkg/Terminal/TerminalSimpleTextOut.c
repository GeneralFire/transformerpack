...
)
{
    ...
    {  CHAR16 SetModeEscapeSequence[50];
       SetModeEscapeSequence[0] = ASCII_ESC;
       Swprintf(SetModeEscapeSequence+1,L"[8;%d;%dt", MaxRows, MaxColumns);
       TerminalOutputEscapeSequence(This, SetModeEscapeSequence);
    }
