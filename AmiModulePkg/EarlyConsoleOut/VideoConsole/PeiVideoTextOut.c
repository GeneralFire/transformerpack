...
{   
    ...
    AsciiSPrint (TextString, 100, "Copyright(c) %d American Megatrends, Inc. \n\r", THIS_YEAR);
    VideoTextOutPpi->WriteString(VideoTextOutPpi, 0, (UINT8 *)TextString); 
...
)    
{
    ...
    Status = AmiVideoPrint(Side, (const char*)Text);
...
)
{
    ...
    VideoStatus = AmiVideoInit( (EFI_PEI_SERVICES**)PeiServices); 
