...
//*** AMI PORTING BEGIN *****//
// Added support for workaround for build process issue with constructor dependency in the build process 
BOOLEAN gSmmPciExpressLibConstructorFlag = FALSE;
//*** AMI PORTING END *****//
...
//**** AMI PORTING BEGIN *****//
// Added support for workaround for build process issue with constructor dependency in the build process 
 gSmmPciExpressLibConstructorFlag = TRUE;
 //**** AMI PORTING END *****//
...
//**** AMI PORTING BEGIN *****//
// Added support for workaround for build process issue with constructor dependency in the build process 
 if (gSmmPciExpressLibConstructorFlag == FALSE) {
     SmmPciExpressLibConstructor(NULL, NULL);
 }
 //**** AMI PORTING END *****//
