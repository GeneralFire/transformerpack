...
//AMI PORTING BEGIN
//Add timeout for unresponsive serial port
//to prevent dead-locks in boot process
#define SERIAL_PORT_TIMEOUT     0xFFFF
STATIC BOOLEAN SerialPortGood = TRUE;
//AMIPORTING END
