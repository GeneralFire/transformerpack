  ...
  )
{
  ...
  if (Head->Signature != POOL_HEAD_SIGNATURE &&
    ...
    //         Head->Signature == POOLPAGE_HEAD_SIGNATURE);
        DEBUG((DEBUG_VERBOSE, "[ASTDBG]ASSERT (Head->Signature == POOL_HEAD_SIGNATURE ||\n"));
        DEBUG((DEBUG_VERBOSE, "[ASTDBG]Head->Signature == POOLPAGE_HEAD_SIGNATURE);\n"));
        DEBUG((DEBUG_VERBOSE, "[ASTDBG]CoreFreePoolI \n"));
    return EFI_INVALID_PARAMETER;
  }
