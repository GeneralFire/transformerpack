...
AmiInstallSecureBootVariables (
    ...
    if(SecureVariableNameList == NULL || SecureVariableFileGuidList == NULL )
        return EFI_INVALID_PARAMETER;
...
///////////////////////////////////////////////////////////////////////////////
    ...
    {
        if(Index < SecureVariableSigDatabaseIndex)
        ...
        if(Action & (SET_NV_DEFAULT_KEYS | SET_RT_DEFAULT_KEYS)) {
            Status = GetSectionFromAnyFv (SecureVariableFileGuidList[Index], EFI_SECTION_RAW, 0, (void**)&pVarBuffer, (UINTN*)&FileSize);
