...
///
// APTIOV_SERVER_OVERRIDE_START : Aligned UefiCpuPkg with EDK2 to resolve build error
typedef struct {
  //
...
// APTIOV_SERVER_OVERRIDE_END : Aligned UefiCpuPkg with EDK2 to resolve build error
